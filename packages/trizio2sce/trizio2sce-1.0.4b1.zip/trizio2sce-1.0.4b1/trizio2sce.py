...
def imprimePRO5(helpMessage1, helpMessage2):
...
def imprimePRO5_ENG(helpMessage1, helpMessage2):
...
def imprimeTodo():
	...
	x=0
	for y in listObjects:
		#print('/'+str(x)+' '+str(y['loc'])+' '+'1'+' '+'_ _   _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _  '+y['name']+' _',file=f)
                cadena=''
	...
	imprimePRO4()
	if english:
		imprimePRO5_ENG(helpMessage1, helpMessage2)
	else:
		imprimePRO5(helpMessage1, helpMessage2)
	imprimePRO6()
	imprimeOtrosPros()
	x=1
	for y in listRooms:
...
print('Trizio2sce version 1.0.4b1 190318 (c) 2018 Pedro Fernández')	
