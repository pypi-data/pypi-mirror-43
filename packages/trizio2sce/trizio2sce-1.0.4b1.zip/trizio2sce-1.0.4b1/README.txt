...
Triz2sce versión 1.0.4b1 190318 (c) 2018 Pedro Fernández
...
Siguiendo las convenciones del Trizbort original, Trizio2sce buscará las cadenas [w] y [c] en el nombre de los objetos para añadirles los atributos ropa y contenedor, aunque los objetos contenedores aún no son funcionales.
...
- **1.0.4b1 190318**
 ...
 - Añadido soporte para atributos ropa y contenedor, aunque el de contenedor aún no es funcional.
...
Trizio2sce version 1.0.4b1 190318 (c) 2018 Pedro Fernández
...
Following original Trizbort standards, Trizio2sce will search for the [w] and [c] strings inside objects name, giving then wearable and container atributes, though container objects are not functional yet.
...
- **1.0.4b1** 190318
 ...
 - Added support for wearable and container atributes, though container isn't functional yet.
