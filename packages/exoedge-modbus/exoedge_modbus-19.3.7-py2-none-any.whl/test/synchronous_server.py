...
class TestModbusTCPServer(threading.Thread):
    ...
    def run(self):
        ...
        store = ModbusSlaveContext(
            di=ModbusSequentialDataBlock(0, [17]*NUMBER_OF_REGS_AND_COILS),
            co=ModbusSequentialDataBlock(0, [17]*NUMBER_OF_REGS_AND_COILS),
            hr=ModbusSequentialDataBlock(0, [17]*NUMBER_OF_REGS_AND_COILS),
            ir=ModbusSequentialDataBlock(0, [17]*NUMBER_OF_REGS_AND_COILS))
