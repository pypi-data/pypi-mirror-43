...
def create(update_available, timings, set_state_health, reset_max_level, logger):
    ...
    states = {
        state_ids.ACTIVE: Active(state_ids.ACTIVE, update_available, set_state_health, reset_max_level, logger),
        state_ids.INACTIVE: Inactive(state_ids.INACTIVE, update_available, set_state_health, reset_max_level, logger),
        state_ids.ONBOARDING: Onboarding(state_ids.ONBOARDING, update_available, set_state_health, reset_max_level, logger),
        state_ids.ONBOARDED: Onboarded(state_ids.ONBOARDED, update_available, set_state_health, reset_max_level, logger),
        state_ids.STOPPED: Stopped(state_ids.STOPPED, update_available, set_state_health, reset_max_level, logger),
        state_ids.ARCHIVED: Archived(state_ids.ARCHIVED, update_available, set_state_health, reset_max_level, logger),
    }
