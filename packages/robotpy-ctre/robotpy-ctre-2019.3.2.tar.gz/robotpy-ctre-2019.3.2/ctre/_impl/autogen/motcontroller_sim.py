...
class MotController:
    ...
    def configMotionSCurveStrength(self, curveStrength: int, timeoutMs: int = 0) -> ErrorCode:
        ...
        '''
        assert isinstance(curveStrength, int)
        assert isinstance(timeoutMs, int)
        retval = ErrorCode.OK
        self.hal_data['motionmagic_scurvelevel'] = curveStrength
        assert isinstance(retval, ErrorCode)
        return retval
    ...
    def configSetParameter(self, param: int, value: float, subValue: int, ordinal: int, timeoutMs: int = 0) -> ErrorCode:
        ...
        elif param == ParamEnum.eMotMag_SCurveLevel:
            self.hal_data['motionmagic_scurvelevel'] = value
