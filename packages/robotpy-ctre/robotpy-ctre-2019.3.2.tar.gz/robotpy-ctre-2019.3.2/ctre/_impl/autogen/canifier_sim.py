...
class CANifier:
    ...
    def _setLEDOutput(self, dutyCycle: int, ledChannel: int) -> ErrorCode:
        ...
        '''
        assert isinstance(dutyCycle, int) and 0 <= dutyCycle < 1<<32
        assert isinstance(ledChannel, int) and 0 <= ledChannel < 1<<32
        retval = ErrorCode.OK
    ...
    def setGeneralOutputs(self, outputsBits: int, isOutputBits: int) -> ErrorCode:
        ...
        '''
        assert isinstance(outputsBits, int) and 0 <= outputsBits < 1<<32
        assert isinstance(isOutputBits, int) and 0 <= isOutputBits < 1<<32
        retval = ErrorCode.OK
    ...
    def setGeneralOutput(self, outputPin: int, outputValue: bool, outputEnable: bool) -> ErrorCode:
        ...
        '''
        assert isinstance(outputPin, int) and 0 <= outputPin < 1<<32
    ...
    def _setPWMOutput(self, pwmChannel: int, dutyCycle: int) -> ErrorCode:
        ...
        '''
        assert isinstance(pwmChannel, int) and 0 <= pwmChannel < 1<<32
        assert isinstance(dutyCycle, int) and 0 <= dutyCycle < 1<<32
        retval = ErrorCode.OK
    ...
    def getGeneralInput(self, inputPin: int) -> bool:
        ...
        '''
        assert isinstance(inputPin, int) and 0 <= inputPin < 1<<32
