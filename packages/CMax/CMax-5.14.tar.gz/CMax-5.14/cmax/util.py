...
class Pose:
    ...
    def point(self):
        """
        Return just the x, y parts represented as an instance of :py:class:`Point`
        """
    ...
    def transform_point(self, point):
        ...
        :param point: an instance of :py:class:`Point`
        """
        cosTh = math.cos(self.theta)
        sinTh = math.sin(self.theta)
    ...
    def diff(self, pose):
        """
        :param pose: an instance of :py:class:`Pose`
...
def value_list_to_pose(values):
    ...
    :returns: a corresponding :py:class:`Pose`
    """
    return Pose(*values)
...
class Point:
    ...
    def near(self, point, dist_eps):
        """
        :param point: instance of :py:class:`Point`
        :param dist_eps: positive real number

        :returns: true if the distance between :py:class:`self` and :py:class:`Point` is less
                  than dist_eps
        """
    ...
    def distance(self, point):
        ...
        :returns: Euclidean distance between ``self`` and :py:class:`Point`
        """
    ...
    def angle_to(self, p):
        """
        :param p: instance of :py:class:`Point` or :py:class:`Pose`
...
class Line:
    ...
    def intersection(self, other):
        """
        Return a :py:class:`Point` where ``self`` intersects ``other``.
        Returns None if there is no intersection.
        :param other: a :py:class:`Line`
        """
...
class LineSeg:
    ...
    def intersection(self, other):
        """
        Return a :py:class:`Point` where ``self`` intersects ``other``.  Returns ``False``
        if there is no intersection.
        :param other: a :py:class:`LineSeg`
        """
        def helper(l1, l2):
...
def local_to_global(pose, point):
    ...
    :param point: instance of :py:class:`util.Point`
    """
...
def local_pose_to_global_pose(pose1, pose2):
    ...
    :param pose1: instance of :py:class:`util.Pose`
    :param pose2: instance of :py:class:`util.Pose`
    """
...
def global_to_local(pose, point):
    ...
    :param pose: instance of C{Pose}
    :param point: instance of C{Point}
    """
...
def global_pose_to_local_pose(pose1, pose2):
    ...
    :param pose1: instance of C{Pose}
    :param pose2: instance of C{Pose}
    """
...
def global_delta_to_local(pose, deltaPoint):
    ...
    :param pose: instance of C{Pose}
    :param deltaPoint: instance of C{Point}
    """
