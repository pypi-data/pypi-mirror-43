...
class AnalysisContext:
    ...
    def set_qc_status(
        ...
        logger.info('Setting ({}={}) QC status to {}: {}'.format(
    ...
    def download_session_qa_requirements(self, path):
        ...
        data_to_send = {
            "project_id": self.analysis_data['projectset_id']
        }
        ...
        if not res['success']:
            ...
            logger.info('Storing project-level session QA requirements at {}'.format(
                path
            ))
    ...
    def upload_session_qa_report(self, input_id, path):
        ...
        logger.info('Sending session QA report with id {}:\n{}'.format(
    ...
    def upload_file(
            ...
            protocol=None, container_id=None, replace=None
    ):
        """
