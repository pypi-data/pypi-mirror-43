...
def ValidateFeatureStatistics(statistics_proto_string, schema_proto_string, environment, previous_statistics_proto_string, serving_statistics_proto_string):
    return _pywrap_tensorflow_data_validation.ValidateFeatureStatistics(statistics_proto_string, schema_proto_string, environment, previous_statistics_proto_string, serving_statistics_proto_string)
