...
if sys.platform == 'cli':
    from adidasSensor.serial.serialcli import *
else:
    import os
    # chose an implementation, depending on os
    if os.name == 'nt': #sys.platform == 'win32':
        from adidasSensor.serial.serialwin32 import *
    elif os.name == 'posix':
        from adidasSensor.serial.serialposix import *
    elif os.name == 'java':
        from adidasSensor.serial.serialjava import *
    else:
        raise ImportError("Sorry: no implementation for your platform ('%s') available" % (os.name,))


protocol_handler_packages = [
        'adidasSensor.serial.urlhandler',
        ]
