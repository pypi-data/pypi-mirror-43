...
setup(name='merchise.lint',
      version='0.11',
      description="Merchise Lint Checks (for CI)",
      long_description=(
          'Provide checkers to avoid common errors to check into your code.'
      ),
      classifiers=[
      ...
      entry_points={
          'console_scripts': [
              ...
              'merchise_lint_pre_commit%s = merchise.lint.main:pre_commit' % sys.version[:1],
          ],
