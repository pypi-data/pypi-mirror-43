...
ci_data_model.append('serial_x3_species_model_6') # Index 1
...
from workspace_jam.pipelines import serial_x2_species_fix_1

pipeline = serial_x2_species_fix_1.make_pipeline(phase_folders=[ci_data_type, ci_data_model[batch_id], ci_data_resolution])
