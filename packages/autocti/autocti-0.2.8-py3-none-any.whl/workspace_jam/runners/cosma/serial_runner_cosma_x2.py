...
ci_data_resolution = str(sys.argv[2]).strip() # The resolution of the image.
...
ci_data_model = []
ci_data_model.append('') # Task number beings at 1, so keep index 0 blank
ci_data_model.append('serial_x3_species_model_4_1') # Index 1
ci_data_model.append('serial_x3_species_model_4_2') # Index 2
ci_data_model.append('serial_x3_species_model_4_3') # Index 3
ci_data_model.append('serial_x3_species_model_5') # Index 4
ci_data_model.append('serial_x3_species_model_6') # Index 5
ci_data_model.append('serial_x3_species_model_7') # Index 6
...
ci_data_path = path_util.make_and_return_path_from_path_and_folder_names(
    path=cosma_path, folder_names=['data', ci_data_type, ci_data_model[batch_id], ci_data_resolution])
...
pipeline = serial_x2_species.make_pipeline(phase_folders=[ci_data_type, ci_data_model[batch_id], ci_data_resolution])
