...
from workspace_jam.pipelines import serial_x3_species_prior_1

pipeline = serial_x3_species_prior_1.make_pipeline(phase_folders=[ci_data_type, ci_data_model[batch_id], ci_data_resolution])
