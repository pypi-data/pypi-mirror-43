...
from workspace_jam.pipelines import serial_x2_species_fix_2

pipeline = serial_x2_species_fix_2.make_pipeline(phase_folders=[ci_data_type, ci_data_model[batch_id], ci_data_resolution])
