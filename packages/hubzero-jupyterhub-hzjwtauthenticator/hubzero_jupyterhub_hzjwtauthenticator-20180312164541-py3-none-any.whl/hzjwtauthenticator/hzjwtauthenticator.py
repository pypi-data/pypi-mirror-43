...
class hzJSONWebTokenLoginHandler(BaseHandler):
...
class hzJSONWebTokenAuthenticator(Authenticator):
    """
    ...
    def get_handlers(self, app):
        return [
            (r'/login', hzJSONWebTokenLoginHandler),
        ]
...
class hzJSONWebTokenLocalAuthenticator(hzJSONWebTokenAuthenticator, LocalAuthenticator):
    """
