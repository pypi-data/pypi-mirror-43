...
class SpriteGraphic:
    ...
    def parse(self):
        ...
        if len(self.tiles) > 256:
            raise WrongImageError("Sprite graphic image: \"" + self.image_path + "\" has too many different tiles")
    ...
    def parse_image(self):
        ...
        # generate real_size and frame_count based on if size was specified (multi frame)
