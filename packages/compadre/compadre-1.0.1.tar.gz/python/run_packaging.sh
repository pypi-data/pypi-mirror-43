...
rm -rf build/ && rm -rf python_src/CMakeFiles && rm -rf python_src/CMakeCache.txt && cd dist && tar -xzvf compadre-$1.tar.gz && cd compadre-$1 && cp PKG-INFO ../.. && cp setup.cfg ../.. && cd ../.. && rm -rf dist 
