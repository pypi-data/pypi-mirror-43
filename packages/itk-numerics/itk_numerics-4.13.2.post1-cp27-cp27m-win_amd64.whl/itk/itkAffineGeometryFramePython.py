...
class itkAffineGeometryFrameD2(ITKCommonBasePython.itkObject):
    ...
    def GetModifiableBoundingBox(self):
    ...
    def SetIndexToObjectTransform(self, _arg):
    ...
    def SetObjectToNodeTransform(self, _arg):
    ...
    def GetModifiableObjectToNodeTransform(self):
    ...
    def SetIndexToWorldTransform(self, _arg):
    ...
    def GetModifiableIndexToNodeTransform(self):
    ...
    def GetIndexToNodeTransform(self, *args):
        """
...
def itkAffineGeometryFrameD2_cast(obj):
...
def itkAffineGeometryFrameD3_cast(obj):
