...
class itkPolygonSpatialObject2(itkBlobSpatialObjectPython.itkBlobSpatialObject2):
    ...
    def ClosestPoint(self, curPoint):
    ...
    def DeletePoint(self, pointToDelete):
    ...
    def InsertPoint(self, point1, pointToAdd):
    ...
    def RemoveSegment(self, startpoint, endPoint):
