...
class ImportBankConnectionParams(object):
    ...
    def __init__(self, bank_id=None, banking_user_id=None, banking_customer_id=None, banking_pin=None, store_pin=False, name=None, skip_positions_download=False, load_owner_data=False, max_days_for_download=0, account_type_ids=None, challenge_response=None):  # noqa: E501
        ...
        if load_owner_data is not None:
            self.load_owner_data = load_owner_data
    ...
    def banking_user_id(self):
        ...
        Online banking user ID credential. Max length: 64. NOTES:<br/>- if you import the 'demo connection', this field can be left unset;<br/> - if the user will need to enter his credentials in finAPI's web form, this field can contain any value. It will be ignored.  # noqa: E501
    ...
    def banking_customer_id(self):
        ...
        Online banking customer ID credential (for most banks this field can remain unset). Max length: 64. NOTES:<br/>- if the user will need to enter his credentials in finAPI's web form, this field can contain any value. It will be ignored.  # noqa: E501
    ...
    def banking_pin(self):
        ...
        Online banking PIN. Max length: 170. Any symbols are allowed. NOTES:<br/>- if you import the 'demo connection', this field can be left unset;<br/> - if the user will need to enter his credentials in finAPI's web form, this field can be left unset or contain any value. It will be ignored.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ImportBankConnectionParams, dict):
