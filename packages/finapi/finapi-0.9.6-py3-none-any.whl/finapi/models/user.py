...
class User(object):
    ...
    def __init__(self, id=None, password=None, email=None, phone=None, is_auto_update_enabled=None):  # noqa: E501
    ...
    def password(self):
        ...
        User's password. Please note that some services may return a distorted password (always 'XXXXX'). See the documentation of individual services to find out whether the password is returned as plain text or as 'XXXXX'.  # noqa: E501
