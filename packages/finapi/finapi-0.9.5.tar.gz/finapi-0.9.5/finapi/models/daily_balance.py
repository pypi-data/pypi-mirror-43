...
class DailyBalance(object):
    ...
    def __init__(self, _date=None, balance=None, income=None, spending=None, transactions=None):  # noqa: E501
    ...
    @property
    def _date(self):
        """Gets the _date of this DailyBalance.  # noqa: E501

        Date in the format 'YYYY-MM-DD HH:MM:SS.SSS' (german time).  # noqa: E501

        :return: The _date of this DailyBalance.  # noqa: E501
        :rtype: str
        """
        return self.__date
    ...
    def _date(self, _date):
        """Sets the _date of this DailyBalance.

        Date in the format 'YYYY-MM-DD HH:MM:SS.SSS' (german time).  # noqa: E501

        :param _date: The _date of this DailyBalance.  # noqa: E501
        :type: str
        """
        if _date is None:
    ...
    def balance(self):
        ...
        Calculated balance at the end of day (aggregation of all regarded accounts).  # noqa: E501
    ...
    def income(self):
        ...
        The sum of income of the given day (aggregation of all regarded accounts).  # noqa: E501
    ...
    def spending(self):
        ...
        The sum of spending of the given day (aggregation of all regarded accounts).  # noqa: E501
    ...
    def transactions(self):
        ...
        Identifiers of the transactions for the given day  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DailyBalance, dict):
