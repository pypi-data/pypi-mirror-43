...
from finapi.models.clearing_account_data import ClearingAccountData  # noqa: F401,E501
...
class Account(object):
    ...
    def account_holder_id(self):
        ...
        Bank's internal identification of the account holder. Note that if your client has no license for processing this field, it will always be 'XXXXX'  # noqa: E501
    ...
    def clearing_accounts(self):
        ...
        List of clearing accounts that relate to this account. Clearing accounts can be used for money transfers (see field 'clearingAccountId' of the 'Request SEPA Money Transfer' service).  # noqa: E501
