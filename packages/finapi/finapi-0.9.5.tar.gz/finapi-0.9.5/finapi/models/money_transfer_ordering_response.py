...
class MoneyTransferOrderingResponse(object):
    ...
    def __init__(self, success_message=None, warn_message=None, payment_id=None, challenge_message=None, answer_field_label=None, tan_list_number=None, optical_data=None, photo_tan_mime_type=None, photo_tan_data=None):  # noqa: E501
    ...
    @property
    def payment_id(self):
        """Gets the payment_id of this MoneyTransferOrderingResponse.  # noqa: E501

        Payment identifier. Can be used to retrieve the status of the payment (see 'Get payments' service).  # noqa: E501

        :return: The payment_id of this MoneyTransferOrderingResponse.  # noqa: E501
        :rtype: int
        """
    ...
    def payment_id(self, payment_id):
        """Sets the payment_id of this MoneyTransferOrderingResponse.

        Payment identifier. Can be used to retrieve the status of the payment (see 'Get payments' service).  # noqa: E501

        :param payment_id: The payment_id of this MoneyTransferOrderingResponse.  # noqa: E501
        :type: int
        """
    ...
    def optical_data(self):
        ...
        In case that the bank server has instructed the user to scan a flicker code, then this field will contain the raw data for the flicker animation as a BASE-64 string. Otherwise, this field will be not set (i.e. null). For more information on how to process the flicker code data, please address the <a href='https://finapi.zendesk.com' target='_blank'>finAPI Developer Portal</a>.  # noqa: E501
    ...
    def photo_tan_data(self):
        ...
        In case that the bank server has instructed the user to scan a photo (or more generally speaking, any kind of QR-code-like data), then this field will contain the raw data of the photo as a BASE-64 string. Otherwise, this field will be not set (i.e. null). For more information on how to process the photo data, please address the <a href='https://finapi.zendesk.com' target='_blank'>finAPI Developer Portal</a>.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MoneyTransferOrderingResponse, dict):
