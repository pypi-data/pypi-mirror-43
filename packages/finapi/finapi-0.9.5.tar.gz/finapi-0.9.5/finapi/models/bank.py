...
class Bank(object):
    ...
    def __init__(self, id=None, name=None, login_hint=None, bic=None, blz=None, blzs=None, login_field_user_id=None, login_field_customer_id=None, login_field_pin=None, is_customer_id_password=None, is_supported=None, supported_data_sources=None, pins_are_volatile=None, location=None, city=None, is_test_bank=None, popularity=None, health=None, last_communication_attempt=None, last_successful_communication=None):  # noqa: E501
        ...
        self._is_customer_id_password = None
        ...
        self.is_customer_id_password = is_customer_id_password
    ...
    @property
    def is_customer_id_password(self):
        """Gets the is_customer_id_password of this Bank.  # noqa: E501

        Whether the banking customer ID has to be treated like a password. Certain banks require a second password (besides the PIN) for the user to login. In this case your application should use a password input field when prompting users for their credentials.  # noqa: E501

        :return: The is_customer_id_password of this Bank.  # noqa: E501
        :rtype: bool
        """
        return self._is_customer_id_password

    @is_customer_id_password.setter
    def is_customer_id_password(self, is_customer_id_password):
        """Sets the is_customer_id_password of this Bank.

        Whether the banking customer ID has to be treated like a password. Certain banks require a second password (besides the PIN) for the user to login. In this case your application should use a password input field when prompting users for their credentials.  # noqa: E501

        :param is_customer_id_password: The is_customer_id_password of this Bank.  # noqa: E501
        :type: bool
        """
        if is_customer_id_password is None:
            raise ValueError("Invalid value for `is_customer_id_password`, must not be `None`")  # noqa: E501

        self._is_customer_id_password = is_customer_id_password
