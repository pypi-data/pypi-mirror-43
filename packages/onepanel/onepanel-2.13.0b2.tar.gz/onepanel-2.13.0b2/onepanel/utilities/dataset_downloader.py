...
class DatasetDownloader(Thread):
    ...
    def start(self):
        ...
        # todo logic to choose the right scheduler?
    ...
    def start_downloading_dataset(self, connection, path, account_uid, dataset_uid, dataset_version):
        ...
        if creds is None or creds['data'] is None:
            logging.getLogger(LOGGER).warning("Unable to get provider credentials. Exiting.")
            return -1
