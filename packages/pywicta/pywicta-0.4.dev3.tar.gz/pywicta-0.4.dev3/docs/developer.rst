...
.. warning::
   ...
   `pywicta` package. If you just want to write code that uses it
...
This will create a conda virtual environment called `pywi-cta-dev` with all
...
.. _available on GitHub: https://github.com/jeremiedecock/pywi-cta
...
.. _TODO.md: https://github.com/jeremiedecock/pywi-cta/blob/master/TODO.md
