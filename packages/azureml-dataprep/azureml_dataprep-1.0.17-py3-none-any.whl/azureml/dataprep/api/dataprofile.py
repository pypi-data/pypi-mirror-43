...
from .engineapi.typedefinitions import ActivityReference, DataField, ExecuteInspectorCommonArguments, FieldType, InspectorArguments, ProfileResult, Moments, Quantiles, HistogramBin, ValueCount, TypeCount, STypeCount, SType
...
class DataProfile:
    ...
    @classmethod
    def _from_execution(cls, engine_api: EngineAPI, context: ActivityReference, include_stype_counts: bool = False):
...
class ColumnProfile(ProfileResult):
    ...
    @property
    def max(self) -> object:
        return super(ColumnProfile, self).max.value

    @property
    def min(self) -> object:
        return super(ColumnProfile, self).min.value
