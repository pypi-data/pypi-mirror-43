...
class Dataflow:
    ...
    def get_profile(self, include_stype_counts: bool = False, number_of_histogram_bins: int = 10) -> DataProfile:
        ...
        :param include_stype_counts: Whether to include checking if values look like some well know semantic types of
            information. For Example, "email address". Turning this on will slow gathering the profile.
        :paramtype boolean
    ...
    def dtypes(self) -> Dict[str, FieldType]:
        """
        Gets column types for the current dataset by calling :meth:`get_profile` and extracting just dtypes from
