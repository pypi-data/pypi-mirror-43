...
class DataProfileDifference:
    def __init__(self,
        column_profile_difference: object = None
    ):
        self._pod = {
    ...
    @property
    def column_profile_difference(self) -> object:
        return self._pod['columnProfileDifference']

    @column_profile_difference.setter
    def column_profile_difference(self, value: object):
