...
from autotextboxkv import AutoTextBoxKV
from datetextbox   import DateTextBox
from combokv       import ComboKV
from listboxkv     import ListBoxKV
...
def demo():
    ...
    date1 = DateTextBox(datebox, width=20, align='left')   # empty one    
    def date1_set():
    ...
    datetext.tk.config(anchor='w')
    datetext2.tk.config(anchor='w')
    date2 = DateTextBox(datebox, width=20, 
