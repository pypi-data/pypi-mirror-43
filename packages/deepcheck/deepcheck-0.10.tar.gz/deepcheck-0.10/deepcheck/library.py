...
def print_confusion_matrix_table(tp, tp_, tp_difference, fp, fp_, fp_difference, fn, fn_, fn_difference, tn, tn_, tn_difference):
    ...
    table.column_headers = ["TP: " + str(round((tp * 100), 2)) + "% --> " + str(round((tp_ * 100), 2)) + "% = " + str(round((tp_difference * 100), 2)) + "%", "FP: " + str(round((fp * 100), 2)) + "% --> " + str(round((fp_ * 100), 2)) + "% = " + str(round((fp_difference * 100), 2)) + "%"]
    table.append_row(["FN: " + str(round((fn * 100), 2)) + "% --> " + str(round((fn_ * 100), 2)) + "% = " + str(round((fn_difference * 100), 2)) + "%", "TN: " + str(round((tn * 100), 2)) + "% --> " + str(round((tn_ * 100), 2)) + "% = " + str(round((tn_difference * 100), 2)) + "%"])
    print(table)
