...
def split(data, label_field, text_fileds, train_frac=0.8, dev=False, clust_func=None, vec_func=None):
    ...
    train, test2 = train_test_split(train, test_size=test_size, stratify=data['cluster'], random_state=1)
    train, test3 = train_test_split(train, test_size=test_size, stratify=data[label_field], random_state=1)
