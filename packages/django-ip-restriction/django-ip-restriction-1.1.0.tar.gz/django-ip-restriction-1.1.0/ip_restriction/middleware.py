...
class IpWhitelister():
    ...
    def is_blocked_ip(self, request, allowed_ips, allowed_ip_ranges):
        ...
        # Account for CloudFront forwarded IPs
        if cloudfront and self.REAL_IP_POSITION and len(request_ip) > self.REAL_IP_POSITION:
            request_ip = [request_ip[self.REAL_IP_POSITION]]
