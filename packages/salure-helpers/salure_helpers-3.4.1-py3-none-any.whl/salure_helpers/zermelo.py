...
class Zermelo():
    ...
    def run_all_extracts(self):
        ...
        self.get_zermelo(endpoint='plannedlessons', fields=['id', 'clockHoursPerLesson', 'plannedGroups', 'lessonDemand', 'branchOfSchool', 'departmentOfBranches', 'subjects', 'sectionOfBranches', 'maxTeachingLevel', 'regularTeachingAssignments', 'lessonHoursInClassPeriods'],
