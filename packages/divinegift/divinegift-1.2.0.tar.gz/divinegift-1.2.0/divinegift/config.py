...
class Settings:
    ...
    def parse_settings(self, file_: str = './settings.ini', encoding: str = 'utf-8', log_changes: bool = True, use_yaml=True):
        """
    ...
    def convert_config(self, file_from: str = './settings.ini', file_to: str = './settings.ini',
