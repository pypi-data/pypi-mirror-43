...
def create_excel(list_, fname, excel_header=None, worksheet='Sheet', start_row=0):
    """
...
def read_excel(filename, excel_header, sheet_name=None, int_columns=None, date_columns=None, start_row=1):
