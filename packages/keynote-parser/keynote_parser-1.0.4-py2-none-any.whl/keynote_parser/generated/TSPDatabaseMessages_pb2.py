...
DatabaseDataArchive = _reflection.GeneratedProtocolMessageType('DatabaseDataArchive', (_message.Message,), dict(
...
DatabaseImageDataArchive = _reflection.GeneratedProtocolMessageType('DatabaseImageDataArchive', (_message.Message,), dict(
