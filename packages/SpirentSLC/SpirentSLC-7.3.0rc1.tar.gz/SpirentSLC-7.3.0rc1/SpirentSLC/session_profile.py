...
class _ResponseBuilder(object):
    ...
    def build(self):
        ...
        return SessionActionResponse(self._response_message, nested_steps=sorted(built_steps, key=lambda resp: resp.id))
...
class _CachedSessionResponse(object):
    ...
    def add_nested(self, response):
        ...
        self._nested_steps = tuple(sorted(updated_steps, key=lambda resp: resp.id))
