...
class SchemaMongoMixin:
    ...
    @pre_dump
    def pro_dump_process(self, data):
    ...
    def valid_mongo_query_fields(cls):
        ...
        valid_mongo_query_fields.add('_id')
...
class BaseSchema(Schema, SchemaMongoMixin):
    ...
    created_at = DateTime(required=False, dump_only=True, description='Schema creation time')
    updated_at = DateTime(required=False, dump_only=True, description='Schema object update time')
    deleted_at = DateTime(required=False, dump_only=True, description='Schema object delete time')


if __name__ == '__main__':
    sb = BaseSchema()
    print(sb.valid_mongo_query_fields())
    sb2 = BaseSchema()
    print(sb2.valid_mongo_query_fields())
