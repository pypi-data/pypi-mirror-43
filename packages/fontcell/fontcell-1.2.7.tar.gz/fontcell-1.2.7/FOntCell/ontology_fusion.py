...
# ##################### #
import Tree_com as treeComp
import doc_managing as doc
import OBO_Formating as obo
import coord_taker as coord
import circ_ontology as co
import pyhtml as h
import makeFigures as make
...
def fuseOntologies3(onto1, onto2
    ...
    if parallelization:
        ...
        doc.save_ods(result, path_to_doc + result_name)
        # save_ods()
        print('Creating OBO resultant file and html')
        if OBO_format_result:
