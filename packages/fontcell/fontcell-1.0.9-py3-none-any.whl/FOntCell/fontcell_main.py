...
def fontcell(path_to_config):
    ...
    topological_euclidean, topological_threshold = rc.read_conf(path_to_config)

    if path_to_config == project_demo_path + os.sep + 'demo_configurations.txt':
        input_folder = project_demo_path + os.sep
        output_folder = project_demo_path + os.sep + 'results' + os.sep
        file_clean_ontology1 = project_demo_path + os.sep + 'file_clean_CELDA.txt'
