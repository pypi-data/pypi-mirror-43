...
def fusion_squares(onto1, onto2, common, resultant, color1, color2, color3, color4, fig_name, name1, name2, r=0.6):
    ...
    rect_a = Rectangle((0, start_a), base_a, height_a, fill=True, color=color_a, alpha=0.3)
    ax.add_patch(rect_a)
    rect_b = Rectangle((start_b, 0), base_b, height_b, fill=True, color=color_b, alpha=0.3)
    ax.add_patch(rect_b)
    rect_final = Rectangle((start_b, 0), base_result, height_b, fill=True, color=color3, alpha=0.3)
    ax.add_patch(rect_final)
    rect_inter = Rectangle((start_b, start_a), base_c, height_c, fill=True, color=color4, alpha=0.3)
    ...
    if label1 == name1:
        plt.text(0, start_a + height_a, label1, horizontalalignment='left', verticalalignment='bottom')
        plt.text(start_b + base_b, height_b, label2, horizontalalignment='right', verticalalignment='bottom')

        plt.text(start_b, start_a + height_a, 'Synonyms', verticalalignment='bottom')
        plt.text(start_b, height_b, 'Resultant Ontology grow', verticalalignment='bottom')
    else:
        plt.text(0, start_a + height_a, label2, horizontalalignment='left', verticalalignment='bottom')
