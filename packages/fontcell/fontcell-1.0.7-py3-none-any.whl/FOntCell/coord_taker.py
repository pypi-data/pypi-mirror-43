...
def take_coordinates(data, result, color, graph1=None, equiv=None):
    ...
    if result:
        ...
        gv.render('dot', format='plain', filepath=proyect_path + os.sep + 'graph.gv')
    else:
        data1 = tc.numerate_nodes_in_edge(data)
...
def parse_documents_coordinates(data, result):
    ...
    root_dir = os.path.dirname(os.path.realpath(__file__))
    proyect_path = root_dir + os.sep + 'fontcell_files'
    x = open(proyect_path + os.sep + 'graph.gv.plain', 'r')
    txt = x.read()
    x.close()
    ...
    if result:
        ...
        root_dir = os.path.dirname(os.path.realpath(__file__))
        proyect_path = root_dir + os.sep + 'fontcell_files'
        doc.save_ods(final_matrix, proyect_path + 'graph_viz_coord.ods')
    else:
        data1 = tc.numerate_nodes_in_edge(data)
        ...
        root_dir = os.path.dirname(os.path.realpath(__file__))
        proyect_path = root_dir + os.sep + 'fontcell_files'
        doc.save_ods(final_matrix, proyect_path + os.sep + 'graph_viz_coord.ods')

    return proyect_path + os.sep + 'fontcell_files' + os.sep + 'graph_viz_coord.ods'
