...
class DataSeries(object):
    ...
    def saveBifurcationDiagram (self, filename, bfPoints, bfLabels, legend=True, cmap=None,
                                xlabel=None, ylabel=None, selections=None, savefig_args=[], savefig_kwargs={}):
        hdr = tpc.getTelluriumDataColumnHeader(self._data)
        npData = tpc.getNumpyData(self._data)
        tpc.saveBifurcationData(filename, npData, hdr, bfPoints, bfLabels, legend, cmap,
                                xlabel, ylabel, selections, savefig_args, savefig_kwargs)
