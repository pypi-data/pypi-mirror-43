...
class KernelExplainer(BlackBoxExplainer):
    ...
    def __init__(self, model, initialization_examples, is_function=False, explain_subset=None, silent=True,
                 nsamples=Defaults.AUTO, features=None, classes=None, nclusters=10, **kwargs):
    ...
    def explain_local(self, evaluation_examples):
        ...
        if self.explain_subset:
            ...
            for ex_idx, example in enumerate(evaluation_examples):
                ...
                tmp_shap_values = self.explainer.shap_values(example, silent=self.silent, nsamples=self.nsamples)
            ...
            shap_values = self.explainer.shap_values(evaluation_examples, silent=self.silent,
