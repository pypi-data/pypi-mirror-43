...
def main(graph=None, model=None):
    ...
    ra = 123.034664 # 3.75464531293933
    dec = -6.5293435 # 0.205076187109334
    redshift = 0.233557
    mwebv = 0.0228761
    ...
    #
    #     return newarrs
    # mjd, flux, fluxerr, passband, zeropoint, photflag = delete_indexes(np.where(np.array(passband) == 'g'), mjd, flux, fluxerr, passband, zeropoint, photflag)
    #
    #
    #
