...
# //  rpnVersion.py
# //
# //  RPN command-line calculator data generator version identification
...
PROGRAM_DESCRIPTION = 'RPN command-line calculator data generator'
