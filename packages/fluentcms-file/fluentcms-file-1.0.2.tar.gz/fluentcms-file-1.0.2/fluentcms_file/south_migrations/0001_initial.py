...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'contentitem_fluentcms_file_fileitem', (
        ...
        db.send_create_signal(u'fluentcms_file', ['FileItem'])


    def backwards(self, orm):
        # Deleting model 'FileItem'
        db.delete_table(u'contentitem_fluentcms_file_fileitem')
