...
$(document).ready(function () {
    ...
    Vue.component('feed', {
        ...
        props: ['id', 'publisher_data', 'publisher_avatar', 'content', 'emojis', 'comments', 'created_at',
            'input_show',
        ...
        methods: {
            ...
            // 显示feed的评论输入框
            show_comment_input: function (to_user) {
                if (to_user) {
            ...
            comment_to_user_name: function () {
                var user_name = this.comment_to_user.first_name || this.comment_to_user.username;
                return "回复 " + user_name + " :"
            },
