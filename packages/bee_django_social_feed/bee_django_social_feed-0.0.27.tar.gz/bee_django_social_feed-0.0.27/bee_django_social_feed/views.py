...
def feeds(request):
    ...
    for e in data:
        ...
        for i in e.emojis:
            ...
            i.user_avatar = user_model.objects.get(pk=i.user_id).get_user_profile_image()
        ...
        for j in e.comments:
            ...
            j.user_avatar = user_model.objects.get(pk=j.user_id).get_user_profile_image()
            if j.to_user:
                j.to_user_data = user_model.objects.values('id', 'username', 'first_name').get(pk=j.to_user.id)
                j.user_avatar = user_model.objects.get(pk=j.to_user.id).get_user_profile_image()
