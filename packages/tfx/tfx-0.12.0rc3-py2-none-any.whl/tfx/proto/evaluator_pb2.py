...
SingleSlicingSpec = _reflection.GeneratedProtocolMessageType('SingleSlicingSpec', (_message.Message,), dict(
...
FeatureSlicingSpec = _reflection.GeneratedProtocolMessageType('FeatureSlicingSpec', (_message.Message,), dict(
