...
from apimaticcalculatorpythonv2.controllers.base_controller import BaseController

class CalculatorEPs(BaseController):

    """A Controller to access Endpoints in the apimaticcalculatorpythonv2 API."""
