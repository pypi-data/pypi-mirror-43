...
namespace __pythran_increments
{
  ...
  {
    {
      static typename __transonic__::type::result_type tmp_global = pythonic::types::make_tuple(pythonic::types::str("0.1.11.post0"));
      return tmp_global;
    }
  }
  ...
  typename strfunc_from_pdf::type<argument_type0, argument_type1, argument_type2, argument_type3, argument_type4>::result_type strfunc_from_pdf::operator()(argument_type0&& rxs, argument_type1&& pdf, argument_type2&& values, argument_type3&& order, argument_type4 absolute) const
  {
    ...
    {
      long  __target139984237320120 = pythonic::__builtin__::getattr(pythonic::types::attr::SIZE{}, rxs);
      for (long  irx=0L; irx < __target139984237320120; irx += 1L)
      {
        ;
...
typename __pythran_increments::strfunc_from_pdf::type<pythonic::types::ndarray<int32_t,pythonic::types::pshape<long>>, pythonic::types::ndarray<double,pythonic::types::pshape<long,long>>, pythonic::types::ndarray<double,pythonic::types::pshape<long,long>>, double, bool>::result_type strfunc_from_pdf0(pythonic::types::ndarray<int32_t,pythonic::types::pshape<long>>&& rxs, pythonic::types::ndarray<double,pythonic::types::pshape<long,long>>&& pdf, pythonic::types::ndarray<double,pythonic::types::pshape<long,long>>&& values, double&& order, bool&& absolute) 
{
...
typename __pythran_increments::strfunc_from_pdf::type<pythonic::types::ndarray<int32_t,pythonic::types::pshape<long>>, pythonic::types::ndarray<double,pythonic::types::pshape<long,long>>, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,pythonic::types::pshape<long,long>>>, double, bool>::result_type strfunc_from_pdf1(pythonic::types::ndarray<int32_t,pythonic::types::pshape<long>>&& rxs, pythonic::types::ndarray<double,pythonic::types::pshape<long,long>>&& pdf, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,pythonic::types::pshape<long,long>>>&& values, double&& order, bool&& absolute) 
{
...
typename __pythran_increments::strfunc_from_pdf::type<pythonic::types::ndarray<int32_t,pythonic::types::pshape<long>>, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,pythonic::types::pshape<long,long>>>, pythonic::types::ndarray<double,pythonic::types::pshape<long,long>>, double, bool>::result_type strfunc_from_pdf2(pythonic::types::ndarray<int32_t,pythonic::types::pshape<long>>&& rxs, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,pythonic::types::pshape<long,long>>>&& pdf, pythonic::types::ndarray<double,pythonic::types::pshape<long,long>>&& values, double&& order, bool&& absolute) 
{
...
typename __pythran_increments::strfunc_from_pdf::type<pythonic::types::ndarray<int32_t,pythonic::types::pshape<long>>, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,pythonic::types::pshape<long,long>>>, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,pythonic::types::pshape<long,long>>>, double, bool>::result_type strfunc_from_pdf3(pythonic::types::ndarray<int32_t,pythonic::types::pshape<long>>&& rxs, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,pythonic::types::pshape<long,long>>>&& pdf, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,pythonic::types::pshape<long,long>>>&& values, double&& order, bool&& absolute) 
{
...
PyErr_Clear();
                ...
                return pythonic::python::raise_invalid_argument(
                               "strfunc_from_pdf", "\n    - strfunc_from_pdf(int32[:], float[:,:], float[:,:], float64, bool)", args, kw);
                });
            }
...
PYTHRAN_MODULE_INIT(increments)(void) {
    ...
    PyObject * theDoc = Py_BuildValue("(sss)",
                                      "0.9.1post0",
                                      "2019-03-07 11:14:52.938958",
                                      "81c90913d9ae01edbccc45700c40ef81042b031c8784e45c7915b8af9838cb19");
    if(! theDoc)
        PYTHRAN_RETURN;
