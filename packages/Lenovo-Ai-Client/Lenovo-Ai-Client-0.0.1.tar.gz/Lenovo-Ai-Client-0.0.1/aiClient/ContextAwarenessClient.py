...
class ContextAwareness(AiBase):
    ...
    def gender_classification(self, options, bit=16, rate=8000, windowSize=2.56):
        """

        """
        data = process_request(options, bit, rate, windowSize)
        ca_gender_detection_url = AiUrl.gender_classification
        return self._request(ca_gender_detection_url, data)

    def scene_classification(self, options, bit=16, rate=8000, windowSize=2.56):
        """
    ...
    def ambient_detection(self, options, bit=16, rate=8000, windowSize=2.56):
        """
    ...
    def infant_crying_detection(self, options, bit=16, rate=8000, windowSize=2.56):
        """
