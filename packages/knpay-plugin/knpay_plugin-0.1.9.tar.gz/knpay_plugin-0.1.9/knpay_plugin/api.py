...
def create_payment_url(amount, gateway_code=None, request=None, extra=None, **data):
    ...
    """
    instance, result = create_payment_transaction(amount=amount, gateway_code=gateway_code, request=request, extra=extra, **data)
    if result:
...
def create_payment_transaction(amount, gateway_code=None, request=None, extra=None, **data):
    """
