...
class ElasticModel(object):
  ...
  @classmethod
  def remote_reindex_wsa(cls, script=None, source_query=None, params=None, target_index=None):
    ...
    cls.remote_reindex(script=script, source_query=source_query, params=params, target_index=target_index)
  ...
  @classmethod
  def remote_reindex(cls, script=None, source_query=None, params=None, target_index=None):
