...
if not folder_mode:
    ...
    if len(list_phs)==0:
        ...
        #print 'SHERLOCK list_pdbs', list_pdbs
        #quit()
        ...
        if phstat_version == 'fortran': # TODO: no python version for this
            ...
            while len(list_phs_rotclu) > 1:
                ...
                for argumlist in list_args:
                    ...
                    # ('chunk_0', './CLUSTERING/', '/xtal/cri4-software/borges/PY/phstat_linux', 2.0, 0, 60, 3, 'sxos', 'e')
                ...
                for output_filename,size_ls in jobs_to_check:
                    ...
                    print 'SHERLOCK name_chunk',name_chunk
                    print 'SHERLOCK clust_fold',clust_fold
                    print "SHERLOCK os.path.join(clust_fold,name_chunk+'_' + str(seed) + '.phi')",os.path.join(clust_fold,name_chunk+'_' + str(seed) + '.phi')
                    os.rename(os.path.join(clust_fold,name_chunk+'_' + str(seed) + '.phi'), os.path.join(clust_fold,name_chunk+'.phi'))
