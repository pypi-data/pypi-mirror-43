...
setuptools.setup(
    ...
    description="A novel and simple framework based on prevalent DL framework and other image processing libs."
                + " v0.0.14: fix a bug in toolkit.toDenseLabel.",
                # + " v0.0.13: new argument num_gpus indicates how many gpus you need.",
                # + " v0.0.12: change the quoting character of label file to |;"
