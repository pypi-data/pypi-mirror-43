...
class FuelDepot(object):
    def __init__(self):
        ...
        self.fetcher = {} # contains batch fetcher of all tankss
        self.modifiable_keys = ['name', 'batch_size', 'if_shuffle', 'height', 'width', 'channel',
                                'resol_ratio', 'spatial_aug', 'p_sa', 'temporal_aug', 'p_ta']

    def loadFuel(self, config=None, name=None, batch_size=None, if_shuffle=True,
                 data_path=None, data_key=None, is_encoded=True,
