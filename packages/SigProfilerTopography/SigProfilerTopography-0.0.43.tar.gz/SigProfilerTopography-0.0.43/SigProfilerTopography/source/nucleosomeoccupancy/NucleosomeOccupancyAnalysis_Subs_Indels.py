...
def fillSignalArrayAndCountArraysIndelsSignatureAdded(inputList):
    ...
    sample2AllIndelsCountArrayDict = initializationForEachChromIndelsSignaturesAdded(
...
def initializationForEachChromIndelsSignaturesAdded(signaturesWithAtLeast10KEligibleMutations2NumberofMutationsDict,sample2SignaturesWithAtLeast10KEligibleMutations2NumberofMutationsDict,indelsSignatures2NumberofMutationsDict):
...
def nucleosome_occupancy_analysis_subs_indels_all_chroms_parallel(genome,outputDir, jobname,singlePointMutationsFilename,indelsFilename,nucleosomeFilename):
    ...
    for chrLong in chrNamesInNucleosomeList:
        ...
        print('for debug March 14, 2019  chrBasedSignalNucleosmeFile starts')
        print(chrBasedSignalNucleosmeFile)
        print('for debug March 14, 2019  chrBasedSignalNucleosmeFile ends')
