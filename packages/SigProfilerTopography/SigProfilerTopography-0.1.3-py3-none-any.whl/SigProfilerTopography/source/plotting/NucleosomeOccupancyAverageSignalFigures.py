...
def nucleosomeOccupancyAverageSignalFigures(outputDir,jobname,figureAugmentation,numberofSimulations):
    ...
    if checkValidness(SIGNATUREBASED,outputDir,jobname):
        ...
        #Indels Signatures
        for indelSignature in indelsSignatures2NumberofMutationsDict:
            indelsSignatureBasedNumberofMutations = indelsSignatures2NumberofMutationsDict[indelSignature]
            plotSignatureBasedAverageNucleosomeOccupancyFigureWithSimulations(None,indelSignature,indelsSignatureBasedNumberofMutations,'Interval around single point mutation (bp)','Average nucleosome signal',
                                                                              outputDir, jobname,isFigureAugmentation,numberofSimulations)
        ...
        for sample in sample2IndelsSignatures2NumberofMutationsDict:
            for signature in sample2IndelsSignatures2NumberofMutationsDict[sample]:
                sampleBasedSignatureBasedNumberofMutations = sample2IndelsSignatures2NumberofMutationsDict[sample][signature]
                plotSignatureBasedAverageNucleosomeOccupancyFigureWithSimulations(sample, signature,sampleBasedSignatureBasedNumberofMutations,
                                                                                      'Interval around single point mutation (bp)','Average nucleosome signal',
                                                                                  outputDir, jobname, isFigureAugmentation,numberofSimulations)
