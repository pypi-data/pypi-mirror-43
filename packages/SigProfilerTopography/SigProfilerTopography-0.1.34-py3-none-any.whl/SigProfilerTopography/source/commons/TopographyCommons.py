...
########################################################################################
def getDecileIndex2NumberofAttributableBasesDict(decileIndex2NumberofAttributableBasesDictFilename):
    decileIndex2NumberofAttributableBasesDict = {}
    decileIndex2NumberofAttributableBasesDictFilePath = os.path.join(current_abs_path,ONE_DIRECTORY_UP,ONE_DIRECTORY_UP,LIB,REPLICATION,decileIndex2NumberofAttributableBasesDictFilename)

    if (os.path.exists(decileIndex2NumberofAttributableBasesDictFilePath)):
        decileIndex2NumberofAttributableBasesDict = readDictionary(decileIndex2NumberofAttributableBasesDictFilePath)
...
########################################################################
def writeDictionaryWithFilePath(dictionary,filepath):
