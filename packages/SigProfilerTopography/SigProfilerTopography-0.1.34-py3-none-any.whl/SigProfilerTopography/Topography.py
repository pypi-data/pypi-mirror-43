...
def runAnalyses(genome, singlePointMutationsFilename,indelsFilename,outputDir,jobname,nucleosomeFilename,replicationTimeFilename,replicationTimeValleyFilename,replicationTimePeakFilename):
    ...
    chromNamesList = chromSizesDict.keys()
    ...
    #
    # nucleosomeOccupancyAnalysis(chromSizesDict,chromNamesList,outputDir,jobname,singlePointMutationsFilename,indelsFilename,nucleosomeFilename)
    # ###############################################
    ...
    if (replicationTimeFilename_woDir not in availableLibraryFilenamesList):
        readReplicationTimeDataAndWriteChrBasedReplicationTimeNPArrays(genome,chromSizesDict,replicationTimeFilename)
        #append
        append2File(replicationTimeFilename_woDir,AVAILABLE_LIBRARY_FILENAMES_PATH)

    replicationTimeAnalysis(chromNamesList,outputDir,jobname,singlePointMutationsFilename,indelsFilename,replicationTimeFilename)
    ###############################################
