...
def generateIntervalVersion(replication_time_wavelet_signal_unprocessed_df):
    ...
    replication_time_wavelet_signal_interval_version_df = pd.DataFrame(rows_list, columns=['chr','start','end','signal'], dtype={'chr': str, 'start': np.int32, 'end': np.int32, 'signal': np.float32})
