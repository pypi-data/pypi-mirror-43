...
def replicationStrandBiasAnalysis(outputDir,jobname,singlePointMutationsFilename,smoothedWaveletRepliseqDataFilename,valleysBEDFilename, peaksBEDFilename,startMutationProbability,endMutationProbability,step):
    ...
    print('For mutation probability threshold: %f' %SUBSTITUTION_MUTATION_SIGNATURE_PROBABILITY_THRESHOLD)
    ...
    signature2ReplicationStrand2CountDict = accumulatedAllChromosomesMutationProbability2Signature2LeadingLaggingStrand2CountDict[SUBSTITUTION_MUTATION_SIGNATURE_PROBABILITY_THRESHOLD]
