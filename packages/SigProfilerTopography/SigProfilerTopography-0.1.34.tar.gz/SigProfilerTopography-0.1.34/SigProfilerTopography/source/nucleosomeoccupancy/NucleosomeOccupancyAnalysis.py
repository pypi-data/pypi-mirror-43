...
##############################################################################################################
#main function
def nucleosomeOccupancyAnalysis(chromSizesDict,chromNamesList,outputDir,jobname,singlePointMutationsFilename, indelsFilename, nucleosomeFilename):
    ...
    # Case: Subs and Indels
    nucleosome_occupancy_analysis_subs_indels_all_chroms_parallel(chromSizesDict,chromNamesList, outputDir, jobname, singlePointMutationsFilename, indelsFilename, nucleosomeFilename)
...
def nucleosome_occupancy_analysis_subs_indels_all_chroms_parallel(chromSizesDict,chromNamesList,outputDir,jobname,singlePointMutationsFilename,indelsFilename,nucleosomeFilename):
