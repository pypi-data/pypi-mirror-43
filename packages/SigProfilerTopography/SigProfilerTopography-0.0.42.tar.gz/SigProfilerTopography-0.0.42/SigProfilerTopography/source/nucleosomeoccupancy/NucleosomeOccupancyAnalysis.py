...
def nucleosomeOccupancyAnalysis(genome,outputDir,jobname,singlePointMutationsFilename, indelsFilename, nucleosomeFilename):
    ...
    # Case 2: SPMs and Indels
        ...
        # NucleosomeOccupancyAnalysis_Subs_Indels.nucleosome_occupancy_analysis_subs_indels_each_chrom_sequential(genome, outputDir, jobname,singlePointMutationsFilename, indelsFilename,nucleosomeFilename)
