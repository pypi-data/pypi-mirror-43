...
def generateNPArrayAndSearchSubsOnNPArray(inputList):
    ...
    type2DecileIndex2NumberofMutationsDict, sample2Type2DecileIndex2NumberofMutationsDict = searchForSubs(sample2NumberofSubsDict,subSignature2NumberofMutationsDict,sample2SubsSignature2NumberofMutationsDict, chrBased_subs_df_split,chrBasedReplicationTimeDataArrayWithDecileIndex)
...
def generateNPArrayAndSearchSubsAndIndelsOnNPArray(inputList):
    ...
    chrLong = inputList[0]
    sample2NumberofSubsDict = inputList[1]
    sample2NumberofIndelsDict = inputList[2]
