...
########################################################
def plotNormalizedMutationDensityFigureWithSimulations(originalTitle, ylabel, normalizedMutationDensityList, sample, signature, analysesType,indelType,barcolor,
    ...
    if (analysesType == INDELBASED):
        if indelType == MICROHOMOLOGY:
            title = 'Microhomology-mediated \nindels'
        elif indelType == REPEAT:
...
def replicationTimeNormalizedMutationDensityFigures(outputDir,jobname,figureAugmentation,numberofSimulations):
    ...
    print('March 21, 2019 debug starts')
    print('sample2IndelsSignature2NumberofMutationsDict')
    print(sample2IndelsSignature2NumberofMutationsDict)
    print('March 21, 2019 debug ends')
    ...
    for analysesType in analysesTypes:
        ...
        # If indels based figures not needed/wanted  following lines can be commented.
            ...
            for sample in sample2SubsSignature2NumberofMutationsDict:
                if signature in sample2SubsSignature2NumberofMutationsDict[sample]:
            ...
            for sample in sample2IndelsSignature2NumberofMutationsDict:
                if signature in sample2IndelsSignature2NumberofMutationsDict[sample]:
                    normalizedMutationData = readNormalizedMutationData(sample, signature,outputDir,jobname)
