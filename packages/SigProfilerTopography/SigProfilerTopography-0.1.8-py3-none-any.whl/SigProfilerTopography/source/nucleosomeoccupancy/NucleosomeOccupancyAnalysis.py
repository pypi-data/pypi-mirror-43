...
def nucleosomeOccupancyAnalysis(genome,outputDir,jobname,singlePointMutationsFilename, indelsFilename, nucleosomeFilename):
    ...
    nucleosome_occupancy_analysis_subs_indels_all_chroms_parallel(genome, outputDir, jobname, singlePointMutationsFilename, indelsFilename, nucleosomeFilename)
...
########################################################################################
def accumulateSplitArraysWithExtraSampleBased(subsSignature2NumberofMutationsDict,indelsSignature2NumberofMutationsDict,
