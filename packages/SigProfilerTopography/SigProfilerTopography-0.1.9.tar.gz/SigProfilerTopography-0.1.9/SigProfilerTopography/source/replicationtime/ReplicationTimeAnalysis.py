...
def replicationTimeAnalysis(genome,outputDir,jobname,singlePointMutationsFileName,indelsFilename,repliseqDataFilename):
    ...
    ##########################################################################################
    sample2SubsSignature2NumberofMutationsDict = getSample2SubsSignature2NumberofMutationsDict()
    ##########################################################################################
    ...
    if (withExtraSampleBasedAnalysis):
        ...
        if (singlePointMutationsFileName!=NOTSET and indelsFilename== NOTSET):
            ...
            ########################################################################################################################################
            type2DecileBasedAllChrAccumulatedCountDict , sample2Type2DecileBasedAllChrAccumulatedCountDict = calculateCountsSPMsandIndelsWithExtraSampleBased(outputDir,jobname,numofProcesses,pool,subsSignature2NumberofMutationsDict,
        ...
        # Case 3: Indels (AggregatedIndels and Indels[Microhomology, Repeat])
            ...
            ########################################################################################################################################
            type2DecileBasedAllChrAccumulatedCountDict, sample2Type2DecileBasedAllChrAccumulatedCountDict = calculateCountsIndelsWithExtraSampleBased(outputDir,jobname,numofProcesses,pool,sample2SubsSignature2NumberofMutationsDict,deciles,chrNamesInReplicationTimeDataList,indelsFilename)
        ...
        if (singlePointMutationsFileName!=NOTSET and indelsFilename== NOTSET):
            ...
            ################ AggregatedSubstitutions and  Signatures starts #######################################
            #######################################################################################################
            type2DecileBasedAllChrAccumulatedCountForAllSinglePointMutationsDict = calculateCountsSPMs(subsSignatures,deciles,chrNamesInReplicationTimeDataList,singlePointMutationsFileName)
            writeReplicationTimeDataForSPMs(outputDir,subsSignatures,jobname,deciles,type2DecileBasedAllChrAccumulatedCountForAllSinglePointMutationsDict)
            #######################################################################################################
            ################ AggregatedSubstitutions and  Signatures ends #########################################
            #######################################################################################################
        ...
        # Case 2: SPMs (AggregatedSubstitutions and Signatures) and Indels (AggregatedIndels and Indels)
            ...
            ################ AggregatedSubstitutions ---  Signatures  --- AggregatedIndels --- Indels starts #######################################
            ########################################################################################################################################
            type2DecileBasedAllChrAccumulatedCountForAllSinglePointMutationsDict = calculateCountsSPMsandIndels(jobname,numofProcesses,pool,subsSignatures,deciles,chrNamesInReplicationTimeDataList,singlePointMutationsFileName,indelsFilename)
