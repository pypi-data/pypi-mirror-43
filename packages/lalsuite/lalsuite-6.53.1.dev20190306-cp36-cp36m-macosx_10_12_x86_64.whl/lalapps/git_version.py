...
id = "66983f7d2e2e2032606d2d08f0ff7a4b8e016d29"
date = "2019-03-3 13:03:03 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "66983f7d2e2e2032606d2d08f0ff7a4b8e016d29":
        return
    msg = "Program id (66983f7d2e2e2032606d2d08f0ff7a4b8e016d29) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
