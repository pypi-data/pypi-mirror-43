...
class QueryItem(sqla_orms.Reconnectable):
	_protected_keys=['_QueryItem'+x for x in ['__item','__engine_creator','__obj_class','__primary_keys']]
...
class Manager(object):
	...
	def create_table(self,table_class: sqla_orms.Base):
		if self.engine.dialect.has_table(self.engine,table_class.__tablename__):
			...
			logsup.logger.inform(f"Creating table '{table_class.__tablename__}' already exists.")
