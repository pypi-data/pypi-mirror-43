...
def cerca_stringa_in_bacino(stringa, bacino, id_licenza=None, id_esca=None,
                            note=None, intervallo=5, consumer_id=None):
    if settings.DEBUG:
    ...
    if id_licenza is None:
        ...
        licenza = read_licenza(id_licenza, consumer_id=consumer_id).get('data')[0]
    ...
    if id_esca is None:
        ...
        esca = read_esca(id_esca, consumer_id=consumer_id).get('data')[0]

    if esca is None:
        esca_body = {
            'stringa': stringa
        }
        esca = create_esca(esca_body, consumer_id=consumer_id).get('data')[0]
    ...
    uscita = create_uscita(obj, consumer_id=consumer_id)
