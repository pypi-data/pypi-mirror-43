...
from trosnoth.const import (
    ...
    ACTION_CHANGE_NICK, ACTION_READY, ACTION_CHAT, ACTION_LEADERBOARD_TOGGLE,
...
class ControlSettingsScreenHelper(object):
    ...
    def setup(self, node):
        ...
        actions = [
            ...
            ACTION_ABANDON_UPGRADE, ACTION_CHANGE_NICK, ACTION_READY,
        ...
        actionNames = {
            ...
            ACTION_CHANGE_NICK: 'Change nickname',
            ACTION_CHAT: 'Chat',
