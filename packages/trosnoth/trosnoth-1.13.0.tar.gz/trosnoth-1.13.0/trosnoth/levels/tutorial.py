...
class TutorialLevel(Level):
    ...
    def start(self):
        ...
        targetBot1 = yield defer.ensureDeferred(self.addControllableBot(
            team=self.redTeam, nick='Target1'))
        targetBot1.setAggression(False)
        self.world.magicallyMovePlayer(
            targetBot1.player, (4096, 950), alive=True)
        targetBot2 = yield defer.ensureDeferred(self.addControllableBot(
        ...
        lemmingBot1 = yield defer.ensureDeferred(self.addControllableBot(
        ...
        lemmingBot2 = yield defer.ensureDeferred(self.addControllableBot(
