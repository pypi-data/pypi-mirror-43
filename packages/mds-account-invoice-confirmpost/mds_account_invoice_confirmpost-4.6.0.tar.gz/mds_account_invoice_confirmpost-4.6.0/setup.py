...
MODULE = 'account_invoice_confirmpost'
PREFIX = 'mds'
...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    description='Queries a confirmation if you post an invoice.',
    ...
    keywords='tryton account invoice confirm',
