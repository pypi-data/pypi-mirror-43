...
MSG_REQUEST = '%s.http_request,code=%d,hostname=%s,request_time=%.1f'
MSG_RESPONSE = '%s.response_code,code=%d,widget_id=%s,method=%s'
...
class StatsD:
    ...
    @run_later_if_enabled
    def http_request(self, code, url, request_time):
        statsd.increment(MSG_REQUEST % (self.name, code, url, request_time))
