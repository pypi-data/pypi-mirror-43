...
class spot_setup(object):
    ...
    def objectivefunction(self,simulation,evaluation, params=None):
        if self._used_algorithm == 'sceua':
            like = spotpy.objectivefunctions.rmse(evaluation,simulation[0])
        else:
            like = spotpy.likelihoods.gaussianLikelihoodMeasErrorOut(evaluation,simulation[0])    
        return like