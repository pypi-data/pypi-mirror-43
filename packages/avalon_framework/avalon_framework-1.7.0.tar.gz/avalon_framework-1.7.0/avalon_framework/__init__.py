...
class Avalon:
    ...
    def info(msg, log=False):
        ...
        """
        Avalon._print('{}[+] INFO: {}{}'.format(Avalon.FG.G, str(msg), Avalon.FM.RST))
    ...
    def time_info(msg, log=False):
        ...
        """
        import datetime
        Avalon._print('{}{}{} [+] INFO: {}{}'.format(Avalon.FM.RST, str(datetime.datetime.now()), Avalon.FG.G, str(msg), Avalon.FM.RST))
        if log and sys.platform != 'win32':
            syslog.syslog(syslog.LOG_INFO, msg)
    ...
    def debug_info(msg, log=True):
        ...
        """
        import datetime
        Avalon._print('{}{} [+] INFO: {}{}'.format(Avalon.FG.DGR, str(datetime.datetime.now()), str(msg), Avalon.FM.RST), file=sys.stderr)
        if log and sys.platform != 'win32':
    ...
    def warning(msg, log=False):
        ...
        """
        Avalon._print('{}{}[!] WARNING: {}{}'.format(Avalon.FG.Y, Avalon.FM.BD, str(msg), Avalon.FM.RST), file=sys.stderr)
        if log and sys.platform != 'win32':
    ...
    def error(msg, log=True):
        ...
        """
        Avalon._print('{}{}[!] ERROR: {}{}'.format(Avalon.FG.R, Avalon.FM.BD, str(msg), Avalon.FM.RST), file=sys.stderr)
        if log and sys.platform != 'win32':
            syslog.syslog(syslog.LOG_WARNING, msg)
    ...
    def debug(msg, log=True):
        ...
        """
        Avalon._print('{}{}[*] DEBUG: {}{}'.format(Avalon.FG.R, Avalon.FM.RDM, str(msg), Avalon.FM.RST), file=sys.stderr)
        if log and sys.platform != 'win32':
            syslog.syslog(syslog.LOG_DEBUG, msg)
    ...
    def gets(msg, default=None, batch=False):
        ...
        Avalon._print('{}{}[?] USER: {}{}'.format(Avalon.FG.Y, Avalon.FM.BD, msg, Avalon.FM.RST), end='')
        return input()
