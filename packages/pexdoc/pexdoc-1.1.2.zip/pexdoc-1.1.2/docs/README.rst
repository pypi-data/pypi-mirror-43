...
.. image::
    ...
    :target: https://dev.azure.com/pmasdev/ptrie/_build?definitionId=5&_a=summary
    :alt: Continuous integration test status

.. image::
    https://img.shields.io/azure-devops/coverage/pmasdev/ptrie/5.svg
    :target: https://dev.azure.com/pmasdev/ptrie/_build?definitionId=5&_a=summary
...
7. Write a unit test which shows that the contributed code works as expected.
   ...
   .. code-block:: console
       ...
       GLOB sdist-make: .../ptrie/setup.py
       py27-pkg inst-nodeps: .../ptrie/.tox/.tmp/package/1/ptrie-1.1.2.zip
       ...
         py27-pkg: commands succeeded
         congratulations :)
       $
