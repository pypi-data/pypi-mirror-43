...
##        gtex_variants = {}
    ...
    atac_seq_species_specific_data_dir = os.path.join(species_specific_data_dir, "atac_data")
...
##            target_dir_name = "_".join([target_species, transcript_id+start_end, str(pval)])
            ...
            if not os.path.exists(os.path.join(target_dir, "TFBSs_found.all.json")):
