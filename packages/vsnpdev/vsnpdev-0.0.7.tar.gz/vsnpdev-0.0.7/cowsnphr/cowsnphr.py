...
class COWSNPhR(object):
    ...
    def ref_file(self):
        ...
        for strain_name in self.strain_name_dict:
            ...
            # gbk = glob(os.path.join(self.ref_path, '*.gbk'))[0]
    ...
    def run_fasttree(self, group_fasta_dict, strain_consolidated_ref_dict, strain_groups, logfile):
        """
    ...
    def __init__(self, seq_path, ref_path, threads):
