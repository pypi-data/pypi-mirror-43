...
if __name__ == "__main__":
    ...
    chrono_start = time.time()
    trajectories = get_solutions_and_related_places(
        '/media/DATA/Projets/dyliss_tgf/cadbiom/decompiled_solutions/')
    print("first step")
    filtered_macs, binary_interactions = filter_trajectories(trajectories, ("TGFB1",))
    print("second step")
    chrono = time.time()
    print(chrono - chrono_start)

#    trajectories = get_solutions_and_related_places('./decompiled_solutions/')
#    filtered_macs, binary_interactions = filter_trajectories(trajectories, ("IL4_exCellRegion",)) #  "STAT6_active_meth_p_cy" "IL4_IL4R_JAK1_IL2Rgamma_JAK3_active_intToMb"

    data = build_interactions(filtered_macs, binary_interactions)
    print("third step")
    build_graph("./graphs/", *data)
    print("fourth step")
