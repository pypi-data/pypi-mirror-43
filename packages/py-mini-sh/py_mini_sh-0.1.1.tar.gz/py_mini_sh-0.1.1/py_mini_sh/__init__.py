...
def exec_(cmd, cwd=None, env=None, ignore_error=False):
...
def run(func, defines):
    ...
    :param defines: The list of extra or redefinitions which are used
        when expanding many of the parameters of the functions defined in
        this package.
    :type defines: dict
