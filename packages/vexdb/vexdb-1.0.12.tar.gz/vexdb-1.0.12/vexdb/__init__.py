"""Thin python3 wrapper for the VexDB API.
By John Holbrook, http://johnholbrook.us.
More about this module at https://github.com/dhmmjoph/python-vexdb.
More about the VexDB API at https://vexdb.io/the_data/.
"""
...
def _urlToJSON(url):
	...
	result = json.loads(_urlRequest(url))
	if (result["status"] == 1):
...
def getNumEvents(sku=None,
	...
	return _urlToSize("http://api.vexdb.io/v1/get_events%s" % params)
...
def getEvents(sku=None,
	...
	if not get_all:
		return _urlToJSON("http://api.vexdb.io/v1/get_events%s" % params)
	else:
		...
		while (current < num_events):
			...
			result += _urlToJSON("http://api.vexdb.io/v1/get_events%s" % this_params)
			current += 2000
		return result
...
def getNumTeams(team=None,
	...
	return _urlToSize("http://api.vexdb.io/v1/get_teams%s" % params)
...
def getTeams(team=None,
	...
	if not get_all:
		return _urlToJSON("http://api.vexdb.io/v1/get_teams%s" % params)
	else:
		...
		while (current < num_teams):
			this_params = params + ("limit_start=%s&limit_number=2000" % current)
			result += _urlToJSON("http://api.vexdb.io/v1/get_teams%s" % this_params)
			current += 2000
		return result
...
def getNumMatches(sku=None,
	...
	return _urlToSize("http://api.vexdb.io/v1/get_matches%s" % params)
...
def getMatches(sku=None,
	...
	if not get_all:
		return _urlToJSON("http://api.vexdb.io/v1/get_matches%s" % params)
	else:
		...
		while (current < num_matches):
			this_params = params + ("limit_start=%s&limit_number=2000" % current)
			result += _urlToJSON("http://api.vexdb.io/v1/get_matches%s" % this_params)
			current += 2000
		return result
...
def getNumRankings(sku=None,
	...
	return _urlToSize("http://api.vexdb.io/v1/get_rankings%s" % params)
...
def getRankings(sku=None,
	...
	if not get_all:
		return _urlToJSON("http://api.vexdb.io/v1/get_rankings%s" % params)
	else:
		...
		while (current < num_rankings):
			this_params = params + ("limit_start=%s&limit_number=2000" % current)
			result += _urlToJSON("http://api.vexdb.io/v1/get_rankings%s" % this_params)
			current += 2000
		return result
...
def getNumSeasonRankings(program=None,
	...
	return _urlToSize("http://api.vexdb.io/v1/get_season_rankings%s" % params)
...
def getSeasonRankings(program=None,
	...
	if not get_all:
		...
		while (current < num_season_rankings):
			this_params = params + ("limit_start=%s&limit_number=2000" % current)
			result += _urlToJSON("http://api.vexdb.io/v1/get_season_rankings%s" % this_params)
			current += 2000
		return result
...
def getNumAwards(sku=None,
	...
	return _urlToSize("http://api.vexdb.io/v1/get_awards%s" % params)
...
def getAwards(sku=None,
	...
	if not get_all:
		return _urlToJSON("http://api.vexdb.io/v1/get_awards%s" % params)
	else:
		...
		while (current < num_awards):
			this_params = params + ("limit_start=%s&limit_number=2000" % current)
			result += _urlToJSON("http://api.vexdb.io/v1/get_awards%s" % this_params)
			current += 2000
		return result
...
def getNumSkills(sku=None,
	...
	return _urlToSize("http://api.vexdb.io/v1/get_skills%s" % params)
...
def getSkills(sku=None,
	...
	if not get_all:
		...
		while (current < num_skills):
			this_params = params + ("limit_start=%s&limit_number=2000" % current)
			result += _urlToJSON("http://api.vexdb.io/v1/get_skills%s" % this_params)
			current += 2000
		return result
