...
class Pump:
    def __init__(self, data):
        ...
        self.df_flow_lift = Tool.dict_to_pd(flow_lift)
        self.df_flow_power = Tool.dict_to_pd(flow_power)
        self.df_freq_flow_lift = Tool.dict_to_pd(freq_flow_lift)
        self.df_freq_flow_power = Tool.dict_to_pd(freq_flow_power)
        ...
        def high_model_train(df_train, df_valid, k):
            ...
            mape = Tool.mean_absolute_percentage_error(df_mape['true'], df_mape['predict'])
            # print(mape)
