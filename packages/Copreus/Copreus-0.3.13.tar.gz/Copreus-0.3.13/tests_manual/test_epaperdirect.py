...
topic_sub_full_image = config["device"]["topics-sub"]["full_image"]
topic_sub_partial_image = config["device"]["topics-sub"]["partial_image"]
topic_sub_switch_frame = config["device"]["topics-sub"]["switch_frame"]
command_switch_frame = config["device"]["mqtt-translations"]["switch_frame"]
