...
from sfeprapy.time_equivalence_mc import calc_time_equiv_worker, mc_inputs_generator, calc_time_equivalence
    ...
    for i, dict_mc_params in enumerate(list_dict_input_files):
        ...
        if 'path_mc_params_csv' in dict_mc_params:  # Read MC parameters. If USER provided MC parameters in a *.csv file
            ...
            if os.path.exists(path_input_file_) and os.path.isfile(path_input_file_) and False:
                ...
                df_mc_params = mc_inputs_generator(index=True, **dict_mc_params)
