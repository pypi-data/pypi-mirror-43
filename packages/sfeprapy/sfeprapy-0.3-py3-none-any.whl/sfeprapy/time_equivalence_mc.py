...
def calc_time_equivalence(
    ...
    :param fire_types_enforce: 0 - parametric, 1 - travelling, 2 - ger parametric, 3 - (0 & 1), 4 (1 & 2)
    ...
    if fire_types_enforce == 0:  # enforced to ec parametric fire
    ...
    elif fire_types_enforce == 1:  # enforced to travelling fire
    ...
    elif fire_types_enforce == 2: # enforced to german parametric fire
    ...
    elif fire_types_enforce == 3:  # enforced to ec parametric + travelling
    ...
    elif fire_types_enforce == 4:  # enforced to german parametric + travelling
