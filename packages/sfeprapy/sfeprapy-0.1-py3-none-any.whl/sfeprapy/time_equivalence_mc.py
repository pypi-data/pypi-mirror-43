...
def calc_time_equivalence(
    ...
    :param fire_type_enforced: 0 - parametric, 1 - travelling, 2 - ger parametric, 3 - (0 & 1) & 4 (1 & 2)
    ...
    # Used to define fire curve start time, depreciated on 11/03/2019 after introducing the german annex ec parametric
    # fire.
    time_start = 0
    ...
    elif fire_type_enforced == 1:  # enforced to travelling fire

        fire_temp = _fire_travelling(
            fire_time,
            fire_load_density,
            fire_hrr_density,
            room_depth,
    ...
    elif fire_type_enforced == 2: # enforced to german parametric fire

        fire_temp = _fire_param_ger(
            t_array_s=fire_time,
            A_w_m2=window_area,
    ...
    elif fire_type_enforced == 3:  # enforced to ec parametric + travelling
    ...
    elif fire_type_enforced == 4:  # enforced to german parametric + travelling

        if 0.125 <= (window_area / room_floor_area) <= 0.5:  # If fire spreads throughout compartment and ventilation is within EC limits = Parametric fire
