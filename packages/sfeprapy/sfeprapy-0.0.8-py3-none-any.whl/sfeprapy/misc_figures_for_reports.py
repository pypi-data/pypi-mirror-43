...
def main():
    ...
    mini_plot3(
        fig_=fig,
        ax_=ax,
        x=[time_fire_param / 60., time_fire_travel / 60.],
        y=[temp_fire_param - 273.15, temp_fire_travel - 273.15],
        legend=['Parametric fire', 'Travelling fire'],
        fig_name='fire_param_and_travel.png',
        xlabel='Time',
        ylabel='Temperature',
        xlim=(0, 120),
        ylim=(0, 1400)
