...
VERSION = '0.1b5' #.dev3' # This is going to be the only time that a beta version is released at PyPi. The following alpha, beta and dev versions are going to be released at https://test.pypi.org/project/visualml/
