...
from nqontrol.servo import _convertStepsize2Frequency, _convertVolt2Int
from nqontrol import general
...
class MockADwin():
    ...
    def Get_Processdelay(self, index):
