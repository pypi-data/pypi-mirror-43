...
def make_raw(module, renderer=None):
    print(read(render_doc(Helper(module).help(module)[0], Helper(module).help(module)[1], renderer=renderer)))
    return read(render_doc(Helper(module).help(module)[0], Helper(module).help(module)[1], renderer=renderer))
...
from os_sys import commands
for i in dir(commands):
    try:
        make_doc(i)
