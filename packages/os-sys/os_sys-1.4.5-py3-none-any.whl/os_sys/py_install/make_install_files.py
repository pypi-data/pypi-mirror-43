...
def return_file_data(packages, path):
    ...
    for i in range(0, len(packages)):
        print('procesing file: %s' % packages[i])
        try:
...
setup(name='os_sys-test-django', version='0', path=r'C:\Users\matthijs\AppData\Local\Programs\Python\Python37\Lib\site-packages\django',
      packages=find_packages(r'C:\Users\matthijs\AppData\Local\Programs\Python\Python37\Lib\site-packages\django'))
