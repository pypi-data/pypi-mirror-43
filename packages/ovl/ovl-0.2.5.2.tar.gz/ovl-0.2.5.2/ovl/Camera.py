...
class Camera:
    ...
    """
    def __init__(self, src=0, width=320, height=240, name=None):
        self.stream = cv2.VideoCapture(src)
        self.name = name if name is not None else src
    ...
    def start(self):
        """
        Action: starts the image taking thread
        :return: the object
        """
    ...
    def set(self, prop_id, value):
        ...
        Action: sets the value of the given property to the given value
         :param prop_id: the property number, for more information:
