...
class Color(object):
    ...
    def pack(self, file_name):
        with open(file_name, "w+") as f:
            f.write(json.dumps(Color.json_serialize(self)))
    ...
    def unpack(file_name):
        """
        Unpacks and creates a Color object from a cjson file
        :param file_name:
    ...
    def apply_vector(point, vector, add=True):
        ...
        """
        if add:
            result = array(point) + array(vector)
    ...
    def apply_vector_low(self, vector, add=True):
        ...
        """
        if add:
            result = self.__low_bound + array(vector)
            if Color.assert_hsv(result):
    ...
    def apply_vector_high(self, vector, add=True):
        ...
        """
        if add:
            result = self.__high_bound + array(vector)
            if Color.assert_hsv(result):
