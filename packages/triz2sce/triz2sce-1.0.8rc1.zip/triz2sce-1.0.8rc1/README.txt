...
Triz2sce versión 1.0.8rc1 190316 (c) 2018 Pedro Fernández
...
- Debido al comportamiento ligeramente distinto del intérprete inglés, intentar meter un objeto contenedor dentro de sí mismo en una obra inglesa, en lugar de un mensaje de error hace que el jugador deje el objeto en la localidad actual.
...
- **1.0.8rc1 190316**
 ...
 - Añadido soporte para el verbo "vaciar".

- **1.0.8b2** 190312

 - Chequeos adicionales para evitar que el nombre de los objetos pueda ser una cadena nula o espacios en blanco.

- **1.0.8b1** 190226

 - Añadido soporte para contenedores en inglés.
 - La palabra "todo" funciona también para meter y sacar objetos de los contenedores.

- **1.0.8b0** 190223

 - Añadido soporte experimental para el atributo [c] (contenedor) (sólo en espñol, de momento)
...
Triz2sce version 1.0.8rc1 190316 (c) 2018 Pedro Fernández
...
- Due to the slighty different behavior of the english interpreter, trying to put a container object inside itself in an english work, instead of displaying an error message will make player drop the object at current location.
...
- **1.0.8rc1** 190316
 ...
 - Added support for the "empty" verb.

- **1.0.8.b2** 190312

 - Extra-checks to avoid object names being null strings or white spaces.

- **1.0.8b1** 190226

 - Added support for containers in english.
 - The word "all" now works when puting things in or getting them out from containers.

- **1.0.8b0** 190223

 - Added experimental support for [c] (container) atribute in objects (spanish only)
