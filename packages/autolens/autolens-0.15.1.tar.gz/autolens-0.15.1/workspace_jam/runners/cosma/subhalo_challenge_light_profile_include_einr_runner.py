...
from workspace_jam.pipelines import pipeline_subhalo_light_profile_no_lens_light_include_einr

pipeline = pipeline_subhalo_light_profile_no_lens_light_include_einr.make_pipeline(phase_folders=[data_type, data_level, data_name])
