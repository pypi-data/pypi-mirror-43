...
from workspace_jam.pipelines.lens_light_included.initializers import lens_light_sersic_mass_sie_source_sersic

pipeline = lens_light_sersic_mass_sie_source_sersic.make_pipeline(phase_folders=[data_type, data_name])
