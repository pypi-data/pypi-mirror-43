...
def make_pipeline(phase_folders=None):
    ...
    phase3 = InversionPhase(phase_name='phase_3_power_law', phase_folders=phase_folders,
    ...
    class GridPhase(ph.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            self.lens_galaxies.lens.mass = results.from_phase('phase_3_power_law').constant.lens.mass
            self.lens_galaxies.lens.shear = results.from_phase('phase_3_power_law').variable.lens.shear
            self.source_galaxies.source.pixelization = results.from_phase('phase_3_power_law').constant.source.pixelization
            self.source_galaxies.source.regularization = results.from_phase('phase_3_power_law').constant.source.regularization
    ...
    phase4 = GridPhase(phase_name='phase_4_sensitivity', phase_folders=phase_folders,
                       lens_galaxies=dict(lens=gm.GalaxyModel(mass=mp.EllipticalPowerLaw,
                                                              shear=mp.ExternalShear),
    ...
    class GridPhase(autofit_ph.as_grid_search(ph.LensSourcePlanePhase)):
        ...
        def pass_priors(self, results):
            ...
            self.lens_galaxies.lens.mass.centre = results.from_phase('phase_3_power_law').constant.lens.mass.centre
            self.lens_galaxies.lens.mass.axis_ratio = \
                results.from_phase('phase_3_power_law').constant.lens.mass.axis_ratio
            self.lens_galaxies.lens.mass.phi = results.from_phase('phase_3_power_law').constant.lens.mass.phi
            self.lens_galaxies.lens.mass.slope = results.from_phase('phase_3_power_law').constant.lens.mass.slope

            self.lens_galaxies.lens.mass.einstein_radius = \
                results.from_phase('phase_3_power_law').variable.lens.mass.einstein_radius

            self.lens_galaxies.lens.shear = results.from_phase('phase_3_power_law').constant.lens.shear

            self.source_galaxies.source.pixelization = \
                results.from_phase('phase_3_power_law').constant.source.pixelization
            self.source_galaxies.source.regularization = \
                results.from_phase('phase_3_power_law').constant.variable.regularization


    phase5 = GridPhase(phase_name='phase_5_subhalo_search', phase_folders=phase_folders,
                       lens_galaxies=dict(lens=gm.GalaxyModel(mass=mp.EllipticalPowerLaw,
                                                              shear=mp.ExternalShear),
                                          subhalo=gm.GalaxyModel(mass=mp.SphericalNFW)),
                       source_galaxies=dict(source=gm.GalaxyModel(pixelization=pix.AdaptiveMagnification,
