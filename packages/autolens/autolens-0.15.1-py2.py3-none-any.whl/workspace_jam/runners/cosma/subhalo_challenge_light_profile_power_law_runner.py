...
from workspace_jam.pipelines import pipeline_subhalo_light_profile_no_lens_light_power_law

pipeline = pipeline_subhalo_light_profile_no_lens_light_power_law.make_pipeline(phase_folders=[data_type, data_level,
                                                                                               data_name])
