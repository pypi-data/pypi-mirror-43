    ...
    def masses_of_all_samples(self, radius_kpc):
        ...
        for i in range(len(self.pdf.samples)):
            ...
            if self.pdf.weights[i] > 1e-6:
                ...
                disk_mass = self.critical_density_arcsec * self.lens_galaxy.disk.angular_mass_within_circle(radius=radius_arc)
        ...
        for r in range(number_bins):
            ...
            for i in range(len(self.pdf.samples)):
                ...
                if self.pdf.weights[i] > weight_cut:
                    ...
                    disk_density = self.critical_density_arcsec * (self.lens_galaxy.disk.angular_mass_within_circle(radii[r + 1]) -
                                                                   self.lens_galaxy.disk.angular_mass_within_circle(radii[r])) / annuli_area
