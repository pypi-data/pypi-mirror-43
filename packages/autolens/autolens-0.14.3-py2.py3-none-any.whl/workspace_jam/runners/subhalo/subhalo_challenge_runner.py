...
data_path = path_util.make_and_return_path_from_path_and_folder_names(
    path=workspace_path, folder_names=[data_type, data_level, data_name])
...
pipeline = \
    pipeline_subhalo_inversion_no_lens_light.make_pipeline(phase_folders=[data_type, data_level, data_type])
