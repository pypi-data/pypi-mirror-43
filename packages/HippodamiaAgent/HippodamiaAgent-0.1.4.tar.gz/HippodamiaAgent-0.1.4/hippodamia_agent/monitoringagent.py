...
_RESTART_TERMINATED = 1  # time to be waited in state terminated until next onboarding attemt is started. (seconds)
...
class MonitoringAgent:
    ...
    def _init_state_machine(self):
        self._sigint = Event()
        self._state_machine, self._states = hippodamia_agent.states.state_machine\
        ...
        self._states[state_ids.INITIALIZED].send_onboarding_request = self.send_onboarding_request
