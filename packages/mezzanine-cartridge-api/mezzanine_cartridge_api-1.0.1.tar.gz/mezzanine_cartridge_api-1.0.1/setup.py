...
setuptools.setup(
    ...
    data_files=[('templates', ['mezzanine_cartridge_api/templates/rest_framework_swagger/http.html', 'mezzanine_cartridge_api/templates/rest_framework_swagger/https.html'])],
