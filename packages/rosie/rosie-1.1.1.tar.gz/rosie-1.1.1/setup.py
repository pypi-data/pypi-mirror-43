...
setup(
    ...
    # Do NOT set include_package_data to True, else the directory
    # contents will be included in the binary (wheel) distribution!
...
Prerequisites:
    ...
    Rosie (see https://gitlab.com/rosie-pattern-language/rosie)
