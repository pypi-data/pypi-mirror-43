...
from zybats import exceptions, runner
from zybats.core import loader
from zybats.utils import deep_update_dict
...
class TestRunner(ApiServerUnittest):
    ...
    def setUp(self):
        ...
        self.atsfunc_functions = project_mapping["functions"]
        ...
        self.test_runner = runner.Runner(config, self.atsfunc_functions)
        self.reset_all()
    ...
    def test_run_single_testcase(self):
        ...
        for testcase_file_path in testcase_file_path_list:
            ...
            config_dict = {}
            test_runner = runner.Runner(config_dict, self.atsfunc_functions)
