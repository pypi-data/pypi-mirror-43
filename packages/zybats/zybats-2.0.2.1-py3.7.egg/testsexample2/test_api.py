...
from zybats import parser
from zybats.core import loader
from zybats.core.api import zybats, prepare_locust_tests
from tests.api_server import HTTPBIN_SERVER
from tests.base import ApiServerUnittest


class Testzybats(ApiServerUnittest):
    ...
    def setUp(self):
        ...
        self.runner = zybats(failfast=True)
        self.reset_all()
    ...
    def test_html_report(self):
        ...
        runner = zybats(failfast=True, report_dir=report_save_dir)
    ...
    def test_log_file(self):
        ...
        runner = zybats(failfast=True, log_file=log_file_path)
        runner.run(self.testcase_cli_path)
    ...
    def test_run_zybats_with_hooks(self):
    ...
    def test_run_zybats_with_teardown_hooks_alter_response(self):
        testcases = [
            {
    ...
    def test_run_zybats_with_teardown_hooks_not_exist_attribute(self):
        testcases = [
            {
                "config": {
                    "name": "test teardown hooks"
    ...
    def test_run_zybats_with_teardown_hooks_error(self):
        testcases = [
            {
                "config": {
                    "name": "test teardown hooks"
