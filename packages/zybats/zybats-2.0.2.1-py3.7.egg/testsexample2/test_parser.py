...
from zybats import exceptions, parser
...
class TestParser(unittest.TestCase):
    ...
    def test_parse_parameters_custom_function(self):
        ...
        from tests import atsfunc
        cartesian_product_parameters = parser.parse_parameters(
            parameters,
            functions_mapping=loader.load_module_functions(atsfunc)
        )
        self.assertIn(
            {
                'user_agent': 'iOS/10.1',
    ...
    def test_parse_tests_base_url_priority(self):
        ...
        self.assertEqual(test_dict["request"]["url"], "https://zybats.org/api1")
    ...
    def test_parse_data_with_variables(self):
        ...
        from tests.atsfunc import sum_two
        functions = {
            "sum_two": sum_two
        }
    ...
    def test_parse_tests_variable_with_function(self):
        ...
        self.assertEqual(
            ...
            "https://zybats.org/api1/?num1=3&num2=6&num3=10"
        )
    ...
    def test_parse_tests_variable_not_found(self):
        ...
        self.assertEqual(
            test_dict["request"]["url"],
            "https://zybats.org/api1/?num1=3&num2=6&num3=10&num4=${sum_two($num0, 5)}"
        )
    ...
    def test_parse_tests_base_url_teststep_empty(self):
        ...
        parsed_tests_mapping = parser.parse_tests(tests_mapping)
        test_dict = parsed_tests_mapping["testcases"][0]["teststeps"][0]
        self.assertEqual(test_dict["request"]["url"], "https://atsfunc.com/api1")
        self.assertEqual(test_dict["request"]["verify"], True)
    ...
    def test_extend_with_api(self):
        ...
        self.assertEqual(extended_block["base_url"], "https://atsfunc.com")
