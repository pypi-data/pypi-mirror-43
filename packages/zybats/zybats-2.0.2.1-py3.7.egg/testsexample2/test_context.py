...
import requests
from zybats import context, exceptions, response
...
class TestContext(ApiServerUnittest):
    ...
    def test_update_seesion_variables(self):
        self.context.update_session_variables({"TOKEN": "atsfunc"})
        self.assertEqual(
    ...
    def test_get_parsed_request(self):
        ...
        self.assertEqual(parsed_request["headers"]["secret_key"], "atsfunc")
