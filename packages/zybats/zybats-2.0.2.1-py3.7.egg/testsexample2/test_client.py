from zybats.client import HttpSession
from zybats.compat import bytes
...
class TestHttpClient(ApiServerUnittest):
    ...
    def test_request_redirect(self):
        url = "{}/redirect-to?url=https%3A%2F%2Fatsfunc.com&status_code=302".format(HTTPBIN_SERVER)
        ...
        self.assertEqual(redirect_request.url, "https://atsfunc.com")
