...
from zybats.compat import basestring, bytes, is_py2
from zybats.exceptions import ParamsError
...
def create_scaffold(project_name):
    ...
    path_list = [
        ...
        (os.path.join(project_name, "logs"), "folder"),
        (os.path.join(project_name, "data"), "folder"),
        (os.path.join(project_name, "atsfunc.py"), "file"),
...
def dump_tests(tests_mapping, tag_name):
    ...
    for key in project_mapping:
        ...
        if project_mapping["functions"]:
            atsfunc_py_path = os.path.join(pwd_dir_path, "atsfunc.py")
            tests_to_dump["project_mapping"]["atsfunc.py"] = atsfunc_py_path
