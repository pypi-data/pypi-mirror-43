...
def main_zats():
    ...
    from zybats.__about__ import __description__, __version__
    from zybats.core.api import zybats
    from zybats.compat import is_py2
    from zybats.utils import (create_scaffold, get_python2_retire_msg,
    ...
    try:
        for path in args.testcase_paths:
            logger.setup_logger(args.log_level, args.log_file, args.testcase_paths[0])
