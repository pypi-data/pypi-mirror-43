...
from zybats.utils import build_url, lower_dict_keys, omit_long_data
...
class HttpSession(requests.Session):
    ...
    to be able to log in and out of websites). Each request is logged so that zybats can
    display statistics.
    ...
    from a zybats class' host property.
    """
