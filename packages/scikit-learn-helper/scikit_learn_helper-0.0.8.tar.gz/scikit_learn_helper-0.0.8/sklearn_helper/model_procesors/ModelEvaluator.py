...
class ModelEvaluator:
    ...
    def test_model_using_cross_validation(self, model_name, model, data_cleaner, X, y):
    ...
    def __calculate__metric(self, model, X, y, metric_name):
        return cross_val_score(model, X, y, cv=self.data_splitter, scoring=metric_name, n_jobs=self.n_jobs).mean()
