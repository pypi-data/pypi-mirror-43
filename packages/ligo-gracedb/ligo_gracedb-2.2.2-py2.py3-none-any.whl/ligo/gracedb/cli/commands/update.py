...
class UpdateSignoffCommand(UpdateChildBase):
    ...
    def add_custom_arguments(self, parser):
        ...
        parser.add_argument("--status", type=str,
            help=("Signoff status (do '{prog} show signoff_statuses') to see "
            "options").format(prog=self.base_prog))
    ...
    def run(self, client, args):
        ...
        return client.update_signoff(args.superevent_id, args.signoff_type,
