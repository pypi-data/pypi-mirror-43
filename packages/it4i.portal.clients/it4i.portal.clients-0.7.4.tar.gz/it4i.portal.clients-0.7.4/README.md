...
```console
$ motd_rss --help
usage: motd_rss -h|--help
       motd_rss [OPTION] ... -t|--text FEED_SOURCE ...
       motd_rss [OPTION] ... -t|--text -i [FEED_SOURCE ...]
       motd_rss [OPTION] ... -m <page_template>|--html=<page_template> FEED_SOURCE ...
       motd_rss [OPTION] ... -m <page_template>|--html=<page_template> -i [FEED_SOURCE ...]
...
```console
$ motd_rss -l5 -t https://scs.it4i.cz/api/v1/motd/all
