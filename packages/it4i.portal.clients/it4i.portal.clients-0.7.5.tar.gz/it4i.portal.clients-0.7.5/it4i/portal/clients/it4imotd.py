...
def main():
    ...
    parser = argparse.ArgumentParser(description="The command shows IT4I messages of the day into formatted text or HTML page.")
    parser.add_argument('-t', '--template',
                        action='store',
                        help="path to TAL / Zope Page Template, output will be formatted into HTML page")
    parser.add_argument('-w', '--width',
                        default=78,
                        type=int,
                        action='store',
                        help="maximum line width (intended for text rendering, default of 78 columns)")
