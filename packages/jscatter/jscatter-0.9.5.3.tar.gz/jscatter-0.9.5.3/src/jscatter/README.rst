...
2. **Read/Write data**
 ...
 Additional typical detector images from SAXS cameras can be read as :ref:`2D sasImage`.
...
The development platform is mainly current Linux (Manjaro/CentOs/Ubuntu).
I regularly use Jscatter on macOS. I regularly use it on multi core systems or on our Linux cluster.
