...
#
# Created: Sun Mar 10 18:19:17 2019
...
"}")
        ...
        self.iso_view_button.setStyleSheet("")
        self.iso_view_button.setCheckable(True)
        ...
        self.x_view_button.setCheckable(True)
        ...
        self.y_view_button.setCheckable(True)
        ...
        self.z_view_button.setCheckable(True)
        ...
        self.program_zoom_button.setCheckable(True)
        ...
        self.machine_zoom_button.setCheckable(True)
...
"}")
        ...
        self.widget_6 = QtWidgets.QWidget(self.conversational_tab)
        self.widget_6.setGeometry(QtCore.QRect(1220, 200, 171, 281))
...
"}")
        ...
        self.frame_29.setGeometry(QtCore.QRect(7, 31, 201, 600))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}")
        ...
        self.probe_tab_widget.setCurrentIndex(7)
    ...
    def retranslateUi(self, Form):
        ...
        self.zoom_in_button.setText(_translate("Form", "ZOOM IN"))
        self.zoom_out_button.setText(_translate("Form", "ZOOM OUT"))
        self.label_32.setText(_translate("Form", "TextLabel"))
        self.program_zoom_button.setText(_translate("Form", "PGM EXTS"))
        self.machine_zoom_button.setText(_translate("Form", "MCH EXTS"))
