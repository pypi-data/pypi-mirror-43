...
__all__ = (
    '_eps', '_small', '_tiny', '_huge', '_pi', 'resource_path', 'separator')
...
resource_path = os.path.abspath(
    os.path.dirname(os.path.abspath(__file__)) + (
            separator + '..') * 1 + separator + 'resources' + separator)

toy_config_path = resource_path + 'toy_config.json'
toy_emap_path = resource_path + 'emap' + separator + 'sum_emap.npy'
