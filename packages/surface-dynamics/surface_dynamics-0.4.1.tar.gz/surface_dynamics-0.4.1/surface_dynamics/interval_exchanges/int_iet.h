...
// TODO: we should use a templated value for the lengths and height
// in order to be able to switch between
// - machine integers (such as uint64_t)
// - GMP integers (mpz_t)
// - various floating point
// - balls
// To do so, one has to be extra careful with the conditions in Rauzy
// induction.
//
// if (ltop > lbot)
//    generic induction
...
// else
//    stop there as we can not decide (can happen for balls)
