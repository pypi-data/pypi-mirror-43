...
class AbstractMicroservice:
    ...
    def __init__(self, config, config_class_root_node_name,
                 ...
                 manage_monitoring_agent=True, manage_ui=True):
        """
        Constructor
        ...
        :param mange_ui: create and control a ui instance
        """
        ...
        if manage_monitoring_agent:
            if "monitoring-agent" in config:
                ...
                self._add_ui_command("monitoring_onboarding_state", self._cmd_monitoring_agent_onboarding_state)
    ...
    def _cmd_monitoring_agent_onboarding_state(self, args):
        """onboarding_state - show the current onboarding state (monitoring agent): ONBOARDING_STATE"""
        test = self._monitoring_agent.current_state().__class__.__name__
        pelops.ui.tools.more(test)

    def _cmd_mqtt_stats(self, args):
        """mqtt_stats - show the send/recv statistics (mqtt client): MQTT_STATS"""
