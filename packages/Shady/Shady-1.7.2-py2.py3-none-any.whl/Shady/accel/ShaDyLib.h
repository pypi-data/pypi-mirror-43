...
#define SHADYLIB_MINOR_VERSION 7  /*     values, to find out the version of the code that   */
...
SHADYLIB_FUNC(  void              ,    ShaDyLib_Renderer_WaitForFrames                    ,  ( ShaDyLib_Renderer r, int yesOrNo )                                     ,   DO( RENDERER->mWaitForFrames = yesOrNo )                                                                      )
