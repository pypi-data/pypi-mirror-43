...
corresponded to each of them. If you have ever seen a wasp try to get out of a half-open
window, then you have a good mental picture of how we build on Linux. But we do at least
know that it's possible to build a working accelerator, at least on a Ubuntu 14
VirtualBox. (In the same way, the wasp usually gets out eventually.)
