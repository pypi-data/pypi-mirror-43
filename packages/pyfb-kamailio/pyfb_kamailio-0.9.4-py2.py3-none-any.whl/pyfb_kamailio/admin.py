...
class AccAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ['method', 'from_user', 'from_domain', 'ruri_user', 'ruri_domain', 'callid', 'sip_code', 'sip_reason', 'time', 'time_attr', 'time_exten', 'cseq', 'ruri_user', 'ruri_domain', 'from_tag', 'to_tag']
