...
`,H=r(1442),N=r.n(H);function B(e){let t="0.[00]a";return 0===e?"0":(e>1e14||e<1e-5?t="0.[000]e+0":e<1&&(t="0.[0000]a"),N()(e).format(t))}const Z=m.c.p`
  margin: 20px 0 5px;
`,R=m.c.g`
  & text {
    text-anchor: end;
...
`,st=({metadata:e})=>{const t=e&&e.sampled?a.createElement("span",null,a.createElement("b",null,"NOTE:")," This data is sampled"):null;return a.createElement(ot,null,t?a.createElement(lt,null,t):null)},ct=m.c.div`
  display: flex;
