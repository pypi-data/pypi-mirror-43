...
class Config(_ConfigBase):
    ...
    application_name = _ConfigValue("APPLICATION_NAME", default=None)
    ...
    try:
        ...
        for logger_name in ["stackifyapm", "stackifyapm.traces", "stackifyapm.errors"]:
            ...
            if "error" in logger_name:
                logger.addHandler(logging.FileHandler("{}{}.err".format(LOG_PATH, logger_name)))
            else:
                logger.addHandler(logging.FileHandler("{}{}.out".format(LOG_PATH, logger_name)))
    except Exception:
