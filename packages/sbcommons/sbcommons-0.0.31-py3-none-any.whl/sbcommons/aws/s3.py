...
def put_object(bucket_name: str, key: str, content: str, content_type: str = 'application/json'):
    bucket = s3_bucket(bucket_name)
    obj = bucket.Object(key=key)
    obj.put(Body=content, ContentType=content_type)
...
def generate_presigned_url(bucket_name: str, key: str, expires_in: int = 86_400):
