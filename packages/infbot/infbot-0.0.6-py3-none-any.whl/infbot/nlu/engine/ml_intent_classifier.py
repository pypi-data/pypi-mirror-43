...
class MLIntentClassifier(EngineCore):
    ...
    def build_model(self,
        ...
        if faq_questions:
            ...
            y_class_domain += ['___FAQ'] * len(faq_questions)
            y_class_intent += ['___FAQ'] * len(faq_questions)
        ...
        print(f'ml_intent_classifier intent class {len(intent_class_index)}')
        ...
        print(f'ml_intent_classifier domain class {len(domain_class_index)}')
