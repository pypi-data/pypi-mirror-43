...
from . import _utils
from .exceptions import HTTPError, ClientError, StateError, ServerError, NotFoundError
...
class ModelDBClient:
    ...
    def set_experiment(self, expt_name=None, desc=None, tags=None, attrs=None):
        if self.proj is None:
            raise StateError("a project must first in progress")
    ...
    def set_experiment_run(self, expt_run_name=None, desc=None, tags=None, attrs=None):
        if self.expt is None:
            raise StateError("an experiment must first in progress")
    ...
    def __init__(self, auth, socket,
        ...
        if _proj_id is not None:
            ...
            if proj is not None:
                ...
                raise NotFoundError("Project with ID {} not found".format(_proj_id))
        else:
    ...
    def __init__(self, auth, socket,
        ...
        if _expt_id is not None:
            ...
            if expt is not None:
                ...
                raise NotFoundError("Experiment with ID {} not found".format(_expt_id))
...
class ExperimentRuns:
    ...
    def find(self, where, ret_all_info=False, *, _proj_id=None, _expt_id=None):
        ...
        msg = Message(project_id=_proj_id, experiment_id=_expt_id,
    ...
    def sort(self, key, descending=False, ret_all_info=False):
        ...
        msg = _ExperimentRunService.SortExperimentRuns(experiment_run_ids=self._ids, sort_key=key,
                                                       ascending=not descending, ids_only=not ret_all_info)
        data = _utils.jsonify(msg)
    ...
    def top_k(self, key, k, ret_all_info=False, *, _proj_id=None, _expt_id=None):
        ...
        msg = _ExperimentRunService.TopExperimentRunsSelector(project_id=_proj_id, experiment_id=_expt_id,
                                                              experiment_run_ids=expt_run_ids,
                                                              sort_key=key, ascending=False, top_k=k,
    ...
    def bottom_k(self, key, k, ret_all_info=False, *, _proj_id=None, _expt_id=None):
        ...
        msg = _ExperimentRunService.TopExperimentRunsSelector(project_id=_proj_id, experiment_id=_expt_id,
                                                              experiment_run_ids=expt_run_ids,
                                                              sort_key=key, ascending=True, top_k=k,
                                                              ids_only=not ret_all_info)
        data = _utils.jsonify(msg)
        response = requests.get("http://{}/v1/experiment-run/getTopExperimentRuns".format(self._socket),
                                params=data, headers=self._auth)
    ...
    def __init__(self, auth, socket,
        ...
        if _expt_run_id is not None:
            ...
            if expt_run is not None:
                ...
                raise NotFoundError("ExperimentRun with ID {} not found".format(_expt_run_id))
