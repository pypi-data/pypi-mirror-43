...
class Persister(object):
    ...
    def execute_deleter(self, item_cls, commit=None):
        """ Deletes models according to `deleter_selector_fields`
        and `deleter_keeper_fields`. See their description in
        ...
        if not item_cls.metadata['model_deleter']:
            return
        item_cls.metadata['model_deleter'].execute(self.adapter_cls,
