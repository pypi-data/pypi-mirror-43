...
def getStorageHost(spark):
    ossBucketName = spark.sparkContext._conf.get(OSS_BUCKET_NAME_CONF)
...
class File(object):
    def __init__(self, spark, filepath, mode="r"):
        ...
        self.ioUtils = self.sc._jvm.org.apache.commons.io.IOUtils
        self.uri = self.sc._jvm.java.net.URI
