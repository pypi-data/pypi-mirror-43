...
class Handler(Component):
    ...
    def init(self, message):
        ...
        handlerContext = self._getContext(message)
        args, restArgs = self.loadComponentArguments(handlerContext, restArgs=restArgs)
...
class Stream(interfaces.HasBaseServices, interfaces.HasLogger, interfaces.HasDevMode):
    ...
    STREAM_ARGUMENTS = [
        ...
        Int("stream-recv-queue-retry-timeout", default=1000),
