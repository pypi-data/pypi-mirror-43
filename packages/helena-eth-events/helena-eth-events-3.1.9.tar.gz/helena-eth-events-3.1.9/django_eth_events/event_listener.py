            ...
            for contract in self.contract_map:
                ...
                if decoded_logs:
                    ...
                    for log in decoded_logs:
                        # Save events
                        logger.info('4 ;) Lets decode')
                        logger.info('5 ;) This is the log %s', log)    
