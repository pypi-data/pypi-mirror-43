...
class EventInfo:
    def __init__(self, wallet, token, **kwargs):
        ...
        self.start_time = helpers.gen_timestamp(str(kwargs.get('start_time')))
        self.end_time = helpers.gen_timestamp(str(kwargs.get('end_time')))
        self.ticket_price = int(kwargs.get('ticket_price'))
