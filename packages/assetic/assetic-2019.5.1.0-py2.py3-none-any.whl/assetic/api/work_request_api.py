...
class WorkRequestApi(object):
    ...
    def work_request_post_0(self, work_request, **kwargs):  # noqa: E501
        """Create new Work Request  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.work_request_post_0(work_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.work_request_post_0_with_http_info(work_request, **kwargs)  # noqa: E501
        else:
            (data) = self.work_request_post_0_with_http_info(work_request, **kwargs)  # noqa: E501
            return data

    def work_request_post_0_with_http_info(self, work_request, **kwargs):  # noqa: E501
        """Create new Work Request  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.work_request_post_0_with_http_info(work_request, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method work_request_post_0" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('work_request' not in params or
            ...
            raise ValueError("Missing the required parameter `work_request` when calling `work_request_post_0`")  # noqa: E501
    ...
    def work_request_put(self, id, work_request, **kwargs):  # noqa: E501
        ...
        :param Assetic3IntegrationRepresentationsWorkRequest work_request: (required)
        :return: Assetic3IntegrationRepresentationsWorkRequest
                 If the method is called asynchronously,
                 returns the request thread.
        """
