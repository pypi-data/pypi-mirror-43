...
**Release 2019.3.2.1**
    *   Assessment form create will leave value as NULL if not defined rather than setting to same value as the label
    If the control type is not correctly defined it will no longer default to text but instead abort
