...
class TopicDelta(object):
    ...
    def __init__(self, dataset=None, query=None, custom_stop_words=None, num_topics=None, num_keywords=None, metadata_selection=None, period_0_start=None, period_0_end=None, period_1_start=None, period_1_end=None, excluded_docs=None):  # noqa: E501
        """TopicDelta - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def dataset(self):
        """Gets the dataset of this TopicDelta.  # noqa: E501

        Dataset name.  # noqa: E501

        :return: The dataset of this TopicDelta.  # noqa: E501
        :rtype: str
        """
    ...
    def dataset(self, dataset):
        """Sets the dataset of this TopicDelta.

        Dataset name.  # noqa: E501

        :param dataset: The dataset of this TopicDelta.  # noqa: E501
        :type: str
        """
        if dataset is None:
    ...
    def query(self, query):
        """Sets the query of this TopicDelta.

        Fulltext query, using mysql MATCH boolean query format. Example, (\"word1\" OR \"word2\") AND (\"word3\" OR \"word4\")  # noqa: E501

        :param query: The query of this TopicDelta.  # noqa: E501
        :type: str
        """
    ...
    def custom_stop_words(self):
        """Gets the custom_stop_words of this TopicDelta.  # noqa: E501


        :return: The custom_stop_words of this TopicDelta.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def custom_stop_words(self, custom_stop_words):
        """Sets the custom_stop_words of this TopicDelta.


        :param custom_stop_words: The custom_stop_words of this TopicDelta.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def num_topics(self):
        """Gets the num_topics of this TopicDelta.  # noqa: E501

        Number of topics to be extracted from the dataset and summarized.  # noqa: E501

        :return: The num_topics of this TopicDelta.  # noqa: E501
        :rtype: int
        """
    ...
    def num_topics(self, num_topics):
        """Sets the num_topics of this TopicDelta.

        Number of topics to be extracted from the dataset and summarized.  # noqa: E501

        :param num_topics: The num_topics of this TopicDelta.  # noqa: E501
        :type: int
        """
    ...
    def num_keywords(self):
        """Gets the num_keywords of this TopicDelta.  # noqa: E501

        Number of keywords per topic that is extracted from the dataset.  # noqa: E501

        :return: The num_keywords of this TopicDelta.  # noqa: E501
        :rtype: int
        """
    ...
    def num_keywords(self, num_keywords):
        """Sets the num_keywords of this TopicDelta.

        Number of keywords per topic that is extracted from the dataset.  # noqa: E501

        :param num_keywords: The num_keywords of this TopicDelta.  # noqa: E501
        :type: int
        """
    ...
    def metadata_selection(self):
        """Gets the metadata_selection of this TopicDelta.  # noqa: E501

        JSON object specifying metadata-based queries on the dataset, of type {\"metadata_field\": \"selected_values\"}  # noqa: E501

        :return: The metadata_selection of this TopicDelta.  # noqa: E501
        :rtype: object
        """
    ...
    def metadata_selection(self, metadata_selection):
        """Sets the metadata_selection of this TopicDelta.

        JSON object specifying metadata-based queries on the dataset, of type {\"metadata_field\": \"selected_values\"}  # noqa: E501

        :param metadata_selection: The metadata_selection of this TopicDelta.  # noqa: E501
        :type: object
        """
    ...
    def period_0_start(self):
        """Gets the period_0_start of this TopicDelta.  # noqa: E501

        Start date for the initial-period dataset. Format: \"YYYY-MM-DD HH:MM:SS\"   # noqa: E501

        :return: The period_0_start of this TopicDelta.  # noqa: E501
        :rtype: str
        """
    ...
    def period_0_start(self, period_0_start):
        """Sets the period_0_start of this TopicDelta.

        Start date for the initial-period dataset. Format: \"YYYY-MM-DD HH:MM:SS\"   # noqa: E501

        :param period_0_start: The period_0_start of this TopicDelta.  # noqa: E501
        :type: str
        """
    ...
    def period_0_end(self):
        """Gets the period_0_end of this TopicDelta.  # noqa: E501

        End date for the initial-period dataset. Format: \"YYYY-MM-DD HH:MM:SS\"   # noqa: E501

        :return: The period_0_end of this TopicDelta.  # noqa: E501
        :rtype: str
        """
    ...
    def period_0_end(self, period_0_end):
        """Sets the period_0_end of this TopicDelta.

        End date for the initial-period dataset. Format: \"YYYY-MM-DD HH:MM:SS\"   # noqa: E501

        :param period_0_end: The period_0_end of this TopicDelta.  # noqa: E501
        :type: str
        """
    ...
    def period_1_start(self):
        """Gets the period_1_start of this TopicDelta.  # noqa: E501

        Start date for the final-period dataset. Format: \"YYYY-MM-DD HH:MM:SS\"   # noqa: E501

        :return: The period_1_start of this TopicDelta.  # noqa: E501
        :rtype: str
        """
    ...
    def period_1_start(self, period_1_start):
        """Sets the period_1_start of this TopicDelta.

        Start date for the final-period dataset. Format: \"YYYY-MM-DD HH:MM:SS\"   # noqa: E501

        :param period_1_start: The period_1_start of this TopicDelta.  # noqa: E501
        :type: str
        """
    ...
    def period_1_end(self):
        """Gets the period_1_end of this TopicDelta.  # noqa: E501

        End date for the final-period dataset. Format: \"YYYY-MM-DD HH:MM:SS\"   # noqa: E501

        :return: The period_1_end of this TopicDelta.  # noqa: E501
        :rtype: str
        """
    ...
    def period_1_end(self, period_1_end):
        """Sets the period_1_end of this TopicDelta.

        End date for the final-period dataset. Format: \"YYYY-MM-DD HH:MM:SS\"   # noqa: E501

        :param period_1_end: The period_1_end of this TopicDelta.  # noqa: E501
        :type: str
        """
    ...
    def excluded_docs(self):
        """Gets the excluded_docs of this TopicDelta.  # noqa: E501


        :return: The excluded_docs of this TopicDelta.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def excluded_docs(self, excluded_docs):
        """Sets the excluded_docs of this TopicDelta.


        :param excluded_docs: The excluded_docs of this TopicDelta.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TopicDelta):
            return False
