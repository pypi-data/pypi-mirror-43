...
setup(
    ...
    author_email='git@voronenko.com',
    description=('Unofficial build of develop branch for Ansible Container empowers you to orchestrate, build, run, and ship '
