...
from cubicweb_vcsfile.entities import Repository
from cubicweb_vcsfile.docparser import Diff2HTMLTransform
    ...
    def run(self):
        ...
        try:
            ...
            try:
                ...
                raise self.severe(e)
            self.warning('Could not get included file at revision "%s", '
