...
if __name__ == "__main__":
    ...
    print("random_weibull(location=1.0, scale=1.0)")
    floor_distribution_timer(random_weibull, location=1.0, scale=1.0)
    ...
    floor_distribution_timer(random_chi_squared, degrees_of_freedom=1.0)
    print("random_cauchy(location=0.0, scale=0.0005)")
    round_distribution_timer(random_cauchy, location=0.0, scale=0.0005)
    print("random_fisher_f(degrees_of_freedom_1=8.0, degrees_of_freedom_2=8.0)")
    floor_distribution_timer(random_fisher_f, degrees_of_freedom_1=8.0, degrees_of_freedom_2=8.0)
