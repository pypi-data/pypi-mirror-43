(window.webpackJsonp=window.webpackJsonp||[]).push([[13],{773:function(a,t,i){"use strict";i.r(t);var e=i(5),s=(i(188),i(195),i(83),i(44));customElements.define("dialog-area-registry-detail",class extends e.a{constructor(...a){super(...a),this.hass=void 0,this._name=void 0,this._error=void 0,this._params=void 0,this._submitting=void 0}static get properties(){return{_error:{},_name:{},_params:{}}}async showDialog(a){this._params=a,this._error=void 0,this._name=this._params.entry?this._params.entry.name:"",await this.updateComplete}render(){if(!this._params)return e.e``;const a=""===this._name.trim();return e.e`
      <paper-dialog
        with-backdrop
        opened
    ...
    `}_nameChanged(a){this._error=void 0,this._name=a.detail.value}async _updateEntry(){this._submitting=!0;try{const a={name:this._name.trim()};this._params.entry?await this._params.updateEntry(a):await this._params.createEntry(a),this._params=void 0}catch(a){this._error=a}finally{this._submitting=!1}}async _deleteEntry(){this._submitting=!0;try{await this._params.removeEntry()&&(this._params=void 0)}finally{this._submitting=!1}}_openedChanged(a){a.detail.value||(this._params=void 0)}static get styles(){return[s.b,e.c`
        paper-dialog {
          min-width: 400px;
        }
        .form {
