...
class SetupIBMCloudServicesRest(SetupIBMCloudServices):
    ...
    def __init__(self):
        ...
        iam_access_token = TokenManager(
            ...
            url=Args.env_dict['iam_url']
        ).get_token()
        self.resourceController = ResourceController(
            access_token=iam_access_token,
            url=Args.env_dict['resource_controller_url'],
            resourceGroupUrl=Args.env_dict['resource_group_url']
        )
        uaa_access_token = TokenManager(
            apikey=Args.args.apikey,
            url=Args.env_dict['uaa_url'],
            iam_token=False
        ).get_token()
    ...
    def _get_credentials(self, params, is_rc_based, credentials_file=None):
        ...
        if credentials_file is not None:
            ...
            credentials = self.resourceController.get_or_create_instance(
                ...
                resource_group_name=Args.args.resource_group,
            ...
            credentials = self.cloudFoundry.get_or_create_instance(
                ...
                organization_name=Args.args.organization,
                space_name=Args.args.space
            )
    ...
    def setup_wml(self):
        ...
        return self._get_credentials(wml_params, True, Args.args.wml)['credentials']
    ...
    def setup_cos(self):
        ...
        credentials = self._get_credentials(cos_params, True, Args.args.cos)['credentials']
