...
#query = """SELECT esb_timestamp, datatype_ttaaii, datatype_cccc, datatype_nnn, datatype_yygggg FROM edp.nwwproduct WHERE (received_via != 'WEBIMG') AND (esb_timestamp >= '2019-03-02' AND esb_timestamp < '2019-03-06')""" #QA
print "Running query..."

# Copy the results to a new file
outputquery = "COPY ({0}) to STDOUT WITH CSV HEADER".format(query)
with open('Database_Query.csv', 'w') as f:
