...
def main():
    ...
    parser_create.add_argument("--dag", action="store_true", default=False, help="Do not execute anything and print the directed acyclic graph of package dependency in the dot language. Recommended use on Unix systems: mungo create --dag | dot | display")
    ...
    parser_install.add_argument("--dag", action="store_true", default=False, help="Do not execute anything and print the directed acyclic graph of package dependency in the dot language. Recommended use on Unix systems: mungo create --dag | dot | display")
    ...
    if command == "create":
        create_environment(name, channels, packages, pip, jobs, dag)
    elif command == "install":
        install_packages(name, channels, packages, pip, jobs, dag)
