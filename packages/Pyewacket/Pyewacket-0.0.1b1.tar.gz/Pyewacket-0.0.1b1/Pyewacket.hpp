...
auto vortex(S storm) {
    ...
    if (fate == 0 ) return storm(default_random);
    if (fate == 1 ) return storm(shuffle);
    if (fate == 2 ) return storm(drop);
    if (fate == 3 ) return storm(scramble);
    if (fate == 4 ) return storm(mt64);
    if (fate == 5 ) return storm(shuffle_mt64);
    if (fate == 6 ) return storm(drop_mt64);
    if (fate == 7 ) return storm(hurricane);
    if (fate == 8 ) return storm(minstd);
    if (fate == 9 ) return storm(shuffle_minstd);
    if (fate == 10) return storm(drop_minstd);
    if (fate == 11) return storm(scram_minstd);
    if (fate == 12) return storm(knuth);
    if (fate == 13) return storm(scram_knuth);
    if (fate == 14) return storm(lux24);
    if (fate == 15) return storm(scram_lux24);
    if (fate == 16) return storm(lux48);
    return storm(scram_lux48);
}
