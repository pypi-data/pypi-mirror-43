...
# -*- coding: utf-8 -*-
# @Author: zcy
# @Date:   2019-02-09 21:21:50
# @Last Modified by:   zcy
# @Last Modified time: 2019-03-05 17:56:20
...
class InceptionResNetV2(BaseModel):
    ...
    def features(self, input):
        ...
        super(InceptionResNetV2, self).isValidSize(x) #check the input size
    ...
    def forward(self, input):
        ...
        # the output should be 1*1 with 1536 channels 
