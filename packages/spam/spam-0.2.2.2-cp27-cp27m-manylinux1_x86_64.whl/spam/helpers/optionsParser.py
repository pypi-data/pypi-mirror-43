...
def DICregularGridParser(parser):
    ...
    parser.add_argument('-ps',
                        ...
                        default='auto',
                        dest='PS',
                        help="Pixel search option. Accepted values are: \"auto\": disactivate pixel search if registration works, or Ffile is given."+\
                             "\"on\": Force a pixel search in any case (rounds initial giess and can lose initial F). \"off\": block pixel search. \"auto\" is default")
