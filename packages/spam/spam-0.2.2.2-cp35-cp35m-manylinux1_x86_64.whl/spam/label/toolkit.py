...
def getBoundingBoxes(lab): print("spam.label.getBoundingBoxes(): This function has been renamed to boundingBoxes, please update your code"); return
...
def getCentresOfMass(lab, boundingBoxes=None, minVol=None): print("spam.label.getCentresOfMass(): This function has been renamed to centresOfMass, please update your code"); return
...
def getVolumes(lab, boundingBoxes=None): print("spam.label.getVolumes(): This function has been renamed to volumes, please update your code"); return
...
def getEquivalentRadii(lab, boundingBoxes=None, volumes=None): print("spam.label.getEquivalentRadii(): This function has been renamed to equivalentRadii, please update your code"); return
...
def getMomentOfInertia(lab, boundingBoxes=None, minVol=None, centresOfMass=None): print("spam.label.getMomentOfInertia(): This function has been renamed to momentOfInertia, please update your code"); return
...
def getEllipseAxes(lab, volumes=None, MOIeigenValues=None, enforceVolume=True, twoD=False): print("spam.label.getEllipseAxes(): This function has been renamed to ellipseAxes, please update your code"); return
...
def getLabelsOnEdges(lab):  print("spam.label.getLabelsOnEdges(): This function has been renamed to labelsOnEdges, please update your code"); return
...
def getLabelledTetrahedra(dims, coordinates, connectivity): print("spam.label.getLabelledTetrahedra(): This function has been renamed to labelTetrahedra, please update your code"); return
...
def getLabelledTetrahedraForScipyDelaunay(dims, delaunay): print("spam.label.getLabelledTetrahedraForScipyDelaunay(): This function has been renamed to labelTetrahedraForScipyDelaunay, please update your code"); return
