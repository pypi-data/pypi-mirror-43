...
def sentry_integration(starlette_app: starlette.applications.Starlette) -> None:
    starlette_app.add_event_handler('startup', functools.partial(init_sentry_integration, starlette_app))
...
def aiohttp_integration(starlette_app: starlette.applications.Starlette) -> None:
    starlette_app.add_event_handler('startup', functools.partial(init_aiohttp_session, starlette_app))
    starlette_app.add_event_handler('shutdown', functools.partial(close_aiohttp_session, starlette_app))
