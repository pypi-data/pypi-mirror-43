...
class Array(Object):
    ...
    if _newclass:
        castFrom = staticmethod(_VisusKernelPy.Array_castFrom)
    else:
        castFrom = _VisusKernelPy.Array_castFrom
...
def Array_castFrom(obj):
    return _VisusKernelPy.Array_castFrom(obj)
Array_castFrom = _VisusKernelPy.Array_castFrom
...
class ArrayUtils(_object):
    ...
    __repr__ = _swig_repr
    if _newclass:
        toArrayVector = staticmethod(_VisusKernelPy.ArrayUtils_toArrayVector)
    else:
        toArrayVector = _VisusKernelPy.ArrayUtils_toArrayVector
    if _newclass:
    ...
    if _newclass:
        maxNumComponents = staticmethod(_VisusKernelPy.ArrayUtils_maxNumComponents)
    else:
        maxNumComponents = _VisusKernelPy.ArrayUtils_maxNumComponents
    if _newclass:
...
def ArrayUtils_toArrayVector(v):
    return _VisusKernelPy.ArrayUtils_toArrayVector(v)
ArrayUtils_toArrayVector = _VisusKernelPy.ArrayUtils_toArrayVector
...
def ArrayUtils_maxNumComponents(src, max_num_components):
    return _VisusKernelPy.ArrayUtils_maxNumComponents(src, max_num_components)
ArrayUtils_maxNumComponents = _VisusKernelPy.ArrayUtils_maxNumComponents
