...
class itkOBJMeshIO(itkMeshIOBasePython.itkMeshIOBase):
    ...
    def GetPointer(self) -> "itkOBJMeshIO *":
        """GetPointer(itkOBJMeshIO self) -> itkOBJMeshIO"""
        return _itkOBJMeshIOPython.itkOBJMeshIO_GetPointer(self)
...
itkOBJMeshIO.GetPointer = new_instancemethod(_itkOBJMeshIOPython.itkOBJMeshIO_GetPointer, None, itkOBJMeshIO)
...
class itkOBJMeshIOFactory(ITKCommonBasePython.itkObjectFactoryBase):
    ...
    def GetPointer(self) -> "itkOBJMeshIOFactory *":
        """GetPointer(itkOBJMeshIOFactory self) -> itkOBJMeshIOFactory"""
        return _itkOBJMeshIOPython.itkOBJMeshIOFactory_GetPointer(self)
...
itkOBJMeshIOFactory.GetPointer = new_instancemethod(_itkOBJMeshIOPython.itkOBJMeshIOFactory_GetPointer, None, itkOBJMeshIOFactory)
