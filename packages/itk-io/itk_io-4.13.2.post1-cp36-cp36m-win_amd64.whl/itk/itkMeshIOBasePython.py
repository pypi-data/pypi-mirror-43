...
class itkMeshIOBase(ITKCommonBasePython.itkLightProcessObject):
    ...
    def GetPointer(self) -> "itkMeshIOBase *":
        """GetPointer(itkMeshIOBase self) -> itkMeshIOBase"""
        return _itkMeshIOBasePython.itkMeshIOBase_GetPointer(self)
...
itkMeshIOBase.GetPointer = new_instancemethod(_itkMeshIOBasePython.itkMeshIOBase_GetPointer, None, itkMeshIOBase)
