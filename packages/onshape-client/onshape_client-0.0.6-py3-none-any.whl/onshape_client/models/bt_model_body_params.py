...
class BTModelBodyParams(object):
    ...
    def __init__(self, part_query=None, part_id=None, element_microversion_id=None, document_id=None, configuration=None, workspace_id=None, element_id=None):  # noqa: E501
