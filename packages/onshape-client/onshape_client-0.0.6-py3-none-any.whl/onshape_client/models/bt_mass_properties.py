...
class BTMassProperties(object):
    ...
    def __init__(self, volume=None, periphery=None, centroid=None, inertia=None, mass=None, has_mass=None, mass_missing_count=None, type_id=None, export_type_name=None, connection_source=None, unknown_class=None):  # noqa: E501
