...
class BTMatchingStandardContentHierarchyInfo(object):
    ...
    def __init__(self, type=None, standard_default=None, category_default=None, types_default=None, type_default=None, category=None, standard=None, types=None, component_document_id=None, name=None, id=None, view_ref=None, href=None):  # noqa: E501
