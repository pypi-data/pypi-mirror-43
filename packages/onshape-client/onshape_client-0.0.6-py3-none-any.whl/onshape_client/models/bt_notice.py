...
class BTNotice(object):
    ...
    def __init__(self, location_infos=None, message=None, stack_trace=None, type=None, try_node=None, level=None, parameter_id=None, changeable_child_field_indices=None, first_child_field=None, child_list_indices=None, node_id=None, child_map_indices=None, atomic_child_indices=None, node_id_raw=None, type_id=None, export_type_name=None, connection_source=None, unknown_class=None):  # noqa: E501
