...
class BTPurchaseParams(object):
    ...
    def __init__(self, password=None, user_id=None, light_seats=None, allow_deprecated_plan=None, email=None, plan_id=None, seats=None, domain_prefix=None, payment_type=None, trial_period_days=None, reseller_name=None):  # noqa: E501
