...
class BTFeatureDefinitionResponse(object):
    ...
    def __init__(self, feature_state=None, feature=None, bel_script_library_version=None, serialization_version=None, reject_microversion_skew=None, microversion_skew=None, library_version=None, source_microversion=None, type_id=None, export_type_name=None, connection_source=None, unknown_class=None):  # noqa: E501
