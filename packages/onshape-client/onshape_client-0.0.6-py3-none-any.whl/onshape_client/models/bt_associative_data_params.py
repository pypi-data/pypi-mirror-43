...
class BTAssociativeDataParams(object):
    ...
    def __init__(self, type=None, data=None, microversion_id=None, id_tag=None, document_microversion=None, associative_data_id=None, operation=None, view_id=None, occurrence_id=None, is_hidden_base_view=None, version_id=None, document_id=None, configuration=None, workspace_id=None, element_id=None):  # noqa: E501
