...
class BTExportModelBody(object):
    ...
    def __init__(self, id=None, type=None, faces=None, vertices=None, edges=None, type_id=None, export_type_name=None, connection_source=None, unknown_class=None):  # noqa: E501
