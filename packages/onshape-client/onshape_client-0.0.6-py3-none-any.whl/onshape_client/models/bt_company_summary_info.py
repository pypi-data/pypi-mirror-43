...
class BTCompanySummaryInfo(object):
    ...
    def __init__(self, state=None, type=None, enterprise_base_url=None, description=None, no_public_documents=None, domain_prefix=None, owner_id=None, image=None, admin=None, name=None, id=None, view_ref=None, href=None):  # noqa: E501
