...
class GlobalPermissionInfo(object):
    ...
    def __init__(self, delete_permanently=None, access_reports=None, create_project=None, approve_releases=None, admin_enterprise=None, manage_rbac=None, manage_users=None, manage_guest_users=None, create_releases=None, share_for_anonymous_access=None):  # noqa: E501
