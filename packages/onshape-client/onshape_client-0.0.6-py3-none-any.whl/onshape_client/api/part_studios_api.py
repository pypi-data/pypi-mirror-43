...
class PartStudiosApi(object):
    ...
    def eval_feature_script(self, did, wvm, wvmid, eid, configuration, **kwargs):  # noqa: E501
        """Evaluate FeatureScript  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.eval_feature_script(did, wvm, wvmid, eid, configuration, async_req=True)
        >>> result = thread.get()
        ...
        :param str wvmid: Workspace (w), Version (v) or Microversion (m) ID. (required)
        :param str eid: Element ID. (required)
        :param str configuration: Configuration string. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.eval_feature_script_with_http_info(did, wvm, wvmid, eid, configuration, **kwargs)  # noqa: E501
        else:
            (data) = self.eval_feature_script_with_http_info(did, wvm, wvmid, eid, configuration, **kwargs)  # noqa: E501
            return data

    def eval_feature_script_with_http_info(self, did, wvm, wvmid, eid, configuration, **kwargs):  # noqa: E501
        """Evaluate FeatureScript  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.eval_feature_script_with_http_info(did, wvm, wvmid, eid, configuration, async_req=True)
        >>> result = thread.get()
        ...
        if ('configuration' not in local_var_params or
                local_var_params['configuration'] is None):
            raise ValueError("Missing the required parameter `configuration` when calling `eval_feature_script`")  # noqa: E501
