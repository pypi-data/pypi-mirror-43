...
class BTBillingPlanSummaryInfo(object):
    ...
    def __init__(self, hidden=None, onshape_plan=None, description=None, application_id=None, company_plan=None, interval=None, deprecated=None, plan_type=None, consumable_quantity=None, amount_cents=None, name=None, id=None, view_ref=None, href=None):  # noqa: E501
