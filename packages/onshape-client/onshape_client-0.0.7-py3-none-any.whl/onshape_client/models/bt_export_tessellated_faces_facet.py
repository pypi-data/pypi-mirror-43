...
class BTExportTessellatedFacesFacet(object):
    ...
    def __init__(self, normals=None, texture_coordinates=None, vertices=None, normal=None, indices=None, type_id=None, export_type_name=None, connection_source=None, unknown_class=None):  # noqa: E501
