...
class BTFSValue(object):
    ...
    def __init__(self, configuration_value_string=None, value_object=None, type_tag=None, type_id=None, export_type_name=None, connection_source=None, unknown_class=None):  # noqa: E501
