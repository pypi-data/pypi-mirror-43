...
class BTWorkflowActionInfo(object):
    ...
    def __init__(self, allow_if_no_approvers=None, allow_if_approvers=None, always_allow=None, tooltip=None, is_approver_action=None, label=None, action=None, required_properties=None, ui_hint=None, is_admin_override=None):  # noqa: E501
