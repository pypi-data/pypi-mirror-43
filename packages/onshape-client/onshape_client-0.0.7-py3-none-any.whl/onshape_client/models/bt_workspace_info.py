...
class BTWorkspaceInfo(object):
    ...
    def __init__(self, can_delete=None, is_read_only=None, parent=None, type=None, description=None, creator=None, microversion=None, thumbnail=None, created_at=None, document_id=None, modified_at=None, last_modifier=None, parents=None, override_date=None, name=None, id=None, view_ref=None, href=None):  # noqa: E501
