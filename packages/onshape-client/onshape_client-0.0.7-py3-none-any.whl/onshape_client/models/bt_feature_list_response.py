...
class BTFeatureListResponse(object):
    ...
    def __init__(self, imports=None, rollback_index=None, default_features=None, feature_states=None, is_complete=None, features=None, bel_script_library_version=None, serialization_version=None, reject_microversion_skew=None, microversion_skew=None, library_version=None, source_microversion=None, type_id=None, export_type_name=None, connection_source=None, unknown_class=None):  # noqa: E501
