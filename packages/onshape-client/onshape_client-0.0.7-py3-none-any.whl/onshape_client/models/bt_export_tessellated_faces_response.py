...
class BTExportTessellatedFacesResponse(object):
    ...
    def __init__(self, bodies=None, facet_points=None, error_enum=None, type_id=None, export_type_name=None, connection_source=None, unknown_class=None):  # noqa: E501
