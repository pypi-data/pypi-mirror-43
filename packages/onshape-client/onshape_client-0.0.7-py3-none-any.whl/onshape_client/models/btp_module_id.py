...
class BTPModuleId(object):
    ...
    def __init__(self, short_descriptor=None, external_document_with_version_and_element_id=None, external_document_with_version=None, dbimport_string=None, version_and_microversion=None, external_import=None, imported_document_id=None, legacy=None, imported_element_id=None, element_import=None, potentially_valid=None, valid_legacy_version=None, path_version=None, imported_version_id=None, path=None, space_before_path=None, space_after_path=None, space_before_version=None, space_after_version=None, version=None, microversion=None, changeable_child_field_indices=None, first_child_field=None, start_source_location=None, end_source_location=None, atomic=None, documentation_type=None, space_default=None, space_before=None, space_after=None, node_id=None, child_map_indices=None, atomic_child_indices=None, node_id_raw=None, child_list_indices=None, type_id=None, export_type_name=None, connection_source=None, unknown_class=None):  # noqa: E501
