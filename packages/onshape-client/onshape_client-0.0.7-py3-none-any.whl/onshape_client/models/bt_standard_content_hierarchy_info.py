...
class BTStandardContentHierarchyInfo(object):
    ...
    def __init__(self, type=None, existing_versions=None, category=None, default_workspace=None, document_type=None, standard=None, types=None, production_version_id=None, test_version_id=None, name=None, id=None, view_ref=None, href=None):  # noqa: E501
