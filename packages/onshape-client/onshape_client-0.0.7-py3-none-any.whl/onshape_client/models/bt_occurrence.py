...
class BTOccurrence(object):
    ...
    def __init__(self, tail_instance_id=None, head_instance_id=None, occurrence_without_head=None, occurrence_without_tail=None, root_occurrence=None, full_path_as_string=None, path=None, type_id=None, export_type_name=None, connection_source=None, unknown_class=None):  # noqa: E501
