...
class JsonNode(object):
    ...
    def __init__(self, array=None, null=None, float=None, int=None, double=None, boolean=None, binary=None, long=None, object=None, textual=None, short=None, number=None, pojo=None, value_node=None, container_node=None, missing_node=None, integral_number=None, floating_point_number=None, big_decimal=None, big_integer=None, node_type=None):  # noqa: E501
