...
class BTReleasePackageItemInfo(object):
    ...
    def __init__(self, properties=None, mime_type=None, configuration=None, element_type=None, document_id=None, version_id=None, element_id=None, company_id=None, workspace_id=None, part_id=None, diff_thumbnail_configuration_key=None, small_thumbnail_href=None, is_revision_managed=None, errors=None, is_included_editable=None, configuration_key=None, rpid=None, obsoletion_revision_id=None, name=None, id=None, view_ref=None, href=None):  # noqa: E501
