...
class BTDocumentElementInfo(object):
    ...
    def __init__(self, name=None, id=None, type=None, length_units=None, angle_units=None, mass_units=None, filename=None, element_type=None, data_type=None, thumbnails=None, microversion_id=None, foreign_data_id=None, thumbnail_info=None):  # noqa: E501
