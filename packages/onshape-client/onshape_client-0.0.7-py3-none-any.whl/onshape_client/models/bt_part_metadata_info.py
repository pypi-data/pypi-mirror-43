...
class BTPartMetadataInfo(object):
    ...
    def __init__(self, name=None, id=None, state=None, custom_property_definitions=None, title2=None, title3=None, title1=None, vendor=None, product_line=None, description=None, revision=None, microversion_id=None, part_number=None, project=None, href=None, element_id=None, custom_properties=None, part_query=None, part_id=None, unflattened_part_id=None, configuration_id=None, thumbnail_info=None, thumbnail_configuration_id=None, material=None, is_mesh=None, body_type=None, is_flattened_body=None, appearance=None, referencing_configured_part_node_ids=None, is_hidden=None, ordinal=None, property_source_types=None):  # noqa: E501
