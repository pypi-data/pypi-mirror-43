...
class BTExportTessellatedFacesBody(object):
    ...
    def __init__(self, id=None, faces=None, facet_points=None, body_type=None, appearance=None, type_id=None, export_type_name=None, connection_source=None, unknown_class=None):  # noqa: E501
