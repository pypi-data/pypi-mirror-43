...
class BTUserSummaryInfo(object):
    ...
    def __init__(self, source=None, company=None, first_name=None, last_name=None, email=None, last_login_time=None, global_permissions=None, is_guest=None, is_light=None, state=None, image=None, name=None, id=None, view_ref=None, href=None):  # noqa: E501
