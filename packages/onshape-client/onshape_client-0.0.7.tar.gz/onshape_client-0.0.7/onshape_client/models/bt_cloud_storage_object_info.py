...
class BTCloudStorageObjectInfo(object):
    ...
    def __init__(self, created_by_id=None, modified_by_id=None, mime_type=None, cloud_storage_account_id=None, cloud_storage_provider=None, parent_id=None, thumbnail_info=None, cloud_storage_object_id=None, size_bytes=None, web_view_link=None, icon_link=None, owner=None, tree_href=None, resource_type=None, is_mutable=None, is_container=None, can_move=None, has_pending_owner=None, description=None, project_id=None, created_at=None, is_enterprise_owned=None, modified_at=None, created_by=None, modified_by=None, name=None, id=None, view_ref=None, href=None):  # noqa: E501
