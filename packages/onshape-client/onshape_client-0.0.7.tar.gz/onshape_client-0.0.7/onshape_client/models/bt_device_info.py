...
class BTDeviceInfo(object):
    ...
    def __init__(self, mobile=None, description=None, version=None, client_type=None, device_name=None, operating_system=None, browser=None, device_type=None, manufacturer=None):  # noqa: E501
