...
class BTWorkflowPropertyInfo(object):
    ...
    def __init__(self, is_approver_property=None, is_notifier_property=None, name=None, default_value=None, initial_value=None, ui_hints=None, property_source=None, dirty=None, validator=None, required=None, editable=None, property_id=None, schema_id=None, value_type=None, enum_values=None):  # noqa: E501
