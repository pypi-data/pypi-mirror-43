...
class BTExportModelEdgeGeometry(object):
    ...
    def __init__(self, length=None, start_point=None, end_point=None, mid_point=None, quarter_point=None, start_vector=None, end_vector=None, type_id=None, export_type_name=None, connection_source=None, unknown_class=None):  # noqa: E501
