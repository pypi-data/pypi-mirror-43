...
class BTExportModelEdge(object):
    ...
    def __init__(self, id=None, geometry=None, curve=None, vertices=None, type_id=None, export_type_name=None, connection_source=None, unknown_class=None):  # noqa: E501
