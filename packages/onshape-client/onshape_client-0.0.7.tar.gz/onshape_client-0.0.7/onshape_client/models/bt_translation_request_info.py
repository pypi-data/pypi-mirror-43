...
class BTTranslationRequestInfo(object):
    ...
    def __init__(self, request_state=None, request_element_id=None, result_external_data_ids=None, document_id=None, version_id=None, workspace_id=None, result_element_ids=None, result_document_id=None, failure_reason=None, result_workspace_id=None, name=None, id=None, view_ref=None, href=None):  # noqa: E501
