...
class BTLocationInfo(object):
    ...
    def __init__(self, from_node=None, end_column=None, language_version=None, end_line=None, parse_node_id=None, end_character=None, module_ids=None, parse_node_id_raw=None, character=None, line=None, version=None, element_microversion=None, top_level=None, document=None, changeable_child_field_indices=None, column=None, node_id=None, child_map_indices=None, atomic_child_indices=None, node_id_raw=None, first_child_field=None, child_list_indices=None, type_id=None, export_type_name=None, connection_source=None, unknown_class=None):  # noqa: E501
