...
class BTMetricParams(object):
    ...
    def __init__(self, system_id=None, property_map=None, document_id=None, element_id=None, event_name=None, event_namespace=None, event_time=None, event_type=None):  # noqa: E501
