...
class BTDocumentSearchHitInfo(object):
    ...
    def __init__(self, name=None, type=None, source_map=None, highlighted_fields=None, document_id=None, hit=None, version_or_workspace_name=None, element_name=None):  # noqa: E501
