...
class BTNodeStatus(object):
    ...
    def __init__(self, error=None, status_type=None, faulty_parameters=None, status_msg=None, status_enum=None, type_id=None, export_type_name=None, connection_source=None, unknown_class=None):  # noqa: E501
