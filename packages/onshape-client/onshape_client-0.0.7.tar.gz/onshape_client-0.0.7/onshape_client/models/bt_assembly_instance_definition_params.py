...
class BTAssemblyInstanceDefinitionParams(object):
    ...
    def __init__(self, is_assembly=None, is_whole_part_studio=None, revision=None, configuration=None, microversion_id=None, part_number=None, document_id=None, version_id=None, element_id=None, part_id=None, feature_id=None):  # noqa: E501
