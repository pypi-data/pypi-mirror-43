...
class BTInsertionLocation(object):
    ...
    def __init__(self, adjacent_to_node=None, order_preserving=None, child_field_index=None, before=None, node_id=None, node_id_raw=None, type_id=None, export_type_name=None, connection_source=None, unknown_class=None):  # noqa: E501
