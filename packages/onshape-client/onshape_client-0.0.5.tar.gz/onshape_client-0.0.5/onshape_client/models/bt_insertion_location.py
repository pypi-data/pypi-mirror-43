...
class BTInsertionLocation(object):
    ...
    def __init__(self, order_preserving=None, adjacent_to_node=None, node_id=None, node_id_raw=None, before=None, child_field_index=None, type_id=None, export_type_name=None, connection_source=None, unknown_class=None):  # noqa: E501
