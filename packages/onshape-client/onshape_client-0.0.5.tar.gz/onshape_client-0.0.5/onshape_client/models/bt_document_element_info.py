...
class BTDocumentElementInfo(object):
    ...
    def __init__(self, name=None, id=None, type=None, filename=None, element_type=None, microversion_id=None, data_type=None, foreign_data_id=None, length_units=None, angle_units=None, mass_units=None, thumbnail_info=None, thumbnails=None):  # noqa: E501
