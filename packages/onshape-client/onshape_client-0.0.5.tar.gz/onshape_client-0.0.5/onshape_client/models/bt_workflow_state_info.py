...
class BTWorkflowStateInfo(object):
    ...
    def __init__(self, name=None, value=None, display_name=None, notifier_source_property=None, required_properties=None, approver_source_property=None, editable_properties=None):  # noqa: E501
