...
class BTPNode(object):
    ...
    def __init__(self, documentation_type=None, short_descriptor=None, atomic=None, start_source_location=None, end_source_location=None, space_before=None, first_child_field=None, changeable_child_field_indices=None, space_after=None, space_default=None, node_id=None, child_map_indices=None, atomic_child_indices=None, node_id_raw=None, child_list_indices=None, type_id=None, export_type_name=None, connection_source=None, unknown_class=None):  # noqa: E501
