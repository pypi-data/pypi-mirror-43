...
class BTShareParams(object):
    ...
    def __init__(self, message=None, entries=None, permission=None, update=None, encoded_configuration=None, document_id=None, workspace_id=None, element_id=None, folder_id=None, permission_set=None):  # noqa: E501
