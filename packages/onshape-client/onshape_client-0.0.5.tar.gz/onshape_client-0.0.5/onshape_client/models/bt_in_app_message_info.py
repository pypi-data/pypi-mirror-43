...
class BTInAppMessageInfo(object):
    ...
    def __init__(self, context=None, content=None, description=None, content_type=None, show_once=None, display_order=None, content_index=None, start_date=None, end_date=None, rule_id=None, looker_query=None, population_task_id=None, billing_plan_ids=None, domain_type=None, name=None, id=None, href=None, view_ref=None):  # noqa: E501
