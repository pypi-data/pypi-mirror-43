...
class BTCompanySummaryInfo(object):
    ...
    def __init__(self, state=None, type=None, description=None, owner_id=None, image=None, admin=None, domain_prefix=None, no_public_documents=None, enterprise_base_url=None, name=None, id=None, href=None, view_ref=None):  # noqa: E501
