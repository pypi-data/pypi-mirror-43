...
class ContentItem(object):
    ...
    def __init__(self, link=None, position=None, anchor=None, title=None, player=None, width=None, height=None, content_id=None, item_title=None, template=None, thumbnail=None, pause_points=None, vertical_offset=None, horizontal_offset=None):  # noqa: E501
