...
class BTReleasePackageItemParams(object):
    ...
    def __init__(self, properties=None, id=None, href=None, is_included=None, part_number=None, part_id=None, version_id=None, document_id=None, configuration=None, workspace_id=None, element_id=None):  # noqa: E501
