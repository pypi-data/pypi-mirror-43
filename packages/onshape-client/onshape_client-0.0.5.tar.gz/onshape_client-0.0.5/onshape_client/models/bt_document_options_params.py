...
class BTDocumentOptionsParams(object):
    ...
    def __init__(self, cpp_server_memory=None, enable_cpp_server_memory_diagnostics=None, document_memory=None, extended_display_check=None, skip_retrieval_test=None, cpp_server_limit=None, thumbnail_cpp_server_limit=None, linked_cpp_server_limit=None, drawing_server_memory=None, cpp_server_default_element_limit=None):  # noqa: E501
