...
class BTReleasePackageInfo(object):
    ...
    def __init__(self, detailed=None, column_names=None, comments=None, package_thumbnail=None, items=None, is_setup=None, is_frozen=None, revision_rule_id=None, linked_version_ids=None, version_id=None, workspace_id=None, is_discarded=None, properties=None, description=None, workflow=None, document_id=None, company_id=None, is_obsoletion=None, name_as_property=None, description_as_property=None, name=None, id=None, href=None, view_ref=None):  # noqa: E501
