...
class BTPartMetadataInfo(object):
    ...
    def __init__(self, name=None, id=None, state=None, description=None, revision=None, project=None, href=None, element_id=None, part_number=None, custom_properties=None, microversion_id=None, vendor=None, product_line=None, title1=None, title2=None, title3=None, part_query=None, part_id=None, unflattened_part_id=None, material=None, thumbnail_info=None, configuration_id=None, thumbnail_configuration_id=None, custom_property_definitions=None, appearance=None, body_type=None, is_mesh=None, referencing_configured_part_node_ids=None, is_flattened_body=None, is_hidden=None, ordinal=None, property_source_types=None):  # noqa: E501
