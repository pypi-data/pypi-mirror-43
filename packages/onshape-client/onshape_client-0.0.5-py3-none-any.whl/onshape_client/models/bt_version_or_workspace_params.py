...
class BTVersionOrWorkspaceParams(object):
    ...
    def __init__(self, name=None, description=None, read_only=None, is_release=None, from_history=None, version_id=None, document_id=None, workspace_id=None, microversion_id=None, client_interaction_mode=None):  # noqa: E501
