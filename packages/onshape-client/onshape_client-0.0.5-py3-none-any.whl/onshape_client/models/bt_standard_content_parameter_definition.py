...
class BTStandardContentParameterDefinition(object):
    ...
    def __init__(self, default_value=None, parameter_id=None, visible=None, is_custom_parameter=None, is_driving_configuration=None, display_name=None):  # noqa: E501
