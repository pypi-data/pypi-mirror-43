...
class BTFeatureScriptEvalCall(object):
    ...
    def __init__(self, script=None, queries=None, bel_script_library_version=None, library_version=None, serialization_version=None, source_microversion=None, reject_microversion_skew=None, microversion_skew=None, type_id=None, export_type_name=None, connection_source=None, unknown_class=None):  # noqa: E501
