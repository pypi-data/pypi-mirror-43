...
class BTDrawingParams(object):
    ...
    def __init__(self, location=None, size=None, language=None, revision=None, decimal_separator=None, part_number=None, part_query=None, part_id=None, element_microversion_id=None, units=None, document_id=None, workspace_id=None, element_id=None, sketch_id=None, sketch_ids=None, external_document_id=None, external_document_version_id=None, element_configuration=None, template_document_id=None, template_workspace_id=None, template_name=None, template_args=None, template_element_id=None, drawing_name=None, projection=None, standard=None, border=None, titleblock=None, number_horizontal_zones=None, number_vertical_zones=None, start_zones=None, is_sketch_only=None, views=None, compute_intersection=None, document_microversion_id=None, hidden_lines=None, include_surfaces=None, is_surface=None, pure_sketch=None, model_type=None, template_version_id=None):  # noqa: E501
