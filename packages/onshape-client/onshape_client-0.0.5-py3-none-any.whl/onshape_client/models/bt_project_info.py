...
class BTProjectInfo(object):
    ...
    def __init__(self, trash=None, permission_set=None, permission_scheme=None, role_map_entries=None, owner=None, description=None, can_move=None, project_id=None, is_container=None, created_at=None, is_enterprise_owned=None, modified_at=None, created_by=None, modified_by=None, tree_href=None, is_mutable=None, resource_type=None, has_pending_owner=None, name=None, id=None, href=None, view_ref=None):  # noqa: E501
