...
def __validate_handle_upload_index_and_metadata_results(data_sync, data_path, isolation_token):
    try:
        FileNotFoundError
    except NameError:
    ...
    try:
        return data_sync.upload_index_and_metadata(data_path, isolation_token)
...
def __handle_upload_index_and_metadata_results(data_sync, data_path, isolation_token):
    results = __validate_handle_upload_index_and_metadata_results(data_sync, data_path, isolation_token)
