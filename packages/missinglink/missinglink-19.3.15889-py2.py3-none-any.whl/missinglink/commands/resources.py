...
class HideInternal(click.Group):
    hidden_cmds = {'restore_aws_template', 'restore_azure_template'}

    def list_commands(self, ctx):
        commands = super(HideInternal, self).list_commands(ctx)
        return [c for c in commands if c not in self.hidden_cmds]


@click.group('resources', help='Resource Management', cls=HideInternal)
