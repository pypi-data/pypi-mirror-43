...
try:
    ...
    print("WARN::Install ipywidgets to use ProfileVisualizationClient")
...
if __name__ == '__main__':
    ProfileVisualizationClient.from_current_cli_profile()
    ProfilesClient.from_current_cli_profile()
