...
class TestAgent(unittest.TestCase):
    ...
    def test_invoke_sync(self):
        ...
        msg = agent.invoke_service(service_name, Message.with_payload({'text': 'Testing...'}))
    ...
    def test_invoke_async(self):
        ...
        service_activation = agent.invoke_service_async(service_name, Message.with_payload({'text': 'Testing...'}))
