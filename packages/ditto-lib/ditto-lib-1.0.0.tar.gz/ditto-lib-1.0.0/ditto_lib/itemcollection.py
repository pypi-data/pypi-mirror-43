...
class ItemCollection:
    ...
    def set_descriptor(self, attribute_name, is_descriptor):
        '''
    ...
    def sorted(self, attribute_name, descending=False):
        '''
    ...
    def to_csv(self, filename, prune_preamble=True, identifier='Name'):
        '''
        Write to csv file
...
def load_collection(name, filename, **kwargs):
    '''
