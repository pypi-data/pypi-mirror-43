...
def make_ptr_float_kmeans(dopredict, verbose, seed, gpu_id, n_gpu, mTrain, n, ord, k, max_iterations, init_from_data, threshold, srcdata, centroids, pred_centroids, pred_labels):
    return _ch2o4gpu_gpu.make_ptr_float_kmeans(dopredict, verbose, seed, gpu_id, n_gpu, mTrain, n, ord, k, max_iterations, init_from_data, threshold, srcdata, centroids, pred_centroids, pred_labels)
make_ptr_float_kmeans = _ch2o4gpu_gpu.make_ptr_float_kmeans

def make_ptr_double_kmeans(dopredict, verbose, seed, gpu_id, n_gpu, mTrain, n, ord, k, max_iterations, init_from_data, threshold, srcdata, centroids, pred_centroids, pred_labels):
    return _ch2o4gpu_gpu.make_ptr_double_kmeans(dopredict, verbose, seed, gpu_id, n_gpu, mTrain, n, ord, k, max_iterations, init_from_data, threshold, srcdata, centroids, pred_centroids, pred_labels)
make_ptr_double_kmeans = _ch2o4gpu_gpu.make_ptr_double_kmeans

def kmeans_transform_float(verbose, gpu_id, n_gpu, m, n, ord, k, srcdata, centroids, preds):
    return _ch2o4gpu_gpu.kmeans_transform_float(verbose, gpu_id, n_gpu, m, n, ord, k, srcdata, centroids, preds)
kmeans_transform_float = _ch2o4gpu_gpu.kmeans_transform_float

def kmeans_transform_double(verbose, gpu_id, n_gpu, m, n, ord, k, srcdata, centroids, preds):
    return _ch2o4gpu_gpu.kmeans_transform_double(verbose, gpu_id, n_gpu, m, n, ord, k, srcdata, centroids, preds)
