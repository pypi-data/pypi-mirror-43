...
class Firmware():
    ...
    def open(self, url):
        ...
        with urlopen(self.url) as res:
            ...
            print(Fore.BLUE + "  {0}".format(self.header.modelNumber) + Style.RESET_ALL)
...
class Updater:
    ...
    def eventInformation(self, information):
        ...
        if information.modeUpdate == ModeUpdate.Complete:
            ...
            print(Fore.YELLOW + "* Connected Device : {0}\n".format(self.deviceType) + Style.RESET_ALL)
    ...
    def update(self):
        ...
        print(Back.YELLOW + Fore.BLACK + " E-DRONE firmware upgrade. " + Style.RESET_ALL)
        print("")
