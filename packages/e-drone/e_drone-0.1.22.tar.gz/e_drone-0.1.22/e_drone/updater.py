...
class Updater:
    ...
    def eventInformation(self, information):
        ...
        print(Fore.YELLOW + "* eventInformation()" + Style.RESET_ALL)
    ...
    def update(self):
        ...
        print(Back.YELLOW + Fore.BLACK + "E-Drone Firmware updater.\n" + Style.RESET_ALL)
        ...
        print(Fore.GREEN + "* Connected DeviceType : {0}\n".format(header.to_) + Style.RESET_ALL)
        ...
        for fw in firmware:
            ...
            if self.targetModelNumber == fw.header.modelNumber:
                ...
                print(Fore.GREEN + "* {0}\n".format(self.targetModelNumber) + Style.RESET_ALL)

                if self.modeUpdate == ModeUpdate.Ready or self.modeUpdate == ModeUpdate.Update:

                    print(Fore.GREEN + "* {0}\n".format(self.modeUpdate) + Style.RESET_ALL)
                    ...
                    while flagRun:
                        ...
                        if (self.flagUpdated == True) or (timeTransferNext < now):
                            ...
                            print(Fore.YELLOW + "\b\b\b\b\b\b\b {0:10.2f}%".format(percentage) + Style.RESET_ALL, end='')
                else:
