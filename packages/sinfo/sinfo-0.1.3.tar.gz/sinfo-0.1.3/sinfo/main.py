...
def sinfo(print_na=True, print_os=True, print_std_lib=False,
          print_private_modules=False, print_all_modules=False,
    ...
    print_all_modules : bool
        Print information about system modules and package dependencies. This
        is often rather verbose and setting `print_na` to `False` is
        recommended.
    print_jupyter : bool
