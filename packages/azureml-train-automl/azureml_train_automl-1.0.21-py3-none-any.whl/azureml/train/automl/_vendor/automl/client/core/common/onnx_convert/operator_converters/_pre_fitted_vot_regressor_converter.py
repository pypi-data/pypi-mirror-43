...
class PrefittedVottingRegressorConverter(_AbstractOperatorConverter):
    """PrefittedVottingRegressor virtual operator converter."""
    ...
    def setup(self):
        ...
        update_registered_converter(_VirtualPrefittedVotingRegressor,
                                    PrefittedVottingRegressorConverter.OPERATOR_ALIAS,
                                    PrefittedVottingRegressorConverter._calc_prefitted_vottingregressor_ot_shapes,
                                    PrefittedVottingRegressorConverter._convert_prefitted_votting_regressor)
