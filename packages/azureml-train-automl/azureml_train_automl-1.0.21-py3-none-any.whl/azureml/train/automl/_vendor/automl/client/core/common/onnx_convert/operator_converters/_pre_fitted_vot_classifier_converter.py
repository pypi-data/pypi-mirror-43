...
class PrefittedVottingClassifierConverter(_AbstractOperatorConverter):
    """PrefittedVottingClassifier virtual operator converter."""
    ...
    def setup(self):
        ...
        update_registered_converter(_VirtualPrefittedVotingClassifier,
                                    PrefittedVottingClassifierConverter.OPERATOR_ALIAS,
                                    PrefittedVottingClassifierConverter._calc_prefitted_vottingclassifier_ot_shapes,
                                    PrefittedVottingClassifierConverter._convert_prefitted_votting_classifier)
