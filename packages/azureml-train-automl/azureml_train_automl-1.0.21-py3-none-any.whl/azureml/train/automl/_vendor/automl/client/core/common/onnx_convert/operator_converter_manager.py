...
from automl.client.core.common.onnx_convert.operator_converters import \
    PrefittedVottingClassifierConverter       # noqa: E402
from automl.client.core.common.onnx_convert.operator_converters import \
    PrefittedVottingRegressorConverter       # noqa: E402
...
class OperatorConverterManager:
    ...
    def _setup_default_operator_converters(self):
        ...
        self.register_op_converter(PrefittedVottingClassifierConverter())
        self.register_op_converter(PrefittedVottingRegressorConverter())
    ...
    def _register_lightgbm_converter_for_ensemble_conversion(self):
        # For the lightgbm classifier object that are ensembled in the vottingclassifier,
        ...
        # And there's no ONNX op can take an Sequence type input.
        update_registered_converter(LGBMClassifier,
                                    OnnxConvertConstants.LightGbmLGBMClassifier,
                                    s2o_calculate_linear_classifier_output_shapes,
                                    OpConverterUtil._convert_lightgbm_classifier_wrapper)
