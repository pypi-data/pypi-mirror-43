...
from automl.client.core.common.model_wrappers import RegressionPipeline, PipelineWithYTransformations
...
def run_pipeline(automl_settings: AutoMLBaseSettings,
    ...
    with logging_utilities.log_activity(logger, activity_name=constants.TelemetryConstants.RUN_PIPELINE_NAME,
        ...
        log_config = logging_utilities.LogConfig(automl_settings.debug_log, automl_settings.verbosity,
