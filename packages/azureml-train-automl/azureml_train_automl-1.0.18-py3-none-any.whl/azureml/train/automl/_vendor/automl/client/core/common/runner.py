...
from automl.client.core.common.activity_logger import TelemetryActivityLogger, DummyActivityLogger
...
class ClientRunner(object):
    ...
    def _run_constrained(self, fn, dataset, pipeline_spec, problem_info,
                         enforce_limits=True, **kwargs) -> Tuple[Any, Optional[BaseException]]:
    ...
    def run(self, dataset, pipeline_spec, problem_info, sets_to_run=None,
            ...
            random_state=None, include_models=False, subsample_seed=0) -> Tuple[Any, Optional[BaseException]]:
        """
    ...
    def _get_activity_logger(self, log_config=None):
        if log_config:
