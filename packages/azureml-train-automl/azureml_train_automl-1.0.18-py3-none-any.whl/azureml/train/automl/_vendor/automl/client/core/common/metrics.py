...
def compute_metrics_classification(y_pred_probs, y_test, metrics,
    ...
    if constants.Metric.NormMacroRecall in metrics:
        ...
        # TODO: Handle cases where the test set doesn't have all the classes
        # by integrating this metric with the fix used for e.g. AUC_weighted
        # that relies on _class_averaged_score. Until this task is completed,
        # NormMacroRecall will be out of sync with AUC and average_precision
        # metrics
