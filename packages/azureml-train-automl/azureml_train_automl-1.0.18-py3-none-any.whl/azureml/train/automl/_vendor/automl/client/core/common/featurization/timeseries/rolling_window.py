...
from automl.client.core.common.featurization.timeseries.forecasting_transform_utils import OriginTimeMixin
...
class RollingWindow(AzureMLForecastTransformerBase, OriginTimeMixin):
    ...
    def _make_feature_name_map(self, X, quiet=False):
        """
