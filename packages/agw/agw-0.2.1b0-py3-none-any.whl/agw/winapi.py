...
if __name__ == '__main__':
    ...
    # chrome = None
    #
    # for index, wind in enumerate(Window.iter_windows(), 1):
    #     if not wind.visible:
    #         continue
    #     print((f'{index:0>3} "{wind.title}" ({wind.handle}) '
    #            f'({wind.top}, {wind.right}, '
    #            f'{wind.bottom}, {wind.left})'))
    #     if 'Google Chrome' in wind.title:
    #         chrome = wind
