...
from .util import Counter, fetch_file_argument
...
class MacroDataFileHandler(object):
    ...
    def __init__(self, data_fields, header_row=False, separator=",", line_pause=False, line_start=False):
...
def iterfile(data_fields, file_arg="--data-file", header_row=False, separator=","):
    ...
    def _iterfile(func):
        ...
        handler = MacroDataFileHandler(data_fields, header_row=header_row, separator=separator)
