...
from nevolution_risk.constants.colors import green, blue, deepskyblue, darkviolet, orange
...
class Graph(object):
    ...
    def __init__(self, player_positions=None, player_count=4):
        ...
        self.players.append(Player("player_three", 120, darkviolet, action_len))
        self.players.append(Player("player_four", 120, orange, action_len))
    ...
    def round_reward(self):
        # TODO: revisit rewards (delete TODO if rewards are fine)
        return 1
    ...
    def fortify(self, start, finish):
        ...
        """
        if not (start.troops >= 1):
            return False

        while start.troops >= 1:
    ...
    def attack(self, start, finish, all_troops):
        # TODO: comment
