...
class Graph(object):
    ...
    def __init__(self, seed, player_positions=None, player_count=4):
        ...
        self.players = []
        self.players.append(Player('player_one', 0, green, action_len))
        self.players.append(Player("player_two", 1, deepskyblue, action_len))
        self.players.append(Player("player_three", 2, darkviolet, action_len))
        self.players.append(Player("player_four", 3, orange, action_len))
