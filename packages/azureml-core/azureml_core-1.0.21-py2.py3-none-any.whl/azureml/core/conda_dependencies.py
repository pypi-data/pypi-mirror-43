...
"""Contains class for managing Conda environment dependencies.

Load existing Conda environment files, or configure and manipulate new environments where the experiment executes.
"""
import os
import ruamel.yaml
import re
