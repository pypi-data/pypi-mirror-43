...
from azureml.core.authentication import ArmTokenAuthentication, AzureCliAuthentication
...
def get_cli_specific_auth():
    ...
    """
    if AZUREML_CLI_IN_USE in os.environ and AZUREML_ARM_ACCESS_TOKEN in os.environ:
...
def get_cli_specific_output(command_output):
    ...
    :rtype json:
    """
    if AZUREML_CLI_IN_USE not in os.environ:
