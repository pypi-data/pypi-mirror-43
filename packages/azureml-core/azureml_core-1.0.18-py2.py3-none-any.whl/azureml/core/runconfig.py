...
DEFAULT_CPU_IMAGE = "mcr.microsoft.com/azureml/base:0.2.3"
DEFAULT_GPU_IMAGE = "mcr.microsoft.com/azureml/base-gpu:0.2.3"
...
class RunConfiguration(AbstractRunConfigElement):
    ...
    :type data_references: :class:`list[DataReferenceConfiguration]`
