...
class RawData0(object):
    ...
    def plot_dciv(self, fig_name=None, ax=None, vmax_plot=4.,
                  **kw):  # pragma: no cover
        """Plot DC I-V curve.
    ...
    def plot_rdyn(self, fig_name=None, ax=None, vmax_plot=4.,
                  **kw):  # pragma: no cover
    ...
    def plot_rstat(self, fig_name=None, ax=None, vmax_plot=4.,
                   **kw):  # pragma: no cover
    ...
    def plot_if_noise(self, fig_name=None, ax=None, **kw):  # pragma: no cover
        ...
        ax1.axvline(self.vint * 1e3, c='k', ls=':', lw=0.5,
                    label=r'$V_\mathrm{{int}}$')
...
class RawData(object):
    ...
    def _recover_zemb(self, **kwargs):
        ...
        with np.errstate(divide='ignore', invalid='ignore'):
            power_avail = np.abs(vt_best * vgap) ** 2 / 8 / np.real(
                zt_best * rn)
        ...
        with np.errstate(divide='ignore', invalid='ignore'):
            power_delivered = np.abs(
                ac_voltage[idx_middle] * vgap) ** 2 / 2 / np.real(zw * rn)
        print("\t\t- deliv. power:\t{:+7.2f}\t\tnW".format(
            power_delivered / 1e-9))
    ...
    def plot_iv(self, fig_name=None, ax=None,
                vmax_plot=4.):  # pragma: no cover
    ...
    def plot_if(self, fig_name=None, ax=None,
                vmax_plot=4.):  # pragma: no cover
    ...
    def plot_ivif(self, fig_name=None, ax=None,
                  vmax_plot=4.):  # pragma: no cover
    ...
    def plot_noise_temp(self, fig_name=None, ax=None,
                        vmax_plot=4.):  # pragma: no cover
    ...
    def plot_yfac_noise_temp(self, fig_name=None, ax=None,
                             vmax_plot=4.):  # pragma: no cover
    ...
    def plot_gain_noise_temp(self, fig_name=None, ax=None,
                             vmax_plot=4.):  # pragma: no cover
    ...
    def plot_rdyn(self, fig_name=None, ax=None,
                  vmax_plot=4.):  # pragma: no cover
        """Plot dynamic resistance.
    ...
    def plot_gain(self, fig_name=None, ax=None,
                  vmax_plot=4.):  # pragma: no cover
        """Plot gain.
    ...
    def plot_simulated(self, fig_name=None, ax=None,
                       vmax_plot=4.):  # pragma: no cover
...
def plot_overall_results(dciv, data_list, fig_folder, vmax_plot=4.,
    ...
    for tl in ax2.get_yticklabels():
        tl.set_color(_blue)
    fig.savefig(os.path.join(fig_folder, 'noise_temperature_and_gain.png'),
                dpi=500)
    plt.close(fig)
