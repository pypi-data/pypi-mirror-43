...
def neprun(module, script, parameters, version="2", middleware = "NEP"):
    ...
    """
        ...
        node_type : string
            Type of the node. Can be "robot", "interface", "device", "algorithm"
    """
...
def masterRegister(node, topic, master_ip = '127.0.0.1', master_port = 7000, socket = "subscriber", mode = "many2many"):
