...
class SavingsMeterBillResponse(Model):
    ...
    :param bill_mtr_cap_id: Bill Meter CAP Identifier
    ...
    :param batcc_cost: BATCC Cost
    :type batcc_cost: float
    :param batcc_native_use: BATCC Native Use
    :type batcc_native_use: float
    :param batcc_weather_native_use: BATCC Weather Native Use
    :type batcc_weather_native_use: float
    :param batcc_nonweather_native_use: BATCC Nonweather Native Use
    ...
    :type cool_r2: float
    :param cap_status: Description of the cost avoidance
    :type cap_status: str
    :param locked: Is the bill's cost avoidance data locked
    :type locked: bool
    ...
    :param review: Has the cost avoidance detail been reviewed
    :type review: ~energycap.sdk.models.Reviewed
    :param account: The bill's account
    :type account: ~energycap.sdk.models.AccountChild
    :param meter: The bill's meter
    :type meter: ~energycap.sdk.models.MeterChild
    :param place: The bill's place
