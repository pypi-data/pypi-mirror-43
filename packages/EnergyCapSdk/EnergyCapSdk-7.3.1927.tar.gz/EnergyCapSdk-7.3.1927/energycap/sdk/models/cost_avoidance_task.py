...
class CostAvoidanceTask(Model):
    ...
    :param message: If there was a catastrophic error during task processing,
     it will go here
    :type message: str
    :param reason: The reason for the cost avoidance task. May be any of the
     following:
     * ResetBaseline
     ...
     * AucRangeModified
    :type reason: str
    :param status: The status of the cost avoidance task. May be any of the
     following:
     * Processing
     * Complete
     * Error
    ...
    :type task_note: str
    :param baseline_log: Log of cost avoidance baseline processing.
     Will be null if baseline was not reprocessed as part of this task.
    :type baseline_log: ~energycap.sdk.models.BaselineLog
    :param savings_log: Log of cost avoidance savings processing.
