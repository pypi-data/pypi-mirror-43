...
class CalculateSavingsRequest(Model):
    ...
    :param skip_if_supplier_or_distribution_bill_missing: For multi-account
     deregulated meters, determines if they should be skipped during processing
     if one of the accounts is missing a bill for that period
    :type skip_if_supplier_or_distribution_bill_missing: bool
    ...
    _attribute_map = {
        ...
        'skip_if_supplier_or_distribution_bill_missing': {'key': 'skipIfSupplierOrDistributionBillMissing', 'type': 'bool'},
    ...
    def __init__(self, bill_selection_option=None, billing_period=None, skip_if_supplier_or_distribution_bill_missing=None, skip_special_adjustment_option=None, special_adjustment_type_id_to_ignore=None, filters=None):
        super(CalculateSavingsRequest, self).__init__()
        self.bill_selection_option = bill_selection_option
        self.billing_period = billing_period
        self.skip_if_supplier_or_distribution_bill_missing = skip_if_supplier_or_distribution_bill_missing
