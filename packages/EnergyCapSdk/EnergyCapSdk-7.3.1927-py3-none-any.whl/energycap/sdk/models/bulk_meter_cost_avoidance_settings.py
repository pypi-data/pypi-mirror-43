...
class BulkMeterCostAvoidanceSettings(Model):
    ...
    :param attempt_summer_adjustment: Indicates whether or not the cost
     avoidance processor will attempt summer adjustments
    :type attempt_summer_adjustment: bool
    :param attempt_winter_adjustment: Indicates whether or not the cost
     avoidance processor will attempt winter adjustments
    :type attempt_winter_adjustment: bool
    :param num_baseline_months: Determines number of months of data included
     in the meter's cost avoidance baseline <span
     class='property-internal'>Must be between 12 and 36</span>
    ...
    :param cooling_needed_above: Determines the external temperature above
     which cooling is expected to take place
    ...
    :param include_meter_in_cost_avoidance: Determines whether or not to
     include the meter in cost avoidance processing
    ...
    :param filters: Filter criteria which determine the meters whose cost
     avoidance settings will be updated
    ...
    _attribute_map = {
        'attempt_summer_adjustment': {'key': 'attemptSummerAdjustment', 'type': 'bool'},
        'attempt_winter_adjustment': {'key': 'attemptWinterAdjustment', 'type': 'bool'},
    ...
    def __init__(self, attempt_summer_adjustment=None, attempt_winter_adjustment=None, num_baseline_months=None, baseline_start_date=None, cooling_needed_above=None, heating_needed_below=None, include_meter_in_cost_avoidance=None, savings_start_date=None, filters=None):
        super(BulkMeterCostAvoidanceSettings, self).__init__()
        self.attempt_summer_adjustment = attempt_summer_adjustment
        self.attempt_winter_adjustment = attempt_winter_adjustment
