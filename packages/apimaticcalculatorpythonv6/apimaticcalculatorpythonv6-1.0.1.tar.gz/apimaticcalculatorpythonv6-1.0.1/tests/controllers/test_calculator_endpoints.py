...
class CalculatorEndpointsTests(ControllerTestBase):

    @classmethod
    def setUpClass(cls):
        super(CalculatorEndpointsTests, cls).setUpClass()
        cls.controller = cls.api_client.calculator_endpoints
    ...
    def test_sum(self):
        ...
        result = self.controller.calculate_op(operation, x, y)
