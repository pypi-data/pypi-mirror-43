...
from apimaticcalculatorpythonv6.controllers.base_controller import BaseController

class CalculatorEndpoints(BaseController):

    """A Controller to access Endpoints in the apimaticcalculatorpythonv6 API."""
