...
def main():
    ...
    parser.add_argument('-f',
                        default="None", action='store', type=str, metavar='True',
                        help="format the output results from ARGs-OAP v1.0")
    parser.add_argument('-fo',
                        default="result", action='store', type=str, metavar='result',
                        help="output folder generated from ARGs-OAP v1.0")
    ################################################## Definition ########################################################
    ...
    try:
        ...
        pass
    ################################################### Programme #######################################################
    # format output from ARGs-OSP v1.0:
    if args.f !='None':
        print('perl ' + workingdir + '/bin/format.pl '
        + args.fo + '/extracted.fa.blast6out.txt '+ args.fo + '/meta_data_online.txt 25 1e-7 80 formated_table '
        + workingdir + '/data/structure_20160422.list '
        + workingdir + '/data/SARG.structure.txt')
        os.system('perl ' + workingdir + '/bin/format.pl '
        + args.fo + '/extracted.fa.blast6out.txt '+ args.fo + '/meta_data_online.txt 25 1e-7 80 formated_table '
        + workingdir + '/data/structure_20160422.list '
        + workingdir + '/data/SARG.structure.txt')
    else:
