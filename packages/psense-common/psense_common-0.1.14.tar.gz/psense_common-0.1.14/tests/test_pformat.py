...
class TestPFormat(unittest.TestCase):
    ...
    def test_valid_input(self):
        ...
        self.assertEqual(
            ...
            {'study': {'start': '2019-03-12', 'type': 'Beaker', 'run': '04', 'device': 'B02'}, 'sensor': {'code': '1111-222-33', 'type': 'Oxygen', 'vsn': '02', 'electrode': 'Circular', 'stack': 'Planar', 'process': 'Blanket', 'extras': 'None'}}
        )

        code2 = '19C11A001B04-0205-205-LA-G11CPVX'
        self.assertEqual(
            self.format.decode(code2),
            {'study': {'start': '2019-03-11', 'type': 'Prototype', 'run': '01', 'device': 'B04'}, 'sensor': {'code': '0205-205-LA', 'type': 'Glucose', 'vsn': '11', 'electrode': 'Circular', 'stack': 'Planar', 'process': 'Volcano', 'extras': 'None'}}
        )
    ...
    def test_partial_input(self):
        ...
        self.assertEqual(
            ...
            {'study': {'start': '2019-03-11', 'type': None, 'run': 'XX', 'device': 'M99'}, 'sensor': {'code': 'WE-RE-X', 'type': 'Other', 'vsn': '99', 'electrode': 'Circular', 'stack': None, 'process': None, 'extras': 'None'}}
        )
