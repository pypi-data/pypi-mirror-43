...
class Tmsv1instrumentidentifiersProcessingInformationAuthorizationOptionsInitiator(object):
    """
    ...
    def __init__(self, merchant_initiated_transaction=None):
        """
        Tmsv1instrumentidentifiersProcessingInformationAuthorizationOptionsInitiator - a model defined in Swagger
        """
    ...
    def merchant_initiated_transaction(self):
        """
        Gets the merchant_initiated_transaction of this Tmsv1instrumentidentifiersProcessingInformationAuthorizationOptionsInitiator.
    ...
    def merchant_initiated_transaction(self, merchant_initiated_transaction):
        """
        Sets the merchant_initiated_transaction of this Tmsv1instrumentidentifiersProcessingInformationAuthorizationOptionsInitiator.

        :param merchant_initiated_transaction: The merchant_initiated_transaction of this Tmsv1instrumentidentifiersProcessingInformationAuthorizationOptionsInitiator.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Tmsv1instrumentidentifiersProcessingInformationAuthorizationOptionsInitiator):
            return False
