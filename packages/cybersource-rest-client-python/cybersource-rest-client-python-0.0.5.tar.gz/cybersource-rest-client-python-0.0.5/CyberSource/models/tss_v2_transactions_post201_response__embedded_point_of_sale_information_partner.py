...
class TssV2TransactionsPost201ResponseEmbeddedPointOfSaleInformationPartner(object):
    ...
    def original_transaction_id(self, original_transaction_id):
        ...
        :type: str
        """
        if original_transaction_id is not None and len(original_transaction_id) > 50:
            raise ValueError("Invalid value for `original_transaction_id`, length must be less than or equal to `50`")
