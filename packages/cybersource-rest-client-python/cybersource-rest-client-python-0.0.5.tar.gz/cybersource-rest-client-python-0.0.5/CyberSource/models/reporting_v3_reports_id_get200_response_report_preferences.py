...
class ReportingV3ReportsIdGet200ResponseReportPreferences(object):
    """
    ...
    def __init__(self, signed_amounts=None, field_name_convention=None):
        """
        ReportingV3ReportsIdGet200ResponseReportPreferences - a model defined in Swagger
        """
    ...
    def signed_amounts(self):
        """
        Gets the signed_amounts of this ReportingV3ReportsIdGet200ResponseReportPreferences.
        Indicator to determine whether negative sign infron of amount for all refunded transaction

        :return: The signed_amounts of this ReportingV3ReportsIdGet200ResponseReportPreferences.
        :rtype: bool
        """
    ...
    def signed_amounts(self, signed_amounts):
        """
        Sets the signed_amounts of this ReportingV3ReportsIdGet200ResponseReportPreferences.
        Indicator to determine whether negative sign infron of amount for all refunded transaction

        :param signed_amounts: The signed_amounts of this ReportingV3ReportsIdGet200ResponseReportPreferences.
        :type: bool
        """
    ...
    def field_name_convention(self):
        """
        Gets the field_name_convention of this ReportingV3ReportsIdGet200ResponseReportPreferences.
        Specify the field naming convention to be followed in reports (applicable to only csv report formats

        :return: The field_name_convention of this ReportingV3ReportsIdGet200ResponseReportPreferences.
        :rtype: str
        """
    ...
    def field_name_convention(self, field_name_convention):
        """
        Sets the field_name_convention of this ReportingV3ReportsIdGet200ResponseReportPreferences.
        Specify the field naming convention to be followed in reports (applicable to only csv report formats

        :param field_name_convention: The field_name_convention of this ReportingV3ReportsIdGet200ResponseReportPreferences.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ReportingV3ReportsIdGet200ResponseReportPreferences):
            return False
