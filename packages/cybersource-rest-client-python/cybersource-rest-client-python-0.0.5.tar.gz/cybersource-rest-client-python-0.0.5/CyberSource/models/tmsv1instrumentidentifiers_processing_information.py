...
class Tmsv1instrumentidentifiersProcessingInformation(object):
    """
    ...
    def __init__(self, authorization_options=None):
        """
        Tmsv1instrumentidentifiersProcessingInformation - a model defined in Swagger
        """
    ...
    def authorization_options(self):
        """
        Gets the authorization_options of this Tmsv1instrumentidentifiersProcessingInformation.
    ...
    def authorization_options(self, authorization_options):
        """
        Sets the authorization_options of this Tmsv1instrumentidentifiersProcessingInformation.

        :param authorization_options: The authorization_options of this Tmsv1instrumentidentifiersProcessingInformation.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Tmsv1instrumentidentifiersProcessingInformation):
            return False
