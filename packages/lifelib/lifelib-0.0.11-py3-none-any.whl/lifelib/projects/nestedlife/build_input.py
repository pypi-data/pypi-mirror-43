...
By default, :py:func:`build_input` reads data from *input.xlsx* in the
...
Input
    ...
    Some tables in *input.xlsx* are imported as cells directly under this space.



PolicyData
    The sample policy data read from *PolicyData* tab in *input.xlsx*.
...
def build_input(model, input_file=default_input):
    ...
    By default, this function assumes reading data from *input.xlsx*
    ...
    print("Started loading data from 'input.xlsx'.", file=sys.stderr)
