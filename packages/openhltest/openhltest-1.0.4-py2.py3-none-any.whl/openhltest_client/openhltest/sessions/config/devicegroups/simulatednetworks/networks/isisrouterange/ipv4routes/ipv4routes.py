...
class Ipv4Routes(Base):
	...
	Implements the iterator interface __iter__ and encapsulates 0..n instances of the oht:sessions/config/device-groups/simulated-networks/networks/isis-route-range/ipv4-routes resource.
	"""
