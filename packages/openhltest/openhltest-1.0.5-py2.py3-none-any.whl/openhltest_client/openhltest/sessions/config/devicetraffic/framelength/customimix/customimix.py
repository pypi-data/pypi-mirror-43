...
class CustomImix(Base):
	...
	Implements the iterator interface __iter__ and encapsulates 0..n instances of the openhltest:sessions/config/device-traffic/frame-length/custom-imix resource.
	"""
