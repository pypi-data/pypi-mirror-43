...
class Neighbors(Base):
	...
	Implements the iterator interface __iter__ and encapsulates 0..n instances of the openhltest:sessions/config/device-traffic/frames/ospfv2-hello/neighbors resource.
	"""
	YANG_NAME = 'neighbors'
	YANG_KEYWORD = 'list'
	YANG_KEY = 'name'
