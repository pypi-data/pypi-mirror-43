...
class SourceAddressList(Base):
	...
	Implements the iterator interface __iter__ and encapsulates 0..n instances of the openhltest:sessions/config/device-traffic/frames/igmpv3-query/source-address-list resource.
	"""
