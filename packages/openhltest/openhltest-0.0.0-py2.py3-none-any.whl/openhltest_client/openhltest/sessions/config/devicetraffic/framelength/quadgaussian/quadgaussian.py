...
class QuadGaussian(Base):
	...
	Implements the iterator interface __iter__ and encapsulates 0..n instances of the oht:sessions/config/device-traffic/frame-length/quad-gaussian resource.
	"""
