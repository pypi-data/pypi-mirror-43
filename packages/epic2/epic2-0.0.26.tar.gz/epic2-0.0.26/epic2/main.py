...
def _main(args):
    ...
    if args["control"]:
        ...
        compute_fdr(new_islands, b_bins_counts, cc, bc, effective_genome_length, args["false_discovery_rate_cutoff"], args["output"])
    else:
        write_islands(new_islands, average_window_readcount, args["false_discovery_rate_cutoff"], args["e_value"], args["output"])
