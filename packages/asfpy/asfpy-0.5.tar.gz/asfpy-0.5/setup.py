...
def main():
      setuptools.setup(name='asfpy',
            ...
            long_description="This is a common set of functions used by the ASF Infrastructure team such as libraries for sending email, hipchat/stride messaging and generic procss daemonization.",
