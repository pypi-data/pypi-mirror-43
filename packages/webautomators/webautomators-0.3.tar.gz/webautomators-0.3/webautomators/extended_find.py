...
class FindElemennt():
    ...
    def _find_webelement(self, selector_type, selector_value, element_name,
        ...
        try:
            if selector_type == 'id':
                ...
                webelement = self.find_element_by_partial_link_text(selector_value)
    ...
    def _find(self, element=None, id=None, name=None,
        ...
        if not webelement:
            webelement = self._find_webelement(selector_type, selector_value,element_name, wait_displayed,timeout)
