...
class EstimatedCall:
    ...
    def front_display(self) -> str:
        ...
        return "{} {}".format(self.line_public_code,
                              self._data['destinationDisplay']['frontText'])
