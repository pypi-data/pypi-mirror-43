...
class PublishedPipeline(HasPipelinePortal):
    ...
    def __init__(self, name, graph_id, description, version, published_pipeline_id, status, endpoint,
                 total_run_steps, workspace, _pipeline_provider=None):
        """
    ...
    def submit(self, workspace, experiment_name, pipeline_parameters=None, _workflow_provider=None,
               _service_endpoint=None, parent_run_id=None):
        """
    ...
    def activate(self):
        ...
        NOTE: This method is being deprecated in favor of PublishedPipeline.enable()
        """
        logging.warning("PublishedPipeline.activate() is being deprecated. Use PublishedPipeline.enable() instead.")
