...
Deleting an entry will not remove the entity from E-Fonenana. To do this, you will need to remove the integration "${entry.platform}" from E-Fonenana.`)){return!1}try{await Object(entity_registry.c)(this.hass,entry.entity_id);this._items=this._items.filter(ent=>ent!==entry);return!0}catch(err){return!1}}})}static get styles(){return lit_element.c`
      a {
...
//# sourceMappingURL=4758b5a4dca50a8eccda.chunk.js.map