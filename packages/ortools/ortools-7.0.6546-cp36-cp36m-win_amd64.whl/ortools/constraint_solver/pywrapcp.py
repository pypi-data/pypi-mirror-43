...
class RoutingModel(_object):
    ...
    def GetHardTypeIncompatibilitiesOfNode(self, index: 'int64') -> "absl::flat_hash_set< int > const &":
        return _pywrapcp.RoutingModel_GetHardTypeIncompatibilitiesOfNode(self, index)

    def GetTemporalTypeIncompatibilitiesOfNode(self, index: 'int64') -> "absl::flat_hash_set< int > const &":
    ...
    def PackCumulsOfGlobalOptimizerDimensionsFromAssignment(self, original_assignment: 'Assignment') -> "operations_research::Assignment const *":
...
class TypeIncompatibilityChecker(_object):
    ...
    def TemporalIncompatibilitiesRespectedOnVehicle(self, vehicle: 'int', next_accessor: 'std::function< int64 (int64) > const &') -> "bool":
        return _pywrapcp.TypeIncompatibilityChecker_TemporalIncompatibilitiesRespectedOnVehicle(self, vehicle, next_accessor)

    def AllIncompatibilitiesRespectedOnVehicle(self, vehicle: 'int', next_accessor: 'std::function< int64 (int64) > const &') -> "bool":
