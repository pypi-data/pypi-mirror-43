...
def sigProfilerExtractor(input_type, out_put, project, refgen="GRCh37", startProcess=1, endProcess=10, totalIterations=8, cpu=-1, hierarchy = False, mtype = ["default"],exome = False, par_h=0.90): 
    ...
    for m in mtypes:
        ...
        while flag:
            ...
            genomes = sub.normalize_samples(genomes, normalize=False, all_samples=True, number=30000)
            for i in range(startProcess,endProcess+1):
                ...
                information.append([processAvg, exposureAvg, processStd, exposureStd, clusterSilhouetteCoefficients, signature_total_mutations, signature_stats]) #Will be used during hierarchical approach
