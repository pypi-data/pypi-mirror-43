...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Voter'
        db.create_table('votebase_voters', (
            ...
            ('round', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['surveys.Round'])),
            ('hash_key', self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True)),
            ('ip_address', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('latitude', self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True)),
            ('longitude', self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True)),
            ('continent_code', self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True)),
            ('country_name', self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True)),
            ('country_code', self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True)),
            ('city', self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True)),
            ('area_code', self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('voting', ['Voter'])

        # Adding model 'Answer'
        db.create_table('votebase_answers', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('voter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['voting.Voter'])),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['questions.Question'])),
            ('custom', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('option', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['questions.Option'], null=True, blank=True)),
            ('option_column', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='option_column', null=True, blank=True, to=orm['questions.Option'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('voting', ['Answer'])


    def backwards(self, orm):
        # Deleting model 'Voter'
        db.delete_table('votebase_voters')

        # Deleting model 'Answer'
        db.delete_table('votebase_answers')
    ...
    models = {
        ...
        'surveys.round': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '70', 'null': 'True', 'blank': 'True'}),
            'survey': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['surveys.Survey']"}),
        ...
        'voting.answer': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'custom': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {}),
