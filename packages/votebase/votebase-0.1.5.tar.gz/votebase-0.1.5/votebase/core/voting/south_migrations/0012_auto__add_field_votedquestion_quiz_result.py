...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VotedQuestion.quiz_result'
        db.add_column('votebase_voted_questions', 'quiz_result',
                      self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VotedQuestion.quiz_result'
        db.delete_column('votebase_voted_questions', 'quiz_result')
