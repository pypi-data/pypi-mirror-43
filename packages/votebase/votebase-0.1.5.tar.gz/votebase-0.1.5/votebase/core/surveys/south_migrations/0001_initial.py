...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Survey'
        db.create_table('votebase_surveys', (
        ...
        # Adding model 'Round'
        db.create_table('votebase_rounds', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('survey', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['surveys.Survey'])),
            ('title', self.gf('django.db.models.fields.CharField')(default=u'Default round', max_length=70)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=70, null=True, blank=True)),
            ('duration', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True, blank=True)),
            ('date_from', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True, blank=True)),
            ('date_to', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True)),
            ('password', self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True)),
            ('permission_level', self.gf('django.db.models.fields.CharField')(default='PUBLIC', max_length=255)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('is_anonymous', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_stat_viewable', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('is_viewable', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('surveys', ['Round'])


    def backwards(self, orm):
        # Deleting model 'Survey'
        db.delete_table('votebase_surveys')

        # Deleting model 'Round'
        db.delete_table('votebase_rounds')
