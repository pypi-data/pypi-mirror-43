...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('votebase_surveys', 'title', self.gf('django.db.models.fields.CharField')(max_length=150))

    def backwards(self, orm):

        # Changing field 'Survey.title'
        db.alter_column('votebase_surveys', 'title', self.gf('django.db.models.fields.CharField')(max_length=70))
