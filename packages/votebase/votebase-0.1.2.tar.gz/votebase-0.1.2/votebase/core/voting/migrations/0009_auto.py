...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'VotedQuestion', fields ['weight']
        db.create_index('votebase_voted_questions', ['weight'])

        # Adding index on 'Voter', fields ['hash_key']
        db.create_index('votebase_voters', ['hash_key'])


    def backwards(self, orm):
        # Removing index on 'Voter', fields ['hash_key']
        db.delete_index('votebase_voters', ['hash_key'])

        # Removing index on 'VotedQuestion', fields ['weight']
        db.delete_index('votebase_voted_questions', ['weight'])
