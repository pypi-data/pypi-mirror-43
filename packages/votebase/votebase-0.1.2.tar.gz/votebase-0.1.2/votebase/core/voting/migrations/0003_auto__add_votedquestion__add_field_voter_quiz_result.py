...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VotedQuestion'
        db.create_table('votebase_voted_questions', (
            ...
            ('page', self.gf('django.db.models.fields.PositiveIntegerField')(default=1)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('voting', ['VotedQuestion'])

        # Adding field 'Voter.quiz_result'
        db.add_column('votebase_voters', 'quiz_result',
                      self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'VotedQuestion'
        db.delete_table('votebase_voted_questions')

        # Deleting field 'Voter.quiz_result'
        db.delete_column('votebase_voters', 'quiz_result')
    ...
    models = {
        ...
        'voting.answer': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'custom': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {}),
