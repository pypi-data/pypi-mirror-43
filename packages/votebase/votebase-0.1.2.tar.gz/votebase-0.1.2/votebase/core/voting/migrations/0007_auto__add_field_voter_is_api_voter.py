...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Voter.is_api_voter'
        db.add_column('votebase_voters', 'is_api_voter',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Voter.is_api_voter'
        db.delete_column('votebase_voters', 'is_api_voter')
