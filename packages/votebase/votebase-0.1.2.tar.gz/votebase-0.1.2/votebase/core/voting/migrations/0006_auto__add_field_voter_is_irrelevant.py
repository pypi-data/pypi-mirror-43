...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Voter.is_irrelevant'
        db.add_column('votebase_voters', 'is_irrelevant',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Voter.is_irrelevant'
        db.delete_column('votebase_voters', 'is_irrelevant')
