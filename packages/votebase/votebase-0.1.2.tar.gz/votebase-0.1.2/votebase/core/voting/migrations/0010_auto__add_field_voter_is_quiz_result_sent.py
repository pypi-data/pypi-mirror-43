...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Voter.is_quiz_result_sent'
        db.add_column('votebase_voters', 'is_quiz_result_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Voter.is_quiz_result_sent'
        db.delete_column('votebase_voters', 'is_quiz_result_sent')
    ...
    models = {
        ...
        'voting.voter': {
            ...
            'is_quiz_result_sent': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
