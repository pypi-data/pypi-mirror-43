...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Voter.voting_started'
        db.add_column('votebase_voters', 'voting_started',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Voter.voting_ended'
        db.add_column('votebase_voters', 'voting_ended',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Voter.voting_duration'
        db.add_column('votebase_voters', 'voting_duration',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Voter.voting_started'
        db.delete_column('votebase_voters', 'voting_started')

        # Deleting field 'Voter.voting_ended'
        db.delete_column('votebase_voters', 'voting_ended')

        # Deleting field 'Voter.voting_duration'
        db.delete_column('votebase_voters', 'voting_duration')
    ...
    models = {
        ...
        'voting.voter': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {}),
            'quiz_result': ('django.db.models.fields.FloatField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'round': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['surveys.Round']"}),
            'survey': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['surveys.Survey']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'voting_duration': ('django.db.models.fields.PositiveIntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
