...
from votebase.core.voting.managers import AnswerManager, VoterManager, VotedQuestionManager
from votebase.core.questions.models import Question, Option


class Voter(models.Model):
    user = models.ForeignKey(
        User, verbose_name=_(u'user'), default=None, null=True, blank=True)
