...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.true_label'
        db.add_column('votebase_questions', 'true_label',
                      self.gf('django.db.models.fields.CharField')(default=u'True', max_length=20),
                      keep_default=False)

        # Adding field 'Question.false_label'
        db.add_column('votebase_questions', 'false_label',
                      self.gf('django.db.models.fields.CharField')(default=u'False', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.true_label'
        db.delete_column('votebase_questions', 'true_label')

        # Deleting field 'Question.false_label'
        db.delete_column('votebase_questions', 'false_label')
