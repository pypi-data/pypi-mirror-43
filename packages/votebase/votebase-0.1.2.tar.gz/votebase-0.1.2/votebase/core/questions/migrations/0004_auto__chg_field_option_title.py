...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Option.title'
        db.alter_column('votebase_options', 'title', self.gf('django.db.models.fields.CharField')(max_length=512))

    def backwards(self, orm):

        # Changing field 'Option.title'
        db.alter_column('votebase_options', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))
