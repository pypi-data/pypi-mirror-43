...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.image_size'
        db.add_column('votebase_questions', 'image_size',
                      self.gf('django.db.models.fields.CharField')(default='ORIGINAL', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.image_size'
        db.delete_column('votebase_questions', 'image_size')
