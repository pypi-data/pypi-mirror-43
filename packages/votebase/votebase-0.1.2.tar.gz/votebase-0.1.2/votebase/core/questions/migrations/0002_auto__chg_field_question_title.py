...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('votebase_questions', 'title', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Question.title'
        db.alter_column('votebase_questions', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))
