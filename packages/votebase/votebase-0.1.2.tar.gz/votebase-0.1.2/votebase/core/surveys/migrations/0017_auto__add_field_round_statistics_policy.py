...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Round.statistics_policy'
        db.add_column('votebase_rounds', 'statistics_policy',
                      self.gf('django.db.models.fields.CharField')(default='PRIVATE', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Round.statistics_policy'
        db.delete_column('votebase_rounds', 'statistics_policy')
