...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Round.is_repeatable'
        db.add_column('votebase_rounds', 'is_repeatable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Round.is_repeatable'
        db.delete_column('votebase_rounds', 'is_repeatable')
