...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Round.finish_url'
        db.add_column('votebase_rounds', 'finish_url',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Round.finish_url_title'
        db.add_column('votebase_rounds', 'finish_url_title',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Round.finish_url'
        db.delete_column('votebase_rounds', 'finish_url')

        # Deleting field 'Round.finish_url_title'
        db.delete_column('votebase_rounds', 'finish_url_title')
    ...
    models = {
        ...
        'surveys.round': {
            ...
            'finish_url': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '255', 'null': 'True', 'blank': 'True'}),
