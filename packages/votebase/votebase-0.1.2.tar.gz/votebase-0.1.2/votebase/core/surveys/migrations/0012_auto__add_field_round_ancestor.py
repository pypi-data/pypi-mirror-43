...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Round.ancestor'
        db.add_column('votebase_rounds', 'ancestor',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['surveys.Round'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Round.ancestor'
        db.delete_column('votebase_rounds', 'ancestor_id')
    ...
    models = {
        ...
        'surveys.round': {
            ...
            'is_stat_viewable': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
