...
from votebase.core.surveys.managers import SurveyManager, RoundManager, BrandingImageManager
...
#        (PERMISSION_LEVEL_PRIVATE, _(u'Private - invites only')),
    ...
    ancestor = models.ForeignKey('self', 'id', verbose_name=_(u'ancestor'),
...
class BrandingImage(models.Model):
    survey = models.ForeignKey(Survey, 'id', verbose_name=_(u'survey'))
    user = models.ForeignKey(User, 'id', verbose_name=_(u'survey'))
