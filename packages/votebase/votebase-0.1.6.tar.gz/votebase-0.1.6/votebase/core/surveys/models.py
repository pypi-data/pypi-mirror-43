...
from votebase.core.surveys.managers import RoundManager, BrandingImageManager
...
class Survey(models.Model):
    ...
    def generate_unique_hash(self):
        while True:
            ...
            hash_key = hashlib.sha1(salt + str(self)).hexdigest()
...
#        (PERMISSION_LEVEL_PRIVATE, _(u'Private - invites only')),
    ...
    def get_random_questions(self):
        ...
        if quiz_questions.count() > 0:
            ...
            questions.append(quiz_questions[random_quiz_pos])

        while len(questions) < self.count_questions:
