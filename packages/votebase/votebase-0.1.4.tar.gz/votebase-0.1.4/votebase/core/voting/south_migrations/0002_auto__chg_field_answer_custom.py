...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Answer.custom'
        db.alter_column('votebase_answers', 'custom', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Answer.custom'
        db.alter_column('votebase_answers', 'custom', self.gf('django.db.models.fields.CharField')(default=None, max_length=255))
