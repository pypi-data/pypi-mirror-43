...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        Voter.objects.update(is_quiz_result_sent=True)

        # Adding index on 'Voter', fields ['is_quiz_result_sent']
        db.create_index('votebase_voters', ['is_quiz_result_sent'])


    def backwards(self, orm):
        # Removing index on 'Voter', fields ['is_quiz_result_sent']
        db.delete_index('votebase_voters', ['is_quiz_result_sent'])
