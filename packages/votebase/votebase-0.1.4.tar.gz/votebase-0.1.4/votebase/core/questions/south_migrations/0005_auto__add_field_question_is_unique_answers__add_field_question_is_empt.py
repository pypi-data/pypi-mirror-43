...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.is_unique_answers'
        db.add_column('votebase_questions', 'is_unique_answers',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Question.is_empty_row_enabled'
        db.add_column('votebase_questions', 'is_empty_row_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.is_unique_answers'
        db.delete_column('votebase_questions', 'is_unique_answers')

        # Deleting field 'Question.is_empty_row_enabled'
        db.delete_column('votebase_questions', 'is_empty_row_enabled')
