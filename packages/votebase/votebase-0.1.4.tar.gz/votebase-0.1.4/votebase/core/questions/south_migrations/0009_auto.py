...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Option', fields ['weight']
        db.create_index('votebase_options', ['weight'])

        # Adding index on 'Option', fields ['is_correct']
        db.create_index('votebase_options', ['is_correct'])

        # Adding index on 'Question', fields ['category']
        db.create_index('votebase_questions', ['category'])

        # Adding index on 'Question', fields ['weight']
        db.create_index('votebase_questions', ['weight'])

        # Adding index on 'Question', fields ['is_quiz']
        db.create_index('votebase_questions', ['is_quiz'])


    def backwards(self, orm):
        # Removing index on 'Question', fields ['is_quiz']
        db.delete_index('votebase_questions', ['is_quiz'])

        # Removing index on 'Question', fields ['weight']
        db.delete_index('votebase_questions', ['weight'])

        # Removing index on 'Question', fields ['category']
        db.delete_index('votebase_questions', ['category'])

        # Removing index on 'Option', fields ['is_correct']
        db.delete_index('votebase_options', ['is_correct'])

        # Removing index on 'Option', fields ['weight']
        db.delete_index('votebase_options', ['weight'])
