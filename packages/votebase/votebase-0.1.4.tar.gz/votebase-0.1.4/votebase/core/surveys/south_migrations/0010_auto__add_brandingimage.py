...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BrandingImage'
        db.create_table('votebase_brandingimages', (
        ...
        db.send_create_signal('surveys', ['BrandingImage'])


    def backwards(self, orm):
        # Deleting model 'BrandingImage'
        db.delete_table('votebase_brandingimages')
