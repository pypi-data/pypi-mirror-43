...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Round.email_treshold'
        db.add_column('votebase_rounds', 'email_treshold',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Round.email_treshold'
        db.delete_column('votebase_rounds', 'email_treshold')
