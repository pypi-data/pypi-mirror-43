...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Rename 'is_stat_viewable' field to 'is_quiz_result_visible'
        db.rename_column('votebase_rounds', 'is_stat_viewable', 'is_quiz_result_visible')

#        # Deleting field 'Round.is_stat_viewable'
#        db.delete_column('votebase_rounds', 'is_stat_viewable')
#
#        # Adding field 'Round.is_quiz_result_visible'
#        db.add_column('votebase_rounds', 'is_quiz_result_visible',
#                      self.gf('django.db.models.fields.BooleanField')(default=False),
#                      keep_default=False)

        # Adding field 'Round.is_quiz_correct_options_visible'
        db.add_column('votebase_rounds', 'is_quiz_correct_options_visible',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Rename 'is_quiz_result_visible' field to 'is_stat_viewable'
        db.rename_column('votebase_rounds', 'is_quiz_result_visible', 'is_stat_viewable')

#        # Adding field 'Round.is_stat_viewable'
#        db.add_column('votebase_rounds', 'is_stat_viewable',
#                      self.gf('django.db.models.fields.BooleanField')(default=False),
#                      keep_default=False)
#
#        # Deleting field 'Round.is_quiz_result_visible'
#        db.delete_column('votebase_rounds', 'is_quiz_result_visible')

        # Deleting field 'Round.is_quiz_correct_options_visible'
        db.delete_column('votebase_rounds', 'is_quiz_correct_options_visible')
    ...
    models = {
        ...
        'surveys.round': {
            ...
            'ancestor': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['surveys.Round']", 'null': 'True', 'blank': 'True'}),
