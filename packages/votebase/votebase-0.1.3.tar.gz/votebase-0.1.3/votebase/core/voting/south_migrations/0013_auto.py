...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'VotedQuestion', fields ['quiz_result']
        db.create_index('votebase_voted_questions', ['quiz_result'])


    def backwards(self, orm):
        # Removing index on 'VotedQuestion', fields ['quiz_result']
        db.delete_index('votebase_voted_questions', ['quiz_result'])
