...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Round.count_questions'
        db.add_column('votebase_rounds', 'count_questions',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Round.is_shuffle'
        db.add_column('votebase_rounds', 'is_shuffle',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Round.count_questions'
        db.delete_column('votebase_rounds', 'count_questions')

        # Deleting field 'Round.is_shuffle'
        db.delete_column('votebase_rounds', 'is_shuffle')
    ...
    models = {
        ...
        'surveys.round': {
            ...
            'postface': ('django.db.models.fields.TextField', [], {'default': 'None', 'max_length': '600', 'null': 'True', 'blank': 'True'}),
