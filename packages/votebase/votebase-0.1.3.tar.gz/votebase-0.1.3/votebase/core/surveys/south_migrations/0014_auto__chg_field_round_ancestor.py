...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Round.ancestor'
        db.alter_column('votebase_rounds', 'ancestor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['surveys.Round'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'Round.ancestor'
        db.alter_column('votebase_rounds', 'ancestor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['surveys.Round'], null=True))
