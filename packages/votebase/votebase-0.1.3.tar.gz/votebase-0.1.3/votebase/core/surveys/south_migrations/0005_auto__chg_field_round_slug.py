...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Round.slug'
        db.alter_column('votebase_rounds', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=80, null=True))

    def backwards(self, orm):

        # Changing field 'Round.slug'
        db.alter_column('votebase_rounds', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=70, null=True))
