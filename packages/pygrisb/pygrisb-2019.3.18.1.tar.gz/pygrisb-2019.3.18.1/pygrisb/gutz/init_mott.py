...
import h5py
import numpy as np
from pygrisb.math.matrix_basis import sigmatomatrixbasis, matrixstructtobasis
...
def init_mott(fin='GPARAM.h5', fout='GMOTT.h5'):
    ...
    print("\n Please select the method to solve embedding Hamiltonian.\n" +
            " LDIAG = -1: Valence truncation ED for Mott solution.\n" +
            "         -2: Option (-1) with Sz symmetry.\n" +
            "         -3: Option (-1) with additional S=0 constraints.\n")
