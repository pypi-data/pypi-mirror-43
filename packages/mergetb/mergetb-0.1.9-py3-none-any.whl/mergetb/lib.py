...
def project_delete_member(pid, mid):
    ...
    return do_delete('/projects/'+pid+'/members/'+mid)
...
def del_pool_site(pool, site):
    ...
    return do_delete('pools/'+pool+'/sites/'+site)
...
def del_pool_project(pool, project):
    ...
    return do_delete('pools/'+pool+'/projects/'+project)
