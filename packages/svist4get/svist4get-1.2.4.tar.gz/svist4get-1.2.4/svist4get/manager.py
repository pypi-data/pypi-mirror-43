...
class Parameters:
    ...
    def parse_command_line(self):
        ...
        parser.add_argument("--version", "-v", action='version', version='%(prog)s 1.2.4',
...
class Transcript_struct_loader(Loader):
    ...
    def create_track(self):
            ...
            if k == 0:
                ...
                for j in range(len(self.adjustable_parameters)):
                    if j < k:
                        ...
                        if start_string2 < 0:
                            start_string2 = 0
                        if end_string1 < width_of_string1:
                            end_string1 = width_of_string1
        ...
        for k in range(len(self.adjustable_parameters)):
            ...
            input_data = dict(exons=exons, max_line = max_line, CDS=CDS, coordinates=coordinates, new_line = new_line, transcript=i,
                              delete=delete,
