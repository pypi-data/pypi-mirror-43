...
version = '.'.join(ktug_hanyang_pua.__version__.split('.')[:2])
# The full version, including alpha/beta/rc tags.
release = ktug_hanyang_pua.__version__
...
htmlhelp_basename = 'ktug-hanyang-pua'
