...
class Xanity(object):
    ...
    def _absolute_trigger(self):
        ...
        if not environment.check_environment():
            try:
                ...
                subprocess.call(self._condabashcmd('conda activate && {}'.format(' '.join(sys.argv))))
    ...
    #
    #     return xanity_data.load_data(experiments=experiment, variables=[name], most_recent=True)
