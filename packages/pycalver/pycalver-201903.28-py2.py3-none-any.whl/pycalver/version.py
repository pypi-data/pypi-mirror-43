...
def format_version(ver_nfo, pattern):
...
def incr(old_version, pattern='{pycalver}', **kwargs):
    ...
    old_date = (old_ver_nfo.year or 0, old_ver_nfo.month or 0, old_ver_nfo.
        dom or 0)
    ...
    if major:
        cur_ver_nfo = cur_ver_nfo._replace(major=cur_ver_nfo.major + 1,
            minor=0, patch=0)
    if minor:
