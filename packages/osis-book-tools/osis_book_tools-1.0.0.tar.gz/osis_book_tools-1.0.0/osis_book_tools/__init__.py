...
setattr(OSISBook, "from_paratext", staticmethod(__from_paratext))
setattr(OSISBook, "paratext_abbreviation", __paratext_abbreviation)
setattr(OSISBook, "localized_name", __localized_name)
setattr(OSISBook, "chapter_descriptor", __chapter_descriptor)
