...
namespace __pythran_operators
{
  ...
  typename loop_spectra3d::type<argument_type0, argument_type1, argument_type2>::result_type loop_spectra3d::operator()(argument_type0&& spectrum_k0k1k2, argument_type1&& ks, argument_type2&& K2) const
  {
    ...
    {
      long  __target140125636169064 = nk0;
      for (long  ik0=0L; ik0 < __target140125636169064; ik0 += 1L)
      {
        {
          long  __target140125635666776 = nk1;
          for (long  ik1=0L; ik1 < __target140125635666776; ik1 += 1L)
          {
            {
              long  __target140125635667336 = nk2;
              for (long  ik2=0L; ik2 < __target140125635667336; ik2 += 1L)
              {
  ...
  typename vector_product::type<argument_type0, argument_type1, argument_type2, argument_type3, argument_type4, argument_type5>::result_type vector_product::operator()(argument_type0&& ax, argument_type1&& ay, argument_type2&& az, argument_type3&& bx, argument_type4&& by, argument_type5&& bz) const
  {
    ...
    {
      long  __target140125636097136 = n0;
      for (long  i0=0L; i0 < __target140125636097136; i0 += 1L)
      {
        {
          long  __target140125636098256 = n1;
          for (long  i1=0L; i1 < __target140125636098256; i1 += 1L)
          {
            {
              long  __target140125636098816 = n2;
              for (long  i2=0L; i2 < __target140125636098816; i2 += 1L)
              {
