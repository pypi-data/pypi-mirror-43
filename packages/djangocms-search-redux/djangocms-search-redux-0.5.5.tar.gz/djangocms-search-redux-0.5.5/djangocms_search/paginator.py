...
class ExPaginator(Paginator):
    ...
    settings.COMMON_PAGINATION_SOFTLIMIT
    ...
    def __init__(self, *args, **kwargs):
        self.softlimit = kwargs.pop('softlimit', getattr(settings, 'COMMON_PAGINATION_SOFTLIMIT', True))
...
def paginate_by(fallback=None):
    try:
        ...
        return COMMON_PAGINATOR_PAGINATE_BY
