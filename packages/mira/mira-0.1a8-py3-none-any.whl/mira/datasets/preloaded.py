...
def load_icdar2015(
    ...
    if subset in ['train', 'traintest']:
        images_dir = utils.get_file(
            origin='https://storage.googleapis.com/odtk/datasets/rrc2015/ch4_training_images.zip',  # noqa: E501
        ...
        annotations_dir = utils.get_file(
            origin='https://storage.googleapis.com/odtk/datasets/rrc2015/ch4_training_localization_transcription_gt.zip',  # noqa: E501
    ...
    if subset in ['test', 'traintest']:
        images_dir = utils.get_file(
            origin='https://storage.googleapis.com/odtk/datasets/rrc2015/ch4_test_images.zip',  # noqa: E501
        ...
        annotations_dir = utils.get_file(
            origin='https://storage.googleapis.com/odtk/datasets/rrc2015/Challenge4_Test_Task1_GT.zip',  # noqa: E501
