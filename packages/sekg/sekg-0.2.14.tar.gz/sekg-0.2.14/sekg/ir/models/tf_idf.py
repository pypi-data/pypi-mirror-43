...
class TFIDFModel(DocumentSimModel):
    ...
    The implementattion from TFIDF is from gensim.
    """
    __tfidf_model_name__ = "apidict_tfidf.model"
    __corpus_name__ = 'apidict_corpus.mm'
    __dictionary_name__ = 'dictionary.dict'
    __tfidf_sim_index__ = "Similarity_TFIDF_index.index"
    ...
    def __init_sub_model_path__(self):
        ...
        self.sim_index_path = os.path.join(self.sim_index_dir, self.__tfidf_sim_index__)
