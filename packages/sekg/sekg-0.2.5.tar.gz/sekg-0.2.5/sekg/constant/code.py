class CodeEntityCategory:
    ...
    CATEGORY_METHOD_CALL_INSTANCE = 18
    ...
    @staticmethod
    def category_code_to_str(category_code):
    ...
    @staticmethod
    def category_code_to_str_list(category_code):
...
class CodeEntityRelationCategory:
    ...
    RELATION_CATEGORY_METHOD_INSTANCE_CALL = 18
    ...
    category_code_to_str_map = {
        ...
        RELATION_CATEGORY_METHOD_INSTANCE_CALL: "instance method call"
