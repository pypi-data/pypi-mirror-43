...
kappav2 = metrics.KappaV2(num_classes=8, batch_size=32)
...
cnf = {
    ...
    'final_balance_weights': np.array([1,2,2,10,10,5,2,2], dtype=float),
    ...
    'standardizer': ScalingStandardizer(1.0 / 255.0),
    'classification': True,
