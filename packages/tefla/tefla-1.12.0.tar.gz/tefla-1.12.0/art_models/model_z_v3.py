...
def block_reduction_b(inputs, name='reduction_block_b', **kwargs):
    ...
    with tf.variable_scope(name, 'BlockReductionB', [inputs], reuse=reuse):
        with tf.variable_scope('Branch_0'):
            branch_0_1 = conv2d(
                inputs, 192, filter_size=(1, 1), stride=(2, 2), name='Conv2d_0a1_1x1', **kwargs)
...
def model(is_training, reuse, input_size=image_size[0], num_block_a=4, num_block_b=7, num_block_c=3, num_classes=2,
