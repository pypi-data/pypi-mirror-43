...
from tefla.core.lr_policyv2 import StepDecayPolicy, PolyDecayPolicy
...
cnf = {
    ...
    'final_balance_weights': np.array([1, 8, 2, 10, 10], dtype=float),
    ...
    #    }
    #),
    # 'validation_scores': [('validation kappa', kappav2.metric)],
