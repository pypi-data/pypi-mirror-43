...
def model(inputs, is_training, reuse, num_classes=5, drop_prob=0.2, input_size=image_size[0], name='InceptionResnetV2'):
    ...
    with tf.variable_scope(name, 'InceptionResnetV2'):
        net = conv2d(inputs, 32, name='Conv2d_1a_3x3', **conv_params_no_bias)
        net = conv2d(net, 32, stride=(2, 2), name='Conv2d_2a_3x3', **conv_params_no_bias)
        # 112 x 112
        ...
        # 64 x 64
        net = conv2d(net, 80,  filter_size=(1, 1), name='Conv2d_3b_1x1', **rest_conv_params)
        # 64 x 64
