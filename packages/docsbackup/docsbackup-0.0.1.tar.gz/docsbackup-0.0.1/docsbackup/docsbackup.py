...
def load_docx(filename):
    ...
    '''
    links = subprocess.check_output('pandoc -t markdown "%s" | egrep -o "http[s:/]+docs\.google\.com/[a-z]+/d/[-a-zA-Z0-9_]{44}/[a-z]+" | sort -u' % filename, shell=True)
...
def load_txt(filename):
    ...
    '''
    import mmap
    links_re = re.compile(r"http[s:/]+docs\.google\.com/[a-z]+/d/[-a-zA-Z0-9_]{44}/[a-z]+")
