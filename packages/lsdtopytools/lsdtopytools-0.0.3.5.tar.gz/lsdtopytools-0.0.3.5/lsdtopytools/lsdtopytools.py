...
class LSDDEM(object):
	...
	def DefineCatchment(self, method="min_area_pixels", test_edges = False, min_area_pixels = 1000, X_coords = [], Y_coords = [], coord_search_radius_nodes = 30, coord_threshold_stream_order = 3):
		"""
		Description:
	...
	def quick_concavity_constrain(self, starting_theta = 0.1, testing_step = 0.05, n_steps = 18, A_0 = 1, river_threshold = 1000):
		...
		self.X_movern = mydem.cppdem.get_disorder_vec_of_tested_movern()
		self.movern_dict_per_basins = mydem.cppdem.get_disorder_dict()
