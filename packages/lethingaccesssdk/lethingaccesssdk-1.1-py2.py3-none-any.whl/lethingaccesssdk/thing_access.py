...
if device_name is not None:
    ...
    logging.error("can't run this module in your local. it should run in the link iot edge. please refer to readme file or https://help.aliyun.com/document_detail/104444.html?spm=a2c4g.11186623.6.565.7f3c4c07yJCikt#h2-url-3")
try:
