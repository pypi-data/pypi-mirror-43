...
ERROR_NOTSUPPORT_DAY_MULTI_FREQNUM = 'day 频率时, 频数只能为1'
ERROR_NOTSUPPORT_WEEK_MULTI_FREQNUM = 'week 频率时, 频数只能为1'
...
WARN_USER_INDICES_RESULT_FORMAT = 'reg_userindi 期望返回 numpy.ndarray 数值类型数据且 Shape=({TARGETLEN},{COLUMNLEN}), Shape[0]为context.target_list的长度'
...
ERROR_REAL_GET_SUB_DATA = '{MSGTYPE} failed get data: {DATA}'
...
LOG_REG_REG_USERDATA = '正在注册用户数据...'
LOG_REG_REG_USERDATA_END = '已完成用户数据注册'
LOG_REG_REG_USERINDI = '正在注册用户因子数据...'
LOG_REG_REG_USERINDI_END = '已完成用户因子数据注册'
