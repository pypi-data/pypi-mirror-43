...
class CommandParser():
    ...
    def request(self, dataType, repeat, interval):
        ...
        drone.setEventHandler(DataType.RawLineTracer, self.RawLineTracer)
    ...
    def eventRawLineTracer(self, rawLineTracer):
        ...
        print("* RawLineTracer " +
                Fore.WHITE + "{0:8}".format(rawLineTracer.left) +
                Fore.WHITE + "{0:8}".format(rawLineTracer.right) +
                Fore.YELLOW + "{0:8}".format(rawLineTracer.frontH) +
                Fore.YELLOW + "{0:8}".format(rawLineTracer.frontS) +
                Fore.YELLOW + "{0:8}".format(rawLineTracer.frontV) +
                Fore.CYAN + "{0:8}".format(rawLineTracer.rearH) +
                Fore.CYAN + "{0:8}".format(rawLineTracer.rearS) +
                Fore.CYAN + "{0:8}".format(rawLineTracer.rearV) +
                Fore.MAGENTA + "{0:8}".format(rawLineTracer.leftColor) +
                Fore.MAGENTA + "{0:8}".format(rawLineTracer.rightColor) +
                Fore.GREEN + "{0:8}".format(rawLineTracer.frontColor) +
                Fore.GREEN + "{0:8}".format(rawLineTracer.rearColor) + Style.RESET_ALL)
