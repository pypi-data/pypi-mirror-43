...
class State(ISerializable):
    ...
    def toArray(self):
        return pack('<BBHHBBBBBBB', self.modeSystem.value, self.modeDrive.value, self.irFrontLeft, self.irFrontRight, self.colorFront.value, self.colorRear.value, self.colorLeft.value, self.colorRight.value, self.card.value, self.brightness, self.battery)
    ...
    def parse(cls, dataArray):
        ...
        data.modeSystem, data.modeDrive, data.irFrontLeft, data.irFrontRight, data.colorFront, data.colorRear, data.colorLeft, data.colorRight, data.card, data.brightness, data.battery = unpack('<BBHHBBBBBBB', dataArray)
...
class RawLineTracer(ISerializable):
    ...
    def toArray(self):
        return pack('<hhhhhhhhBBBB', self.left, self.right, self.frontR, self.frontG, self.frontB, self.rearR, self.rearG, self.rearB, self.leftColor, self.rightColor, self.frontColor, self.rearColor)
    ...
    def parse(cls, dataArray):
        ...
        data.left, data.right, data.frontR, data.frontG, data.frontB, data.rearR, data.rearG, data.rearB, data.leftColor, data.rightColor, data.frontColor, data.rearColor = unpack('<hhhhhhhhBBBB', dataArray)
...
class RawCard(ISerializable):
    ...
    def toArray(self):
        return pack('<hhhhhhhhhhhhhhhhhhffffffffffffBBB',
                    ...
                    self.color[0], self.color[1] , self.card)
    ...
    def parse(cls, dataArray):
        ...
        (   data.range[0][0][0], data.range[0][0][1], data.range[0][1][0], data.range[0][1][1], data.range[0][2][0], data.range[0][2][1],
            ...
            data.color[0], data.color[1] , data.card) = unpack('<hhhhhhhhhhhhhhhhhhffffffffffffBBB', dataArray)
