    ...
    def run(self):
        ...
        if (self.count > 0) and (self.arguments != None):
            ...
            # >python -m e_drive request State 10 0.1
                ...
                #print("* State -   Ready   Magenta   Red    Black   Black       None_        1840   1606   2237     77")    
            ...
            # >python -m e_drive request RawCardRange 10 0.1
            elif    ((self.count == 4) and 
                    (self.arguments[0] == "request") and
                    (self.arguments[1] == "RawCardRange")):         # time interval
                #print("* RawCardRange    189  2545   248  2740   253  2869   345     0   220     0   212     0")
                print ("                 |Front                              |Rear                               |")
