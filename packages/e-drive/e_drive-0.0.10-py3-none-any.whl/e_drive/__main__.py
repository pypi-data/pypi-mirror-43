...
class CommandParser():
    ...
    def run(self):
        ...
        if (self.count > 0) and (self.arguments != None):
            ...
            # >python -m e_drive request State 10 0.1
            ...
            # >python -m e_drive request RawCard 10 0.1
            elif    ((self.count == 4) and 
                    (self.arguments[0] == "request") and
            ...
            # >python -m e_drive request CardRange 10 0.1
            elif    ((self.count == 4) and 
                    (self.arguments[0] == "request") and
    ...
    def eventRawCard(self, rawCard):
        ...
        if self.flagRawCardShowRange:
            ...
            print("* RawCard - " +
                    Fore.RED    + "{0:6}".format(rawCard.rgbRaw[0][0]) +
                    Fore.GREEN  + "{0:6}".format(rawCard.rgbRaw[0][1]) +
                    Fore.BLUE   + "{0:6}".format(rawCard.rgbRaw[0][2]) +
                    Fore.RED    + "{0:6}".format(rawCard.rgbRaw[1][0]) +
                    Fore.GREEN  + "{0:6}".format(rawCard.rgbRaw[1][1]) +
                    Fore.BLUE   + "{0:6}".format(rawCard.rgbRaw[1][2]) +
                    Fore.RED    + "{0:6}".format(rawCard.rgb[0][0]) +
                    Fore.GREEN  + "{0:6}".format(rawCard.rgb[0][1]) +
                    Fore.BLUE   + "{0:6}".format(rawCard.rgb[0][2]) +
                    Fore.RED    + "{0:6}".format(rawCard.rgb[1][0]) +
                    Fore.GREEN  + "{0:6}".format(rawCard.rgb[1][1]) +
                    Fore.BLUE   + "{0:6}".format(rawCard.rgb[1][2]) +
                    Fore.RED    + "{0:6}".format(rawCard.hsv[0][0]) +
                    Fore.GREEN  + "{0:6}".format(rawCard.hsv[0][1]) +
                    Fore.BLUE   + "{0:6}".format(rawCard.hsv[0][2]) +
                    Fore.RED    + "{0:6}".format(rawCard.hsv[1][0]) +
                    Fore.GREEN  + "{0:6}".format(rawCard.hsv[1][1]) +
                    Fore.BLUE   + "{0:6}".format(rawCard.hsv[1][2]) +
                    Fore.CYAN   + "{0:6}".format(rawCard.color[0]) +
                    Fore.CYAN   + "{0:6}".format(rawCard.color[1]) +
                    Fore.YELLOW + "{0:6}".format(rawCard.card.value) + Style.RESET_ALL)
