...
class Base(metaclass=abc.ABCMeta):
    ...
    def __init__(self, config, **kwargs):
        ...
        self.stream_out = sys.stdout if 'out' not in kwargs else kwargs['out']
        self.stream_err = sys.stderr if 'err' not in kwargs else kwargs['err']
        # OPTIONS
        ...
        self.backup_dir = kwargs.get('backup_dir') or config.get(
    ...
    def _load_exclude_file(self, filepath):
        ...
        exclude = []
        with self.open(exclude_from, 'r') as ex_file:
    ...
    def backup(self, sources=None, verbose=False, **kwargs):
        ...
        if not os.path.exists(self.backup_dir):
            ...
            try:
                os.makedirs(self.backup_dir, mode=self.ARCHIVE_PERMISSIONS)
