...
class Grammar(object):
    ...
    REGEX_3 = re.compile('^[a-zA-Z]')
    REGEX_4 = re.compile('^[a-zA-Z0-9_]')
    REGEX_5 = re.compile('^[a-zA-Z]')
    ...
    REGEX_15 = re.compile('^[0-9]')
    REGEX_16 = re.compile('^[0-9]')
    REGEX_17 = re.compile('^[\\s]')
            ...
            if address2 is not FAILURE:
                ...
                if address3 is not FAILURE:
                        ...
                        if address6 is not FAILURE:
                            ...
                            while address8 is not FAILURE:
                                ...
                                if elements3 is None:
                                    ...
                                    address8 = TreeNode10(self._input[index5:self._offset], index5, elements3)
                                    self._offset = self._offset
                    ...
                    if elements1 is None:
                        ...
                        address4 = TreeNode9(self._input[index3:self._offset], index3, elements1)
                        self._offset = self._offset
                    if address4 is FAILURE:
                ...
                if address3 is not FAILURE:
                    ...
                    if address5 is not FAILURE:
                        ...
                        while address7 is not FAILURE:
                            ...
                            if self._offset < self._input_size:
                                chunk3 = self._input[self._offset:self._offset + 1]
                            if chunk3 is not None and Grammar.REGEX_16.search(chunk3):
                                address7 = TreeNode(self._input[self._offset:self._offset + 1], self._offset)
                                self._offset = self._offset + 1
                            else:
                                address7 = FAILURE
