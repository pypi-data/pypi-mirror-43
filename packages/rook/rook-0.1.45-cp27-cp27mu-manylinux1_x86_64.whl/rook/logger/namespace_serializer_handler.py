...
class NamespaceSerializerHandler(logging.Handler):
    ...
    def emit(self, record):
        ...
        try:
            ...
            self.output.send_log_message(record.levelno, record.created or time.time(), record.pathname, record.lineno, raw_message, formatted_message, ContainerNamespace(arguments))
        except Exception:
