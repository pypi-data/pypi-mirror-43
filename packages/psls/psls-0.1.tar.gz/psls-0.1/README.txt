P-SLS : the PLATO Solar-like Light-curve Simulator
...
The program is based on the module SLS,  the Solar-like Light-curve Simulator.

Two different types of oscillation spectrum can be simulated:
- oscillation spectra based on the Universal Pattern (gen_up) together with the mixed modes patterns derived from the asymptotic theory
- oscillation spectra based on a set of eigenfrequencies computed with ADIPLS (gen_adipls)
