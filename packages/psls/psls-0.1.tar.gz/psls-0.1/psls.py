...
if (UP):
    ...
    time,ts,f,ps,mps_nf,opar,_ =  sls.gen_up(StarID, numax,Sampling,Duration, StarMag,delta_nu =  delta_nu, mass = -1. , seed =seeds[0] , pn_ref = 0.,  wn_ref= 0., mag_ref = 6.,verbose = Verbose, teff = StarTeff, DPI = DPI,  q = q , GST = 1 )
...
for i in range(NGroup):
    ...
    ts = (1. + ts_i*1e-6) * (1. + ts_N_i*1e-6/math.sqrt(NCamera))
