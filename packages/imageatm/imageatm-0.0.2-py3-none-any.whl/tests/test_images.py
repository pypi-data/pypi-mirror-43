...
NON_EXISTENT_FILE_PATH = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), 'test_images', 'foo_bar.jpg'
)
...
TRUNCATED_IMG_PATH = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), 'test_images', 'truncated.jpg'
)
...
PNG_IMG_PATH = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), 'test_images', 'image_png.png'
)

BMP_IMG_PATH = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), 'test_images', 'image_bmp.bmp'
)
