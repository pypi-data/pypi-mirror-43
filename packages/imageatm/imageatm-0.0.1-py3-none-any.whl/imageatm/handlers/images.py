...
def validate_image(file_name, img_formats=IMG_FORMATS):
    '''
...
def resize_image(img, max_size: int, upscale: bool = False):
    '''
...
def resize_image_mp(data_tuple):
    ...
    save_image(img, os.path.join(new_image_dir, image_id))
