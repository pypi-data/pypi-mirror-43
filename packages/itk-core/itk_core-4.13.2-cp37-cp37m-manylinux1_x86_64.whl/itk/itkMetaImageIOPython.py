...
class itkMetaImageIO(ITKIOImageBaseBasePython.itkImageIOBase):
    ...
    def GetPointer(self) -> "itkMetaImageIO *":
        """GetPointer(itkMetaImageIO self) -> itkMetaImageIO"""
        return _itkMetaImageIOPython.itkMetaImageIO_GetPointer(self)
...
itkMetaImageIO.GetPointer = new_instancemethod(_itkMetaImageIOPython.itkMetaImageIO_GetPointer, None, itkMetaImageIO)
...
class itkMetaImageIOFactory(ITKCommonBasePython.itkObjectFactoryBase):
    ...
    def GetPointer(self) -> "itkMetaImageIOFactory *":
        """GetPointer(itkMetaImageIOFactory self) -> itkMetaImageIOFactory"""
        return _itkMetaImageIOPython.itkMetaImageIOFactory_GetPointer(self)
...
itkMetaImageIOFactory.GetPointer = new_instancemethod(_itkMetaImageIOPython.itkMetaImageIOFactory_GetPointer, None, itkMetaImageIOFactory)
