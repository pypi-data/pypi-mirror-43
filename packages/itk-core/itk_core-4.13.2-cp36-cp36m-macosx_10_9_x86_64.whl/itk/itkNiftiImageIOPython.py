...
class itkNiftiImageIO(ITKIOImageBaseBasePython.itkImageIOBase):
    ...
    def SetLegacyAnalyze75Mode(self, _arg: 'bool const') -> "void":
        ...
        properly respect the file orientation fields. The itkAnalyzeImageIO
        file reader/writer should be used to match the Analyze75 file
        definitions as specified by the Mayo Clinic BIR laboratory. By default
